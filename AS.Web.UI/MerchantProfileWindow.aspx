<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Title="Merchant Profile"
    CodeFile="MerchantProfileWindow.aspx.cs" Inherits="gen_MerchantProfile" EnableEventValidation="false" meta:resourcekey="PageResource1" %>
...
<asp:Content ContentPlaceHolderID="head" runat="server">
    <script src="<%= ResolveUrl("~/")  %>res/js/common/reportfilter.js" type="text/javascript"></script>
</asp:Content>
            ...
            <MasterTableView>
                <Columns>
                    ...
                    <as:ASGridBoundColumn UniqueName="ResellerName" HeaderText="Reseller" HeaderTooltip="Reseller" HeaderStyle-Width="130px"
                        DataField="ResellerName" ASFormat="DynamicString" Visible="false" meta:resourcekey="ASGridBoundColumnResource65">
                        <ColumnValidationSettings>
                            <ModelErrorMessage Text=""></ModelErrorMessage>
                        </ColumnValidationSettings>
                    ...
                    <as:ASGridBoundColumn UniqueName="PartnerName" HeaderText="Partner" HeaderTooltip="Partner" HeaderStyle-Width="130px"
                        DataField="PartnerName" ASFormat="DynamicString" Visible="false" meta:resourcekey="ASGridBoundColumnResource66">
                        <ColumnValidationSettings>
                            <ModelErrorMessage Text=""></ModelErrorMessage>
                        </ColumnValidationSettings>
