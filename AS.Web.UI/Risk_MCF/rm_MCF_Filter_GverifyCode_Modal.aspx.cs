...
public partial class rm_MCF_Filter_GverifyCode_Modal : NonReportPage
{
    #region Enums
    ...
    private void BindData()
    {
        ...
        uxGverifyCodeStatus.DataSourceOrigination = listOri;
        uxGverifyCodeStatus.DataSourceDestination = listDes;
    }
    ...
    private DataSet GetFilterList(WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        paramsIn.Add(new FilterParameter("@ItemCode", WebSiteEnums.Filter_Extend.GverifyCode.ToString(), DbType.String));
    ...
    public void Save()
    {
        ...
        paramsIn.Add("@ItemValueList", uxGverifyCodeStatus.GetSelectedItemsAsString(","), DbType.String);
        paramsIn.Add("@Mode", this.Mode, DbType.Int32);
        paramsIn.Add("@ItemCode", WebSiteEnums.Filter_Extend.GverifyCode.ToString(), DbType.String);
    ...
    private int UpdateIncludeStatus(bool isIncluded)
    {
        ...
        _params.Add(new FilterParameter("@Mode", Convert.ToInt32(this.Mode), DbType.Int32));
        _params.Add(new FilterParameter("@AssignmentID", Convert.ToInt32(this.PrimaryID), DbType.Int32));
        _params.Add(new FilterParameter("@IsIncluded", isIncluded, DbType.Boolean));
        _params.Add(new FilterParameter("@ItemCode", WebSiteEnums.Filter_Extend.GverifyCode.ToString(), DbType.String));
