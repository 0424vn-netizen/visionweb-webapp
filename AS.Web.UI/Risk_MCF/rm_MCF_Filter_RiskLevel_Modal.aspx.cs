...
public partial class rm_MCF_Filter_RiskLevel_Modal : NonReportPage
{
    #region Enums
    enum DataBindAction
    {
    ...
    protected string RiskLevelLabel = "Risk Level";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        uxFilterRiskLevel.Mode = (WebSiteEnums.ParamFilterMode)(int.Parse(SecureQueryString["mode"]));
        uxFilterRiskLevel.PrimaryID = SecureQueryString["primaryid"];
        uxFilterRiskLevel.ParamID = SecureQueryString["paramid"];


        RiskLevelLabel = GetLocalResourceObject("Filter_RiskLevel_Modal_aspx_cs_State").ToString();

        this.Page.Title = GetLocalResourceObject("Filter_RiskLevel_Modal_aspx_cs_Select").ToString() + " " + (GetLocalResourceObject("Filter_RiskLevel_Modal_aspx_cs_State").ToString());
        if (!IsPostBack)
        {
    ...
    protected override void OnPostBackActions(Enum type, object sender)
    {
        switch ((PostBackAction)type)
        {
            case PostBackAction.Close:
                uxFilterRiskLevel.IsInclude = IsIncluded;
                uxFilterRiskLevel.Save();
    ...
    private int UpdateIncludeStatus(bool isIncluded)
    {
        ...
        _params.Add(new FilterParameter("@Mode", Convert.ToInt32(uxFilterRiskLevel.Mode), DbType.Int32));
        _params.Add(new FilterParameter("@AssignmentID", Convert.ToInt32(uxFilterRiskLevel.PrimaryID), DbType.Int32));
    ...
    private void BindStatus()
    {
        ...
        parames.Add(new FilterParameter("@AssignmentID", Convert.ToInt32(uxFilterRiskLevel.PrimaryID), DbType.Int32));
        parames.Add(new FilterParameter("@Mode", Convert.ToInt32(uxFilterRiskLevel.Mode), DbType.Int32));
