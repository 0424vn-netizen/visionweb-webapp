<%@ Page Title="Reoder Full View Columns" Language="C#" MasterPageFile="~/MasterPagePopup.master" meta:resourcekey="PageResource1"
    AutoEventWireup="true" CodeFile="rm_MCF_EditManageCustomModal.aspx.cs" Inherits="rm_MCF_EditManageCustomModal" %>
...
<asp:Content ContentPlaceHolderID="ContentPage" runat="server" ID="uxMainModalContent">
    <as:ASModalContainer ID="uxModalContainer" runat="server" ContainerCssClass="container" WidthCssClass="modal-md">
            ...
            <div class="col-xs-12">
                ...
                <div>
                    <as:RadListBox runat="server" ID="uxRightGrid" Width="100%" Height="291" CssClass="uxRightGrid-background"
                        ...
                        EnableDragAndDrop="true"  OnClientDropping="EditColumnModal.uxGridListBox_OnClientDropping" OnClientDragging="EditColumnModal.uxGridListBox_OnClientDragging" OnClientDragStart="EditColumnModal.uxGridListBox_OnClientDragStart"
                        OnClientReordered="EditColumnModal.uxGridListBox_OnClientDropped" PersistClientChanges="true" OnItemDataBound="uxRightGrid_ItemDataBound"
                        AllowReorder="true" ButtonSettings-ShowReorder="false" DataTextField="ColumnText" DataValueField="Key">
                        <ClientItemTemplate>
                         <div class="#= Attributes.IsDefault# display-flex space-between">   
                            ...
                            <span class="col-name col-name-style" id="#= Value#">#= Text#</span>
        ...
        <tek:RadCodeBlock ID="uxRadCodeBlock" runat="server">
            ...
            <script type="text/javascript" src="<%=ResolveUrl("~") %>res/js/risk_MCF/rm_MCF_EditManageCustomModal.js"></script>
        </tek:RadCodeBlock>
    </as:ASModalContainer>
</asp:Content>
