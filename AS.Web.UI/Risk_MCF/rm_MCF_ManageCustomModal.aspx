<%@ Page Title="Manage Custom Views" Language="C#" MasterPageFile="~/MasterPagePopup.master" meta:resourcekey="PageResource1"
    AutoEventWireup="true" CodeFile="rm_MCF_ManageCustomModal.aspx.cs" Inherits="rm_MCF_ManageCustomModal" %>
...
<asp:Content ContentPlaceHolderID="ContentPage" runat="Server" ID="uxMainModalContent">
    <tek:RadAjaxManagerProxy ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <tek:AjaxSetting AjaxControlID="uxDeleteCustomView">
                <UpdatedControls>
                    <tek:AjaxUpdatedControl ControlID="uxCustomViewsGrid" LoadingPanelID="uxLoadingPanelCustom" />
                    <tek:AjaxUpdatedControl ControlID="hddCustomViewDefault" LoadingPanelID="uxLoadingPanelCustom" />
                </UpdatedControls>
            </tek:AjaxSetting>
    ...
    <as:ASModalContainer ID="uxModalContainer" runat="server" ContainerCssClass="container" WidthCssClass="modal-lg">
        <asp:Panel ID="uxDisplayViewType" runat="server" CssClass="mb-20">
            <span class="title-auto-queue">
                <asp:Label runat="server" ID="lblViewType" Text="View" meta:resourcekey="txtViewType"></asp:Label>
            </span>
        ...
        <as:ASGrid ID="uxCustomViewsGrid" runat="server" AllowPaging="false" AllowSorting="True" AllowAutomaticUpdates="True"
            ...
            <MasterTableView>
                <Columns>
                    ...
                    <as:ASGridBoundColumn UniqueName="ViewType" ItemStyle-HorizontalAlign="Left" HeaderText="View Type" HeaderTooltip="View Type" meta:resourcekey="ASGridBoundColumnResource2"
        ...
        <div class="display-flex ipmt  align-center space-between mt-6x">
            <span class="link dark-blue">
                <as:Button runat="server" class="btn btn-default" ID="btnCreateCustomView" meta:resourcekey="btnCreateCustomViewResource" Text="Create Custom View" IsStandardButton="False" />
            </span>
            <div>
                <as:Button runat="server" class="btn btn-default" ID="uxClose" meta:resourcekey="uxCloseResource" Text="Close" OnClientClick="onCloseModal()" IsStandardButton="False" />
            </div>
        </div>
        <div class="display-none">
            <as:Button ID="uxRebindCustomViewsGrid" runat="server" OnClick="uxRebindCustomViewsGrid_Click" IsStandardButton="False" />
            ...
            <as:HiddenField ID="hddCustomViewDefault" runat="server" />
        </div>
    </as:ASModalContainer>
    ...
    <tek:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            var rm_MCF_ManageCustomModal_PageMode = '<%= PageMode%>';
            var rm_MCF_ManageCustomModal_hddCustomViewDefault = '<%= hddCustomViewDefault.ClientID%>';
        </script>

        <script type="text/javascript" src="<%= ResolveUrl("~/") %>res/js/risk_MCF/rm_MCF_ManageCustomModal.js"></script>
    </tek:RadCodeBlock>
</asp:Content>
