<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPagePopup.master" CodeFile="rm_MCF_Filter_GverifyCode_Modal.aspx.cs" Inherits="rm_MCF_Filter_GverifyCode_Modal" Title="Select Gverify Code" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="Server">
    <as:ASModalContainer ID="uxModalContainer" runat="server" WidthCssClass="modal-md" ContainerCssClass="container" Width="">
        ...
        <div class="row">
            <div class="col-md-12">
                <as:MultiSelector ID="uxGverifyCodeStatus" runat="server" DataTextField="DataText" XmlFilterItemsFilePath="~/App_Data/AssigmentFilters.xml" DataValueField="DataKey"
    ...
    <as:ASRadCodeBlock ID="radCodeBlock" runat="server">
        <script type="text/javascript">
            parent.setModalID("GverifyCodeModal");
        </script>
    </as:ASRadCodeBlock>
</asp:Content>
