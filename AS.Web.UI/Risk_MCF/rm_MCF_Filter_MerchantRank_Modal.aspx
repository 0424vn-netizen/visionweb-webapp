<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPagePopup.master" CodeFile="rm_MCF_Filter_MerchantRank_Modal.aspx.cs" Inherits="rm_MCF_Filter_MerchantRank_Modal" Title="Select MerchantRank" meta:resourcekey="PageResource1"%>
<%@ Register Src="~/UserControls/rm_MCF_FilterMerchantRank.ascx" TagName="Risk_MerchantRank" TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="Server">
    <as:ASModalContainer ID="uxModalContainer" runat="server" WidthCssClass="modal-md" ContainerCssClass="container" Width="">
        ...
        <div class="row">
            <div class="col-md-12">
                <uc1:Risk_MerchantRank ID="uxMerchantRankFilter" runat="server" WidthUC="600" HeightUC="500" />
            </div>
        </div>
        <div class="row">
    ...
    <as:ASRadCodeBlock ID="radCodeBlock" runat="server">
        <script type="text/javascript">
            parent.setModalID("MerchantRankModal");
        </script>
    </as:ASRadCodeBlock>
</asp:Content>