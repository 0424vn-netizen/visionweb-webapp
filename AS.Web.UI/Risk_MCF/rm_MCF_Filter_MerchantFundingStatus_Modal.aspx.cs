...
public partial class rm_MCF_Filter_MerchantFundingStatus_Modal : NonReportPage
{
    #region Enums
    enum DataBindAction
    {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (SecureQueryString != null && SecureQueryString["mode"] != null)
        {
            ...
            uxMerchantFundingStatusFilter.Mode = (WebSiteEnums.ParamFilterMode)mode;
        }
        if (SecureQueryString != null && SecureQueryString["primaryid"] != null)
            uxMerchantFundingStatusFilter.PrimaryID = SecureQueryString["primaryid"];
        if (SecureQueryString != null && SecureQueryString["paramid"] != null)
            uxMerchantFundingStatusFilter.ParamID = SecureQueryString["paramid"];
        if (!IsPostBack)
        {
    ...
    protected override void OnPostBackActions(Enum type, object sender)
    {
        switch ((PostBackAction)type)
        {
            case PostBackAction.Close:
                uxMerchantFundingStatusFilter.IsInclude = IsIncluded;
                uxMerchantFundingStatusFilter.Save();
    ...
    private int UpdateIncludeStatus(bool isIncluded)
    {
        ...
        _params.Add(new FilterParameter("@Mode", Convert.ToInt32(uxMerchantFundingStatusFilter.Mode), DbType.Int32));
        _params.Add(new FilterParameter("@PrimaryID", Convert.ToInt32(uxMerchantFundingStatusFilter.PrimaryID), DbType.Int32));
        ...
        return WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_UpdateIncludeStatusFundingStatus", _params, out _paramsOut);
    }
    private void BindStatus()
    {
        ...
        parames.Add(new FilterParameter("@PrimaryID", Convert.ToInt32(uxMerchantFundingStatusFilter.PrimaryID), DbType.Int32));
        parames.Add(new FilterParameter("@Mode", Convert.ToInt32(uxMerchantFundingStatusFilter.Mode), DbType.Int32));
        ...
        // Get OutParams value
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_GetStatusFundingStatus", parames, out paramesOut);
