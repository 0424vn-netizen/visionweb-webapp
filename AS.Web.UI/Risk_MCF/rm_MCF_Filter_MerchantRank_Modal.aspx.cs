...
public partial class rm_MCF_Filter_MerchantRank_Modal : NonReportPage
{
    #region Enums
    enum DataBindAction
    {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (SecureQueryString != null && SecureQueryString["mode"] != null)
        {
            ...
            uxMerchantRankFilter.Mode = (WebSiteEnums.ParamFilterMode)mode;
        }
        if (SecureQueryString != null && SecureQueryString["primaryid"] != null)
            uxMerchantRankFilter.PrimaryID = SecureQueryString["primaryid"];
        if (SecureQueryString != null && SecureQueryString["paramid"] != null)
            uxMerchantRankFilter.ParamID = SecureQueryString["paramid"];
        if (!IsPostBack)
        {
    ...
    protected override void OnPostBackActions(Enum type, object sender)
    {
        switch ((PostBackAction)type)
        {
            case PostBackAction.Close:
                uxMerchantRankFilter.IsInclude = IsIncluded;
                uxMerchantRankFilter.Save();
    ...
    private int UpdateIncludeStatus(bool isIncluded)
    {
        ...
        _params.Add(new FilterParameter("@Mode", Convert.ToInt32(uxMerchantRankFilter.Mode), DbType.Int32));
        _params.Add(new FilterParameter("@PrimaryID", Convert.ToInt32(uxMerchantRankFilter.PrimaryID), DbType.Int32));
        ...
        return WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_UpdateIncludeStatusMerchantRank", _params, out _paramsOut);
    }
    private void BindStatus()
    {
        ...
        parames.Add(new FilterParameter("@PrimaryID", Convert.ToInt32(uxMerchantRankFilter.PrimaryID), DbType.Int32));
        parames.Add(new FilterParameter("@Mode", Convert.ToInt32(uxMerchantRankFilter.Mode), DbType.Int32));
        ...
        // Get OutParams value
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_GetStatusMerchantRank", parames, out paramesOut);
