...
public partial class rm_MCF_Filter_G2CompassAutoApprovalIndicator_Modal : NonReportPage
{
    #region Enums
    enum DataBindAction
    {
    ...
    private int UpdateIncludeStatus(bool isIncluded)
    {
        ...
        _params.Add(new FilterParameter("@ItemCode", WebSiteEnums.Filter_Extend.G2Compass.ToString(), DbType.String));
    ...
    private void BindData()
    {
        ...
        uxG2Compass.DataSourceOrigination = listOri;
        uxG2Compass.DataSourceDestination = listDes;
    }
    ...
    private DataSet GetFilterList(WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        paramsIn.Add(new FilterParameter("@ItemCode", WebSiteEnums.Filter_Extend.G2Compass.ToString(), DbType.String));
    ...
    public void Save()
    {
        ...
        paramsIn.Add("@ItemValueList", uxG2Compass.GetSelectedItemsAsString(","), DbType.String);
        paramsIn.Add("@Mode", this.Mode, DbType.Int32);
        paramsIn.Add("@ItemCode", WebSiteEnums.Filter_Extend.G2Compass.ToString(), DbType.String);
