...
public partial class rm_NRT_DQAssignWorkQueueModal : NonReportPage
{
    #region Enums
    ...
    private const string SPA_GET_WQ_ASSIGNMENT = "spa_RM_NRT_wq_GetWorkQueueAssignmentList";
    private const string SPA_PROCESS_REQUEUED_MER = "spa_RM_NRT_wq_ProcessRequeuedMerchants";
