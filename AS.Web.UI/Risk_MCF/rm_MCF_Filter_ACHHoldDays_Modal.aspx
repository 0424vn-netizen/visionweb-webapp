<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPagePopup.master" CodeFile="rm_MCF_Filter_ACHHoldDays_Modal.aspx.cs" Inherits="rm_MCF_Filter_ACHHoldDays_Modal" Title="Select ACH Hold Days" meta:resourcekey="PageResource1" %>

<%@ Register Src="~/UserControls/rm_MCF_FilterACHHoldDays.ascx" TagName="Risk_ACHHoldDays" TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="Server">
    <as:ASModalContainer ID="uxModalContainer" runat="server" WidthCssClass="modal-md" ContainerCssClass="container" Width="">
        ...
        <div class="row">
            <div class="col-md-12">
                <uc1:Risk_ACHHoldDays ID="uxACHHoldDaysFilter" runat="server" WidthUC="600" HeightUC="500" />
            </div>
        </div>
        <div class="row">
    ...
    <as:ASRadCodeBlock ID="radCodeBlock" runat="server">
        <script type="text/javascript">
            parent.setModalID("ACHHoldDaysModal");
        </script>
    </as:ASRadCodeBlock>
</asp:Content>