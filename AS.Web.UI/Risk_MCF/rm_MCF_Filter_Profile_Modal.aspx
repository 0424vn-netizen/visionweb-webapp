<%@ Page Language="C#" MasterPageFile="~/MasterPagePopup.master" AutoEventWireup="true" CodeFile="rm_MCF_Filter_Profile_Modal.aspx.cs" Inherits="rm_MCF_Filter_Profile_Modal" Title="Select Profile" meta:resourcekey="PageResource1" %>

<%@ Register Src="~/UserControls/rm_MCF_FilterProfile.ascx" TagName="Risk_Profile" TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="Server">
    <as:ASModalContainer ID="uxModalContainer" runat="server" WidthCssClass="modal-md" ContainerCssClass="container" Width="">
        ...
        <div class="row">
            <div class="col-md-12">
                <uc1:Risk_Profile ID="uxProfileFilter" runat="server" WidthUC="600" HeightUC="500" />
            </div>
        </div>
        <div class="row">
    ...
    <as:ASRadCodeBlock ID="radCodeBlock" runat="server">
        <script type="text/javascript">
            parent.setModalID("ProfileModal");
        </script>
    </as:ASRadCodeBlock>
</asp:Content>
