...
public partial class rm_MCF_Resolution_ActiveModal : ReportPage
{
    #region Enums
    ...
    private string _resolutionIDs = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        _resolutionIDs = SecureQueryString["resolutionID"];
        ...
        ExportConfig exportConfig)
    {
        ...
        exportConfig.FileName = GeneralFuncsLib.GetLegalFileName("Open Escalations");
        exportConfig.ReportHeader = GetLocalResourceObject("rm_Resolution_ActiveModal_aspx_cs_ReportHeader").ToString();
    }
    ...
    protected override void DoItemDataBound(ASGrid sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            dataItem[MERCHANT_NAME].Text = VeraCodeSolution.DoVeraCode(url);
