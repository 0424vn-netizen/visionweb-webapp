<%@ Page Language="C#" MasterPageFile="~/MasterPagePopup.master" AutoEventWireup="true" CodeFile="rm_MCF_Filter_RiskCategory_Modal.aspx.cs" Inherits="rm_MCF_Filter_RiskCategory_Modal" Title="Select Risk Level" meta:resourcekey="PageResource1" %>

<%@ Register Src="~/UserControls/rm_MCF_FilterRiskCategory.ascx" TagName="Risk_FilterRiskCategory" TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="Server">
    <as:ASModalContainer ID="uxModalContainer" runat="server" WidthCssClass="modal-md" ContainerCssClass="container" Width="">
        ...
        <div class="row">
            <div class="col-md-12">
                <uc1:Risk_FilterRiskCategory ID="uxFilterRiskCategory" runat="server" WidthUC="600" HeightUC="500"/>
            </div>
        </div>
        <div class="row">
    ...
    <as:ASRadCodeBlock ID="radCodeBlock" runat="server">
        <script type="text/javascript">
            parent.setModalID('RiskCategoryModal');
        </script>
    </as:ASRadCodeBlock>
</asp:Content>
