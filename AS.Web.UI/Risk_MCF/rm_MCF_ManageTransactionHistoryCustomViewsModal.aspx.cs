...
public partial class rm_MCF_ManageTransactionHistoryCustomViewsModal : ReportPage
{
    ...
    public string FlagLink
    {
        get
        {
            if (SecureQueryString["flagLink"] != null)
            {
                return SecureQueryString["flagLink"];
            }
            else
            {
                return string.Empty;
    ...
    public WebSiteEnums.PageModeEnums PageMode
    {
        get
        {
            ...
            {
                return WebSiteEnums.PageModeEnums.TransactionHistory;
            }
        }
    }
    ...
    protected void uxCustomViewsGrid_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            rbDisplayType.Attributes.Add("onclick", "UpdateDefaultCustomView('" + CryptorServices.Current.EncryptText(dataRow["CustomViewID"].ToString()) + "','"+ FlagLink + "',this)");
        }
    }


    [System.Web.Services.WebMethod()]
    public static void UpdateDefaultCustomView(string viewId, string flagLink)
    {
