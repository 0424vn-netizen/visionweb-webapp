<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_BarometerExportOptionModal.aspx.cs" MasterPageFile="~/MasterPagePopup.master"
    Inherits="rm_MCF_BarometerExportOptionModal" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPage" runat="Server">
    <as:ASModalContainer ID="uxModalContainer" runat="server" WidthCssClass="modal-sm" ContainerCssClass="container" Width="">
        ...
        <script type="text/javascript" src="<%=ResolveUrl("~") %>res/js/risk_MCF/rm_MCF_BarometerExportOptions.js"></script>
    </as:ASModalContainer>
</asp:Content>
