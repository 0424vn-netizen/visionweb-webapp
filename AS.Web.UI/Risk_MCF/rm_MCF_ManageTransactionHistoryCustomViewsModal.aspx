<%@ Page Title="Manage Custom Views" Language="C#" MasterPageFile="~/MasterPagePopup.master" meta:resourcekey="PageResource1"
    AutoEventWireup="true" CodeFile="rm_MCF_ManageTransactionHistoryCustomViewsModal.aspx.cs" Inherits="rm_MCF_ManageTransactionHistoryCustomViewsModal" %>
...
<asp:Content ContentPlaceHolderID="ContentPage" runat="Server" ID="uxMainModalContent">
    ...
    <tek:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" src="<%= ResolveUrl("~/") %>res/js/risk_MCF/rm_MCF_ManageTransactionHistoryCustomViewsModal.js"></script>
    </tek:RadCodeBlock>
</asp:Content>
