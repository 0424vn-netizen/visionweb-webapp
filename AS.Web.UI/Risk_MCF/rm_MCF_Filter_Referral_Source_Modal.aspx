<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPagePopup.master" CodeFile="rm_MCF_Filter_Referral_Source_Modal.aspx.cs" Inherits="rm_MCF_Filter_Referral_Source_Modal" Title="Select Referral Source" meta:resourcekey="PageResource1" %>

<%@ Register Src="~/UserControls/rm_MCF_Filter_Referral_Source.ascx" TagName="Risk_Referral_Source" TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="Server">
    <as:ASModalContainer ID="uxModalContainer" runat="server" WidthCssClass="modal-md" ContainerCssClass="container" Width="">
        ...
        <div class="row">
            <div class="col-md-12">
                <uc1:Risk_Referral_Source ID="uxReferralSourceFilter" runat="server" WidthUC="600" HeightUC="500" />
            </div>
        </div>
        <div class="row">
    ...
    <as:ASRadCodeBlock ID="radCodeBlock" runat="server">
        <script type="text/javascript">
            parent.setModalID("ReferralSourceModal");
        </script>
    </as:ASRadCodeBlock>
</asp:Content>
