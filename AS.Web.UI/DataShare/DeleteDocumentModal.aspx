<%@ Page Language="C#" MasterPageFile="~/MasterPagePopup.master" AutoEventWireup="true" CodeFile="DeleteDocumentModal.aspx.cs" Inherits="DeleteDocumentModal"
    ...
    <as:ASModalContainer ID="uxModalContainer" runat="server" WidthCssClass="modal-sm">
        <div class="row" id="uxMessages-container">
            ...
            <div class="col-xs-12 form-action-container text-right">
                <as:Button runat="server" CssClass="btn btn-default" ID="uxOK" Text="OK" OnClientClick="return parent.deleteDocument();" meta:resourcekey="btnOk" />
