...
function parameter_Add(modal) {
    ...
    if (pageName.indexOf('rm_AdhocCreate.aspx') == -1) {
...
function parameter_closeModalEvent(modalID) {
    switch (modalID) {
        case 'ParameterFilter_TransactionCodeModal':
            ...
            var url = "";
            if (isAdhoc())
                url = rootURL + "Risk/rm_AdhocCreate.aspx/GetTransactionCode";
            else
                url = rootURL + "Risk/rm_Assignment_CreateNew.aspx/GetTransactionCode";
...
function saveParameters(modal) {
    var actionUrl = "";
    if (isAdhoc())
        actionUrl = rootURL + "Risk/rm_AdhocCreate.aspx/SaveParametersToStagging";
    else
        actionUrl = rootURL + "Risk/rm_Assignment_CreateNew.aspx/SaveParametersToStagging";
    var primaryID = $("#" + Risk_Assignment_Parameters_uxPrimaryID_ClientID).val();
    var modeID = $("#" + Risk_Assignment_Parameters_uxMode_ClientID).val();
...
function resetTimeout()
{
    ...
    var data = {};
    if (isAdhoc())
        url = rootURL + "Risk/rm_AdhocCreate.aspx/ResetTimeOut";
    else
        url = rootURL + "Risk/rm_Assignment_CreateNew.aspx/ResetTimeOut";
