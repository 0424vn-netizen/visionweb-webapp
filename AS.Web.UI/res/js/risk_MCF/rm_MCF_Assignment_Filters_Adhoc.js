function filter_closeModalEvent(modalID, clientIDbtn) {
    switch (modalID) {
        case 'HierarchyModal':
            ...
            break;
        case 'SICModal':
            document.getElementById(Risk_Assignment_Filters_Adhoc_btnRefreshSIC).click();
            break;
        case 'StateModal':
            document.getElementById(Risk_Assignment_Filters_Adhoc_btnRefreshState).click();
            break;

        case 'ProfileModal':
            document.getElementById(Risk_Assignment_Filters_Adhoc_btnRefreshProfile).click();
            break;
        case 'HRCodeModal':
            document.getElementById(Risk_Assignment_Filters_Adhoc_btnRefreshHighRisk).click();
            break;
...
function CallFilterModal1(modal, width, height) {
    return doOpenSubPopup(modal + Risk_Assignment_Filters_Adhoc_QueryString, 'auto');
}
...
function DisplayMerchantCountOnFilter(merchantCountOnFilter) {
    $get(Risk_Assignment_Filters_Adhoc_pnlMerchantCountOnFilter).innerHTML = addCommas(merchantCountOnFilter);
}
...
function ValidateMerchantRangeFromTo() {
    var isValid = true;
    var merchantRangeFrom = document.getElementById(Risk_Assignment_Filters_Adhoc_txtMerchantRangeFrom).value;
    var merchantRangeTo = document.getElementById(Risk_Assignment_Filters_Adhoc_txtMerchantRangeTo).value;
...
function ValidateMerchantRangeFromRequired() {
    ...
    if ((merchantRangeFrom.length > 0 && merchantRangeTo.length > 0) ||
        ...
        document.getElementById(Risk_Assignment_Filters_Adhoc_txtMerchantRangeFrom).focus();
        isValid = false;
    }
    return isValid;
}
...
function ValidateMerchantRangeToRequired() {
    ...
    if ((merchantRangeFrom.length > 0 && merchantRangeTo.length > 0) ||
        ...
        document.getElementById(Risk_Assignment_Filters_Adhoc_txtMerchantRangeTo).focus();
        $('label[for=' + Risk_Assignment_Filters_Adhoc_txtMerchantRangeFrom + ']').addClass('label-error');
        isValid = false;
    }
    return isValid;
}
...
function btnCountClick() {
    document.getElementById(Risk_Assignment_Filters_Adhoc_btnCalculateMerchantCount).click();
}
