function UpdateDefaultCustomView(customViewID, flagLink, e) {
    $('.RadGrid :input[type="radio"]').each(function (index) {
        this.checked = false;
    })
    e.checked = true;
    PageMethods.UpdateDefaultCustomView(customViewID, flagLink);

};

function GetTransactionHistoryManageCustomViewsGrid() {
