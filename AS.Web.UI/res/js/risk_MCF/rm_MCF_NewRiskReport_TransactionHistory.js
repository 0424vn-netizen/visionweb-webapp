...
function doOpenTransactionHistoryNewPopup(encodeURL) {
    registerCloseTHCustomViewModal();
    return parent.ShowPopupModal(encodeURL, 'auto');
}

parent.registerCloseTHCustomViewModalEvent = function() {
    $get(rm_Button_TransactionHistory_Rebind_ClientID).click();
}

if (rm_TransactionHistory_Flaglink == 0) {
...
function registerCloseTHCustomViewModal() {
