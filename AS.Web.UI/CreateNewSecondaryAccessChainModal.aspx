<%@ Page Title="Create New Custom Chain" Language="C#" MasterPageFile="~/MasterPagePopup.master" AutoEventWireup="true" 
    CodeFile="CreateNewSecondaryAccessChainModal.aspx.cs" Inherits="CreateNewSecondaryAccessChainModal" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" Runat="Server">
    ...
    <as:RadCodeBlock ID="uxRadCodeBlock" runat="server">
        <script type="text/javascript" src="<%=ResolveUrl("~") %>res/js/CreateNewSecondaryAccessChainModal.js">
        </script>
    </as:RadCodeBlock>
</asp:Content>
