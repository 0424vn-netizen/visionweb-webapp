...
namespace As.VisionWeb.Web
{
    ...
    public partial class StatementDetail_SPHERE : ReportPage
    {
        #region Enum
        ...
        protected void uxIDINE_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Footer && DataSetIdine != null && DataSetIdine.Tables.Count > 1 && DataSetIdine.Tables[1].Rows.Count > 0)
            {
        ...
        protected void uxCashAdvance_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Footer && DataSetCashAdvance != null && DataSetCashAdvance.Tables.Count > 1 && DataSetCashAdvance.Tables[1].Rows.Count > 0)
            {
