<%@ Page Title="ACH DETAILS" Language="C#" MasterPageFile="~/MasterPagePopup.master" AutoEventWireup="true" CodeFile="ACHDetailsModal.aspx.cs" Inherits="ACHDetailsModal" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="Server">
    ...
    <as:ASModalContainer ID="ASModalContainer1" runat="server" WidthCssClass="modal-xxl">
        ...
        <as:ASGrid ID="uxReportGrid" runat="server" Width="100%" AllowPaging="true" AllowSorting="true"
            ASPagingMethod="SPASingleMethod" AutoGenerateColumns="false" ShowPageTotal="false" CssClass="in" meta:resourcekey="uxReportGridResource1">
            <MasterTableView>
                <Columns>
