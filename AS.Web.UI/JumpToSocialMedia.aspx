<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePopup.master" AutoEventWireup="true" CodeFile="JumpToSocialMedia.aspx.cs" Inherits="JumpToSocialMedia" meta:resourcekey="PageResource1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPage" runat="Server">
    <div id="uxProgress" style="padding: auto; position: fixed; vertical-align: middle; text-align: center; z-index: 9999; height: 100%; width: 100%; top: 0px; left: 0px; bottom: 0px; right: 0px; background: #FFF url('res/Images/loading.gif') no-repeat center center">
    </div>
