                ...
                <as:PlaceHolder runat="server" ID="uxContactInfoColumn">
                    <div class="login-info">
                        <as:PlaceHolder ID="uxContactInfoPanel" runat="server">
                            <h4>
                                <strong>
                                    <as:Literal runat="server" ID="uxCSHeader" Visible="false" Text="" meta:resourcekey="uxCompanyNameResource1"></as:Literal>
                                    <as:Literal runat="server" ID="Literal1" Text="" meta:resourcekey="uxCompanyNameResource1">Welcome to the Merchant Reporting Portal</as:Literal>
                            ...
                            <as:PlaceHolder ID="uxHideAddress" runat="server">
                                <b class="control-label" style="font-weight:700">Contact Information</b>
                                <p>
