...
[PagePermission("ViewSrvMsg")]
public partial class ServiceMessage_View : ReportPage
{
    #region Enum
    enum DataBindAction
    {
            ...
            case DataBindAction.BindMessageGrid:
                {
                    ...
                    ((ASGrid)sender).DataSourceInvoker = new ASFuncInvoker(WebServices.RiskServices, WebSiteConstants.GET_REPORT_METHOD_NAME, new object[] { "spa_cs_GetMySrvMessages", ReportServices.ConvertToFilterParamWSArray(_parames) });
                }
                break;
        }
    }
