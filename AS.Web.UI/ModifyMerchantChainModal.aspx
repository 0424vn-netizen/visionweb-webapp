<%@ Page Title="Add/Modify Merchant Chain" Language="C#" MasterPageFile="~/MasterPagePopup.master" AutoEventWireup="true" 
    CodeFile="ModifyMerchantChainModal.aspx.cs" Inherits="ModifyMerchantChainModal" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" Runat="Server">
    <as:ASModalContainer ID="ASModalContainer1" runat="server" Width="530px" ContainerCssClass="container" WidthCssClass="modal-xxl">
                ...
                <div class="box">
                    <p>
                        ...
                        <as:PlaceHolder ID="uxPlcAdd" runat="server" Visible="false">
                            <as:Literal ID="ltToAssignMerchant" runat="server" Text="To assign this Merchant to a new Chain select from the list below." meta:resourcekey="ltToAssignMerchantResource1"></as:Literal><br />
                            <as:Literal ID="ltToDeleteMerchant" runat="server" Text="To delete this Merchant from the Chain leave the Chain ID blank." meta:resourcekey="ltToDeleteMerchantResource1"></as:Literal>
                        </as:PlaceHolder>
                    </p>
                    <div class="form-inline">
                        <div class="control-inline last valign-top">
                            <as:ValidatorLabel ID="ValidatorLabel1" runat="server" ApplyFor="uxChain" Text="Chain ID:" meta:resourcekey="ValidatorLabel1Resource1"></as:ValidatorLabel>
                        </div>
                        <div class="inline-block">
                            <as:RadComboBox ID="uxChain" runat="server" DataTextField="ChainNumber" DataValueField="ChainNumber" EnableLoadOnDemand="true"
        ...
        <as:Validator ID="Validator1" runat="server" ValidationFunction="dovalidation" MessageType="Inline" meta:resourcekey="ValidatorResource1">
            <Items>
                <as:CustomValidationItem ClientValidationFunction="ValidateData" ControlToValidateID="uxChain" Message="You have entered an invalid Chain ID. Please try again." />
            </Items>
        </as:Validator>
    </as:ASModalContainer>
    <as:RadCodeBlock ID="uxRadCodeBlock" runat="server">
        ...
        <script type="text/javascript" src="<%=ResolveUrl("~") %>res/js/ModifyMerchantChainModal.js"></script>
    </as:RadCodeBlock>
</asp:Content>
