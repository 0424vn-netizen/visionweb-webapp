<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Title="My Message"
    CodeFile="ServiceMessage_View.aspx.cs" Inherits="ServiceMessage_View" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="Server">
    ...
    <uc:PageTitle ID="uxPageTitle" runat="server" ReportTitle="Service Messages" meta:resourcekey="uxPageTitleResource1" />
    ...
    <tek:RadCodeBlock ID="uxRadCodeBlock" runat="server">
        ...
        <script type="text/javascript" src="<%= ResolveUrl("~/") %>res/js/ServiceMessage_View.js"> </script>
    </tek:RadCodeBlock>
</asp:Content>
