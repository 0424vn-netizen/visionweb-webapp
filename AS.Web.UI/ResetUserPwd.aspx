<%@ Page Title="Reset MS User Password" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ResetUserPwd.aspx.cs" Inherits="ResetUserPwd" ValidateRequest="false" meta:resourcekey="PageResource1" %>

<%@ Register Src="~/UserControls/PageTitle.ascx" TagName="PageTitle" TagPrefix="uc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPage" runat="Server">
     
    <uc:PageTitle ID="uxPageTitle" HasFilteringOption="false" runat="server" ReportTitle="Reset MS User Password" meta:resourcekey="uxPageTitleResource1" /> 
    <div class="row">
        <div class="col-m-12">
                ...
                <div class="form-inline dark-blue">
                    ...
                    <div class="inline-block">
                        ...
                        <as:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn btn-default valign-top"
                            ...
                            OnClick="btnSubmit_Click" IsStandardButton="False" meta:resourcekey="btnSubmitResource1" /> 
                        <div class="">
    ...
    <script src="<%= ResolveUrl("~/")%>res/js/usermaintenance/ResetUserPwd.js"></script>
</asp:Content>
