...
public partial class UserControls_MIF_MerchantDetails_MONETARY : ExportMultiSections
{
    #region Enums
    ...
    private const string FILE_NAME_BUSINESS_INFO = "~/App_Data/tpl_BusinessInformation_FIS.htm";
    ...
    // SPA
    private const string SPA_GET_MERCHANT_PROFILE = "spa_cs_GetMerchantProfile_TSYS_Detail_MONETARY";
    //TK 41447
            ...
            case DataBindAction.BindMerchantDetails:
                ...
                if (dtMerch.Rows.Count > 0)
                {
                    ...
                    foreach (RepeaterItem item in rptMerchantInfo.Items)
                    {
                        ...
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkAssociation", "EntityNumber2", HierarchyMode.MONETARY_ASSOCIATION);
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkBank", "EntityNumber1", HierarchyMode.MONETARY_BANK);
                    }
                }
                else
                {
