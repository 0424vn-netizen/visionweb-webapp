<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Risk_Assignment_Filters.ascx.cs"
    Inherits="UserControls_Risk_Assignment_Filters" %>
<%@ Register Src="~/UserControls/Risk_ApprovalDate.ascx" TagName="Risk_ApprovalDate"
    TagPrefix="uc" %>
...
<%@ Register Src="~/UserControls/Risk_WatchStatus.ascx" TagName="Risk_WatchStatus" TagPrefix="uc" %>
<%@ Register Src="~/UserControls/rm_Filter_HRCode_Modal.ascx" TagName="HRCode" TagPrefix="uc" %>
<%@ Register Src="~/UserControls/Risk_FilterMerchantRank.ascx" TagName="MerchantRank" TagPrefix="uc" %>
<%@ Register Src="~/UserControls/Risk_FilterACHHoldDays.ascx" TagName="ACHHoldDays" TagPrefix="uc" %>
<%@ Register Src="~/UserControls/Risk_FilterOwnerLastName.ascx" TagName="OwnerLastName" TagPrefix="uc" %>
<%@ Register Src="~/UserControls/Risk_FilterZipCode.ascx" TagName="ZipCode2" TagPrefix="uc" %>
<%@ Register Src="~/UserControls/Risk_MerchantFundingStatus.ascx" TagName="MerchantFundingStatus" TagPrefix="uc" %>
<%@ Register Src="~/UserControls/rm_Filter_MerchantClassifications_Modal.ascx" TagName="MerchantClassifications" TagPrefix="uc" %>
...
<%--<as:Validator ID="HieararchyFilterValidator" runat="server" MessageType="Inline"
    ...
    <Items>
        ...
        <as:CustomValidationItem ResMessage="Resources.ValMsg.To_Greater" ClientValidationFunction="ValidateMerchantRangeFromTo"
            ControlToValidateID="txtMerchantRangeFrom" />
        <as:CustomValidationItem ResMessage="Resources.ValMsg.CustomRequired" ClientValidationFunction="ValidateMerchantRangeFromRequired"
            ResParams="Merchant ID From" ControlToValidateID="txtMerchantRangeFrom" />
        <as:CustomValidationItem ResMessage="Resources.ValMsg.CustomRequired" ClientValidationFunction="ValidateMerchantRangeToRequired"
            ResParams="Merchant ID To" ControlToValidateID="txtMerchantRangeTo" />
    </Items>
</as:Validator>--%>
...
<div class="row">
    <div class="col-md-12 in" id="uxAssignmentFiltersGrid">
        <table class="ASTable" style="table-layout: fixed;">
            ...
            <%-- <tr class="AltRow">
                <td class="heading">
                    <as:ValidatorLabel ID="VltLblMerchantRange" runat="server" CssClass="control-label"
                        Text="Merchant ID Range:" ApplyFor="txtMerchantRangeFrom" meta:resourcekey="VltLblMerchantRangeResource1">
                    </as:ValidatorLabel>
                </td>
                <as:ASRadCodeBlock ID="ASRadCodeBlock4" runat="server">
                    <td colspan="<%=FeatureMode == WebSiteEnums.FeatureMode.Edit ?"2":"1"%>">
                        <label class="first">
                            <as:Literal ID="Literal4" runat="server" Text="From" meta:resourcekey="Literal4Resource1"></as:Literal></label>
                        <div class="control-inline">
                            <asp:TextBox ID="txtMerchantRangeFrom" runat="server" Width="160px" MaxLength="16"
                                onkeypress="MerchantRange_OnKeyPress(event);" CssClass="form-control" meta:resourcekey="txtMerchantRangeFromResource1"></asp:TextBox>
                        </div>
                        <label>
                            <as:Literal ID="Literal140" runat="server" Text="To" meta:resourcekey="Literal40Resource1"></as:Literal></label>
                        <div class="control-inline last">

                            <asp:TextBox ID="txtMerchantRangeTo" runat="server" Width="160px" MaxLength="16"
                                onkeypress="MerchantRange_OnKeyPress(event);" CssClass="form-control" meta:resourcekey="txtMerchantRangeToResource1"></asp:TextBox>
                        </div>
                        <as:ValidatorMessage runat="server" ID="txtMerchantRangeFromMsg" ApplyFor="txtMerchantRangeFrom" />
                        <as:ValidatorMessage runat="server" ID="txtMerchantRangeToMsg" ApplyFor="txtMerchantRangeTo" />
                    ...
                    <tr class="AltRow">
                        ...
                        <as:PlaceHolder runat="server" ID="plhHierarchy">
                            <td class="action-column">
                                <a href="#" onclick='return CallHierarchyFilterModal(&#039;rm_Filter_Hierarchy_Modal.aspx?<%# HierarchyFilterQueryString(Eval("HierarchyFilterMode").ToString(),"ctl00_ContentPage_uxFilters_uxHierarchyFilterRepeater_ctl" + GetItemIndexAsString(Container.ItemIndex) + "_btnRefreshHierarchy") %>&#039;, &#039;auto&#039;); return false;'>
            ...
            <tr class="AltRow">
                ...
                <as:PlaceHolder runat="server" ID="plhState">
                    <td class="action-column">
                        <a href="#" onclick="return CallFilterModal1('rm_Filter_State_Modal.aspx', 480, 725); return false;">
                            <as:Literal ID="Literal9" runat="server" Text="Edit" meta:resourcekey="Literal9Resource1"></as:Literal></a>
                    </td>
                </as:PlaceHolder>
            </tr>
            <tr class="Row">
                ...
                <as:PlaceHolder runat="server" ID="plhSIC">
                    <td class="action-column">
                        <a href="#" onclick="return CallFilterModal1('rm_Filter_SIC_Modal.aspx', 480, 725); return false;">
            ...
            <tr class="AltRow">
                ...
                <as:PlaceHolder runat="server" ID="plhProfile">
                    <td class="action-column">
                        <a href="#" onclick="return CallFilterModal1('rm_Filter_Profile_Modal.aspx', 480, 725); return false;">
            ...
            <asp:Panel ID="pnMerchantRank" runat="server" Visible="false">
                <tr class="Row">
                    ...
                    <as:PlaceHolder runat="server" ID="plhMerchantRank">
                        <td class="action-column">
                            <a href="#" onclick="return CallFilterModal1('rm_Filter_MerchantRank_Modal.aspx', 480, 725); return false;">
            ...
            <asp:Panel ID="pnACHHoldDay" runat="server" Visible="false">
                <tr class="AltRow">
                    ...
                    <as:PlaceHolder runat="server" ID="plhAchHoldDay">
                        <td class="action-column">
                            <a href="#" onclick="return CallFilterModal1('rm_Filter_ACHHoldDays_Modal.aspx', 480, 725); return false;">
            ...
            <asp:Panel ID="pnOwnerLastName" runat="server" Visible="false">
                <tr class="Row">
                    ...
                    <as:PlaceHolder runat="server" ID="plhOwnerLastName">
                        <td class="action-column">
                            <a href="#" onclick="return CallFilterModal1('rm_Filter_OwnerLastName_Modal.aspx', 480, 725); return false;">
            ...
            <asp:Panel ID="pnZip3" runat="server" Visible="false">
                <tr class="AltRow">
                    ...
                    <as:PlaceHolder runat="server" ID="plhZipCode">
                        <td class="action-column">
                            <a href="#" onclick="return CallFilterModal1('rm_Filter_ZipCode_Modal.aspx', 480, 725); return false;">
            ...
            <asp:Panel ID="pnMerchantFundingStatus" runat="server" Visible="false">
                <tr class="Row">
                    ...
                    <as:PlaceHolder runat="server" ID="plhMerchantFunding">
                        <td class="action-column">
                            <a href="#" onclick="return CallFilterModal1('rm_Filter_MerchantFundingStatus_Modal.aspx', 480, 725); return false;">
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <as:CheckBox ID="uxChkIsTo" runat="server" onclick="visibleCreditScoreCb(this, 'uxCbCreditScoreTo')" Text="" meta:resourcekey="lbIsSmaller" />
                                    <as:ASRadComboBox ID="uxCbCreditScoreTo" runat="server" DataTextField="DataText" DataValueField="DataKey" Enabled="false" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <as:CheckBox ID="uxChkIsFrom" Width="37px" runat="server" onclick="visibleCreditScoreCb(this, 'uxCbCreditScoreFrom')" Text="" meta:resourcekey="lbIsGreater" />
            ...
            <as:PlaceHolder ID="uxHighRisk" runat="server" Visible="false">
                ...
                <tr class="Row">
                    ...
                    <as:PlaceHolder runat="server" ID="plhHRCode" Visible="False">
                        <td class="action-column">
                            <a href="#" onclick="return CallFilterModal1('rm_Filter_HRCode_Modal.aspx', 480, 725); return false;">
            ...
            <tr id="pnlMerchantClassifications" runat="server" visible="true">
                ...
                <td class="action-column" runat="server" id="pnlMerchantClassificationsEdit">
                    <a href="#" onclick="return CallFilterModal1('rm_Filter_MerchantClassifications_Modal.aspx', 480, 725); return false;">
        ...
        <div class="display-none">
            ...
            <as:Button ID="btnRefreshHierarchy1" runat="server" OnClick="btnRefreshHierarchy_Click" IsStandardButton="False" meta:resourcekey="btnRefreshHierarchy1Resource1" />
...
<as:RadCodeBlock ID="radCodeBlock" runat="server">
    ...
    <script src="<%= ResolveUrl("~/")%>res/js/risk/Risk_Assignment_Filters.js"></script>
</as:RadCodeBlock>
