<%@ Control Language="C#" AutoEventWireup="true" Inherits="UserControls_rm_MCF_RiskReport_UxExport" CodeFile="~/UserControls/rm_MCF_RiskReport_UxExport.ascx.cs" %>
...
<div class="report-export dropdown pull-right" runat="server" id="divExport">
    ...
    <ul class="dropdown-menu">
        ...
        <li id="Li4" runat="server">
            <asp:LinkButton ID="LinkButton4" runat="server" OnClientClick="return ShowExportModal(this, 'PDF')" meta:resourcekey="imgPDFResource1">PDF</asp:LinkButton></li>
    </ul>
...
<as:RadCodeBlock ID="RadCodeBlock1" runat="server">
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~") %>res/js/risk_MCF/rm_MCF_RiskReport_UxExport.js"></script>
</as:RadCodeBlock>
