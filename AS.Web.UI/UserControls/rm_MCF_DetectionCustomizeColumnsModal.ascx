<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_DetectionCustomizeColumnsModal.ascx.cs" Inherits="UserControls_rm_MCF_DetectionCustomizeColumnsModal" %>
...
<tek:RadCodeBlock ID="uxRadCodeBlock" runat="server">
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~") %>res/js/risk_MCF/rm_MCF_DetectionManageCustomViewsModal.js"></script>
</tek:RadCodeBlock>
