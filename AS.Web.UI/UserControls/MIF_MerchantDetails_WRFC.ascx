<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MIF_MerchantDetails_WRFC.ascx.cs"
    Inherits="UserControls_MIF_MerchantDetails_WRFC" %>
                    ...
                    <td class="heading valign-middle">
                        <as:Panel runat="server" ID="uxpnlRMLabel" meta:resourcekey="uxpnlRMLabelResource1">
                            <as:ValidatorLabel ID="ValidatorLabel1" runat="server" Text="Relationship Manager:"
                                ApplyFor="uxtxtRelationShipManager" meta:resourcekey="ValidatorLabel1Resource1">
                            </as:ValidatorLabel>
                        </as:Panel>
                    </td>
                            ...
                            <as:Panel runat="server" ID="uxpnlAddEdit" CssClass="opt-in-out-text w-100" meta:resourcekey="uxpnlAddEditResource1">
                                ...
                                <div class="pull-right">
                                    <as:LinkButton ID="uxbtnAdd" OnClick="uxbtnAdd_click" Text="Add RM" runat="server"
                                        CssClass="btn btn-default" meta:resourcekey="uxbtnAddResource1" />
                                    <as:LinkButton ID="uxbtnEdit" OnClick="uxbtnEdit_click" runat="server" Text="Edit"
                                        CssClass="btn btn-default" meta:resourcekey="uxbtnEditResource1" />
                                </div>
                            </as:Panel>
                            <as:Panel ID="uxpnlSaveCancel" runat="server" Visible="false" meta:resourcekey="uxpnlSaveCancelResource1">
                                ...
                                <div class="pull-right opt-in-out-button">
                                    <as:LinkButton ID="uxbtnSave" OnClick="uxbtnSave_click" OnClientClick="return dovalidation();"
                                        runat="server" Text="Save" CssClass="btn btn-default" meta:resourcekey="uxbtnSaveResource1" />
                                    <as:LinkButton ID="uxbtnCancel" OnClick="uxbtnCancel_click" runat="server" Text="Cancel"
                                        CssClass="btn btn-default" meta:resourcekey="uxbtnCancelResource1" />
                                </div>
                            </as:Panel>
                        ...
                        <as:Validator ID="Validator1" runat="server" ValidationFunction="dovalidation" MessageType="Inline" meta:resourcekey="Validator1Resource1">
                            <Items>
                                <as:CustomValidationItem ClientValidationFunction="CheckPrefix" ControlToValidateID="uxtxtRelationShipManager"
                                    Message="Prefix or suffix (for example Mr./Ms/Sir/Jr.) are not allowed." meta:resourcekey="MIF_MerchantDetail_WRFCJS_Text_UnallowPrefixSuffix" />
                                <as:CustomValidationItem ClientValidationFunction="CheckPrefixSpecial" ControlToValidateID="uxtxtRelationShipManager"
                                    Message="Relationship Manager field must be 30 characters or less and may not include special characters" meta:resourcekey="MIF_MerchantDetails_WRFCJS_Text_AtLeast30NoSpecialChars" />
                            </Items>
                        </as:Validator>
                    </td>
                    <%} %>
                                ...
                                <tr class="AltRow">
                                    ...
                                    <td>
                                        <div class="opt-in-out-text <%# HasMSProductEnvironment()? "mt-1x" :"" %>">
                                            <asp:Literal ID="ltrSiteAccess" runat="server" Text='<%# HasMSProductEnvironment()?Eval("SiteAccess"):GetLocalResourceObject("MIF_MerchantDetails_WRFCJS_Text_NA").ToString() %>' />
                                        </div>
                                        <div class="pull-right opt-in-out-button">
                ...
                <div class="col-md-6">
                            ...
                            <div class="col-md-12 in" id="ciHierarchyInformation">
                                <table class="ASTable">
                                    ...
                                    <tr class="AltRow">
                                        ...
                                        <td class="heading">
                                            <asp:Literal ID="Literal24" runat="server" Text="Group:" meta:resourcekey="LiteralResource24" /></td>
                                        <td>
                                            <as:PlaceHolder ID="PlaceHolder4" runat="server" Visible='<%# CheckHierarchy("WRGROUP") %>'>
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;9715&#039;, &#039;<%# HierarchyMode.WRFC_GROUP %>&#039;, &#039;<%# Eval("Group") %>&#039;);'><%# Eval("Group")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal2" runat="server" Visible='<%# !CheckHierarchy("WRGROUP") %>'
                                                Text='<%# Eval("Group") %>'></as:Literal></td>
                                    </tr>
                                    <tr class="Row">
                                        <td class="heading">
                                            <asp:Literal ID="Literal25" runat="server" Text="Association:" meta:resourcekey="LiteralResource25" /></td>
                                        <td>
                                            <as:PlaceHolder ID="uxHGroup" runat="server" Visible='<%# CheckHierarchy("WRASSO") %>'>
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;9716&#039;, &#039;<%# HierarchyMode.WRFC_ASSO %>&#039;, &#039;<%# Eval("Association") %>&#039;);'><%# Eval("Association")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal1" runat="server" Visible='<%# !CheckHierarchy("WRASSO") %>'
                                                Text='<%# Eval("Association") %>'></as:Literal></td>
                                        <td class="heading">
                                            <asp:Literal ID="Literal26" runat="server" Text="Chain:" meta:resourcekey="LiteralResource26" /></td>
                                        <td>
                                            <as:PlaceHolder ID="uxPlaceChain" runat="server">
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;9717&#039;, &#039;<%# HierarchyMode.WRFC_CHAIN %>&#039;, &#039;<%# Eval("Chain") %>&#039;);'><%# Eval("Chain")%></a>
                                            </as:PlaceHolder>
                                            <as:PlaceHolder ID="uxPlaceChainNew" runat="server" Visible='<%# CheckPermissionAddEditChain(Eval("SiteAccess")) %>'>
                                                <a href="#" onclick="return ShowPopupModal('CreateNewChainModal.aspx?'+'<%# Page.BuildSecureQueryString("MerchNum="+Eval("MerchantNumber")) %>','auto');">
                                                    <asp:Literal ID="Literal27" runat="server" Text="Create New Chain" meta:resourcekey="LiteralResource27" /></a>
                                            </as:PlaceHolder>
                                            <as:PlaceHolder ID="uxPlaceExistChain" runat="server" Visible='<%# CheckPermissionAddEditChain(Eval("SiteAccess")) %>'>
                                                <asp:Literal ID="Literal10" runat="server" Text="or" meta:resourcekey="LiteralResourceOR"></asp:Literal>  <a href="#" onclick="return ShowPopupModal('ModifyMerchantChainModal.aspx?'+'<%# Page.BuildSecureQueryString("MerchNum="+Eval("MerchantNumber")+"&Chain="+Eval("Chain")) %>','auto');">
                                                    <asp:Literal ID="Literal28" runat="server" Text="Add to Existing Chain" meta:resourcekey="LiteralResource28" /></a>
                                            </as:PlaceHolder>
                    ...
                    <div class="row" id="bankinfo">
                        <div class="col-xs-12" data-toggle="collapse" data-target="#ciBankInformation">
                            <h2 class="grid-title">
                                <asp:Literal ID="Literal29" runat="server" Text="Bank Information" meta:resourcekey="LiteralResource29" /></h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 in" id="ciBankInformation">
                            <table class="ASTable">
                                ...
                                <tr class="Row">
                                    <td class="heading">
                                        <asp:Literal ID="Literal32" runat="server" Text="Bank Name:" meta:resourcekey="LiteralResource32" /></td>
                                    <td>
                                        <%# Eval("BankName")%>
                                    </td>
                                </tr>
                                <tr class="AltRow">
                                    <td class="heading">
                                        <asp:Literal ID="Literal33" runat="server" Text="Routing #:" meta:resourcekey="LiteralResource33" /></td>
                                    <td>
                                ...
                                <tr class="Row">
                                    <td class="heading">
                                        <asp:Literal ID="Literal34" runat="server" Text="DDA #:" meta:resourcekey="LiteralResource34" /></td>
                                    <td>
