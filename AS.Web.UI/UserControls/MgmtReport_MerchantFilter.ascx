<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MgmtReport_MerchantFilter.ascx.cs"
    Inherits="UserControls_MgmtReport_MerchantFilter" %>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                    ...
                    <as:ASGridBoundColumn DataField="Entity" UniqueName="Entity" HeaderText="Merchant ID"
                        HeaderTooltip="Merchant ID"
...
<tek:RadCodeBlock ID="RadCodeBlock1" runat="server">
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~") %>res/js/risk/MgmtReport_MerchantFilter.js"></script>
</tek:RadCodeBlock>
