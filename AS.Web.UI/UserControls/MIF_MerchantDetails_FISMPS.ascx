<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MIF_MerchantDetails_FISMPS.ascx.cs" Inherits="UserControls_MIF_MerchantDetails_FISMPS" %>
...
<asp:PlaceHolder ID="phdMerchantDetail" runat="server">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row" id="businessinfo">
                        ...
                        <div class="col-xs-3">
                            <div class="report-export dropdown pull-right" runat="server" id="divExport" visible='<%# !IsCaseManagement %>'>
                                <ul class="dropdown-menu">
                                    <li id="uxLiExcel" runat="server">
                                        <asp:LinkButton ID="imgExcel" runat="server" meta:resourcekey="imgExcelResource1">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li id="Li1" runat="server">
                                            <asp:LinkButton ID="LinkButton1" runat="server" meta:resourcekey="LinkButton1Resource1">
                                                <asp:Literal ID="Literal22" runat="server" Text="Excel" meta:resourcekey="LiteralResource22" />
                                            </asp:LinkButton></li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <table class="ASTable">
                                    ...
                                    <tr class="Row">
                                       <td class="heading valign-middle">
                                        ...
                                        <td class="heading valign-middle">
                                            <asp:Literal ID="Literal46" runat="server" Text="Chain:" meta:resourcekey="LiteralResource40" /></td>
                                        <td>
                                            <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;2205&#039;, &#039;MPSCHAIN&#039;, &#039;<%# Eval("MPSChain") %>&#039;);'><%# Eval("MPSChain")%></a>
                                        </td>
                                        
                                    </tr>
                                    <tr class="AltRow">
                                        <td class="heading valign-middle">
                                            <asp:Literal ID="Literal44" runat="server" Text="Agent:" meta:resourcekey="LiteralResource144" /></td>
                                        <td>
                                            <as:PlaceHolder ID="PlaceHolder2" runat="server">
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;2204&#039;, &#039;MPSAGENT&#039;, &#039;<%# Eval("Agent") %>&#039;);'><%# Eval("Agent")%></a>
                                            </as:PlaceHolder>
                                        </td>
                                        <td class="heading valign-middle">
                                            <asp:Literal ID="Literal40" runat="server" Text="MIC Chain:" meta:resourcekey="LiteralResource140" /></td>
                                        <td>
                                            <as:PlaceHolder ID="PlaceHolder3" runat="server" Visible='<%# string.IsNullOrEmpty(Eval("Chain").ToString())? false: true %>'>
                                            ...
                                            <as:PlaceHolder ID="uxPlaceChainNew" runat="server" Visible='<%# CheckPermissionAddEditChain(Eval("SiteAccess")) %>'>
                                                <a href="#" onclick="return ShowPopupModal('CreateNewChainModal.aspx?'+'<%# Page.BuildSecureQueryString("MerchNum="+Eval("MerchantNumber")) %>','auto');">
                                                    <asp:Literal ID="Literal41" runat="server" Text="Create New MIC Chain" meta:resourcekey="LiteralResource41" /></a>
                                            </as:PlaceHolder>
                                            <as:PlaceHolder ID="uxPlaceExistChain" runat="server" Visible='<%# CheckPermissionAddEditChain(Eval("SiteAccess")) %>'>
                                                ...
                                                <a href="#" onclick="return ShowPopupModal('ModifyMerchantChainModal.aspx?'+'<%# Page.BuildSecureQueryString("MerchNum="+Eval("MerchantNumber")+"&Chain="+Eval("Chain")) %>','auto');">                                                    
                                                    <asp:Literal ID="Literal43" runat="server" Text="Add to Existing MIC Chain" meta:resourcekey="LiteralResource43" />
                                                </a>
                                            </as:PlaceHolder>
                                            </td>
                                    </tr>
                                ...
                                <ul class="dropdown-menu">
                                    <li id="Li2" runat="server">
                                        <asp:LinkButton ID="LinkButton2" runat="server"  meta:resourcekey="LinkButton2Resource1">
                                            <asp:Literal ID="Literal30" runat="server" Text="Excel" meta:resourcekey="LiteralResource30" />
                                        </asp:LinkButton></li>
                                </ul>
                            </div>
                        </div>
    ...
    <as:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" src="<%=ResolveUrl("~") %>res/js/MIF_MerchantDetails_FISMPS.js"></script>
    </as:RadCodeBlock>
</asp:PlaceHolder>
