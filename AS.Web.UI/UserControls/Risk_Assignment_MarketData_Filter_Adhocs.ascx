<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Risk_Assignment_MarketData_Filter_Adhocs.ascx.cs" Inherits="UserControls_Risk_Assignment_MarketData_Filter_Adhocs" %>
<%@ Register Src="~/UserControls/Risk_ApprovalDate.ascx" TagName="AppDate" TagPrefix="uc" %>
...
<as:Validator ID="HieararchyFilterValidator" runat="server"
    ...
    <Items>
        ...
        <as:BasicValidationItem Rule="Number" Message="Only numbers are allowed in Merchant ID field." 
   ...
   <%-- <tr align="left" class="MPSBorderAltRow">
    ...
    <as:RadCodeBlock ID="RadCodeBlock3" runat="server">        
        <td colspan="<%=FeatureMode == WebSiteEnums.FeatureMode.Edit ?"2":"1"%>" >
            <table>
                <tr>
                    <td style="font-weight:bold; padding:0;"><as:Literal ID="Literal3" runat="server" Text="Merchant ID Range:" meta:resourcekey="Literal3Resource1"></as:Literal></td>
