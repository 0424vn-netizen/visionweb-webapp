<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MIF_MerchantDetails_SignaPay.ascx.cs" Inherits="UserControls_MIF_MerchantDetails_SignaPay" %>
                            ...
                            <div class="col-md-12 in" id="ciHierarchyInformation">
                                <table class="ASTable">
                                    ...
                                    <tr class="Row">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxBank" runat="server" Visible='<%# CheckHierarchy("SIGNABNK") %>'>
                                                <a href="#" id="uxLinkBank" runat="server"><%= BindValue("EntityNumber1")%></a>
                                            </as:PlaceHolder>
                                             <as:Literal ID="Literal12" runat="server" Text='<%# Eval("EntityNumber1") %>' Visible='<%# !CheckHierarchy("SIGNABNK") %>'></as:Literal>                                
                                        </td>
                                    </tr>
                                    <tr class="AltRow">
                                        <td class="heading">
                                        ...
                                        <td>
                                             <as:PlaceHolder ID="uxAssociation" runat="server" Visible='<%# CheckHierarchy("SIGNAASSO") %>'>
                                                <a href="#" id="uxLinkAssociation" runat="server"><%= BindValue("EntityNumber2")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal21" runat="server" Text='<%# Eval("EntityNumber2") %>' Visible='<%# !CheckHierarchy("SIGNAASSO") %>'></as:Literal>  
                                        </td>
                                    </tr>
