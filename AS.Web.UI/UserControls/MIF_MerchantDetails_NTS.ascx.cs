...
public partial class UserControls_MIF_MerchantDetails_NTS : ExportMultiSections
{
    #region Constants

    // Path
    private string PATH_EXPORT_EXCEL_FILE = ConfigurationManager.AppSettings["ExportTempFolder"];
    private const string PATH_BANK_INFO_TPL_FILE = "~/App_Data/tpl_BankInformation_NTS.htm";
    private const string PATH_HI_TPL_FILE = "~/App_Data/tpl_HierarchyInformation_NTS.htm";
    private const string PATH_BI_TPL_FILE = "~/App_Data/tpl_BusinessInformation_NTS.htm";
    ...
    private const string FILE_NAME_MEMOS_INFO = "Merchant Memos";
    private const string MECHANT_INFO = "Merchant Information";
    private const string SPA_GET_MERCHANT_PROFILE = "spa_cs_GetMerchantProfile_NTS";
    private const string OPTED_IN = "Opted In";
    private const string MERCHANT_INFOMATION = "MerchantInfomation";
    private const string OPT_STATUS = "OptStatus";
    private const string MIF_EMAIL = "MifEmail";
    private const string TEMP_STR = "TempStr";
    private const string MERCHANT_NUMBER = "MerchantNumber";
    private const string LAST_BATCH_DATE = "LastBatchDate";
    private const string OPTED_IN1 = "Opted";
    private const string OPTED_IN2 = "Opted";
    private const string OPTED_IN3 = "Opted";
    private const string OPTED_IN4 = "Opted";
    private const string OPTED_IN5 = "Opted";
    private const string OPTED_IN6 = "Opted";
    #endregion Constants
    ...
    public DataTable MifTable
    {
        get
        {
            return ViewState[MERCHANT_INFOMATION] != null ?
                (DataTable)(ViewState[MERCHANT_INFOMATION]) : null;
        }
        set
        {
            ViewState[MERCHANT_INFOMATION] = value;
        }
    }
    ...
    protected string OptedIn
    {
        get
        {
            return (string)ViewState[OPT_STATUS];
        }
        set
        {
            ViewState[OPT_STATUS] = value;
        }
    }
    ...
    protected string MifEmail
    {
        get
        {
            return (string)ViewState[MIF_EMAIL];
        }
        set
        {
            ViewState[MIF_EMAIL] = value;
        }
    }
    ...
    protected string TempStr
    {
        get
        {
            return (string)ViewState[TEMP_STR];
        }
        set
        {
            ViewState[TEMP_STR] = value;
        }
    }
    ...
    protected string MerchantNumber
    {
        get
        {
            return (string)ViewState[MERCHANT_NUMBER];
        }
        set
        {
    ...
    private string LastBatchDate
    {
        get
        {
            return (string)ViewState[LAST_BATCH_DATE];
        }
        set
        {
            ViewState[LAST_BATCH_DATE] = value;
        }
    }
    ...
    public void DoMultiExportExcel()
    {
        ...
        //exportNames.Add(0, MECHANT_INFO);
        //exportNames.Add(1, FILE_NAME_BI );
        //exportNames.Add(2, FILE_NAME_HI);
        //exportNames.Add(3, FILE_NAME_BANK_INFO);
        //exportNames.Add(4, FILE_NAME_MEMOS_INFO);

        exportNames.Add(0, GetLocalResourceObject("LiteralResource1.Text").ToString());
        exportNames.Add(1, GetLocalResourceObject("MIF_MerchantDetails_NTS_Text_BusinessInformation").ToString());
        if (IsRiskInformation  )
        {
            exportNames.Add(2, GetLocalResourceObject("MIF_MerchantDetails_Text_RiskInformation").ToString());
            exportNames.Add(3, GetLocalResourceObject("MIF_MerchantDetails_NTS_Text_HierarchyInformation").ToString());
            exportNames.Add(4, GetLocalResourceObject("MIF_MerchantDetails_NTS_Text_BankInformation").ToString());
            exportNames.Add(5, GetLocalResourceObject("MIF_MerchantDetails_Text_NTS").ToString());
        }
        else
        {
            exportNames.Add(2, GetLocalResourceObject("MIF_MerchantDetails_NTS_Text_HierarchyInformation").ToString());
            exportNames.Add(3, GetLocalResourceObject("MIF_MerchantDetails_NTS_Text_BankInformation").ToString());
            exportNames.Add(4, GetLocalResourceObject("MIF_MerchantDetails_Text_NTS").ToString());
        }
    ...
    protected string ButtonExcelBusinessInformation_Click()
    {
       ...
       strExcelTemplate.Replace("BI_APPROVAL_DATE",
        ...
        string excelFileName = GeneralFuncsLib.GetFileName(FILE_NAME_BI);
    ...
    protected string ButtonExcelHierarchyInformation_Click()
    {
        ...
        string excelFileName = GeneralFuncsLib.GetFileName(FILE_NAME_HI);
        return WriteContentToFile(PATH_EXPORT_EXCEL_FILE, excelFileName, "xls", strExcelTemplate.ToString());
    }
    ...
    protected string ButtonExcelBankInformation_Click()
    {
        ...
        string excelFileName = GeneralFuncsLib.GetFileName(FILE_NAME_BANK_INFO);
        return WriteContentToFile(PATH_EXPORT_EXCEL_FILE, excelFileName, "xls", strExcelTemplate.ToString());
    }
    ...
    protected string ButtonExcelMerchantInformation_Click()
    {
        ...
        string excelFileName = GeneralFuncsLib.GetFileName(MECHANT_INFO);
        return WriteContentToFile(PATH_EXPORT_EXCEL_FILE, excelFileName, "xls", strExcelTemplate.ToString());
    }
