...
public partial class UserControls_rm_MCF_AQAggregateReport : GlobalUserControl
{
    enum DataBindAction
    {
        BindAQAggregateGrid
    ...
    private const string SPA_GET_AQ_AGGREGATE_AS = "spa_RM_MCF_AutoQueue_Get_BarometerReport";
