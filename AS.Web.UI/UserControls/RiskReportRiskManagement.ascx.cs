...
public partial class UserControls_RiskReportRiskManagement : GlobalUserControl
{
    #region Fields
            ...
            case DataBindAction.BindVolumeTicket:
                {
                    ...
                    info = WebServices.RiskServices.GetReports("spa_rm_cs_GetVolumeTicketAnalysis", parameters);
            ...
            case DataBindAction.BindChargebackRetrievalAnalysis:
                {
                    ...
                    parameters.Add(new FilterParameter("@ReportDate", DateTime.Today, DbType.Date));
                    parameters.Add(new FilterParameter("@MerchantNumber", this.MerchantNumber, DbType.String));
                    info = WebServices.RiskServices.GetReports("spa_rm_cs_GetRetrievalChargebackAnalysis", parameters);
            ...
            case DataBindAction.BindAuthorization:
                {
                    ...
                    parameters.Add(new FilterParameter("@ReportDate", DateTime.Today, DbType.Date));
                    parameters.Add(new FilterParameter("@MerchantNumber", this.MerchantNumber, DbType.String));
                    info = WebServices.RiskServices.GetReports("spa_rm_cs_GetPercentAuthOfSalesAnalysis", parameters);
            ...
            case DataBindAction.BindKeyedAnalysis:
                {
                    ...
                    parameters.Add(new FilterParameter("@ReportDate", DateTime.Today, DbType.Date));
                    parameters.Add(new FilterParameter("@MerchantNumber", this.MerchantNumber, DbType.String));
                    info = WebServices.RiskServices.GetReports("spa_rm_cs_GetKeyedAnalysis", parameters);
            ...
            case DataBindAction.BindDailyForeignCard:
                {
                    ...
                    parameters.Add(new FilterParameter("@ReportDate", DateTime.Today, DbType.Date));
                    parameters.Add(new FilterParameter("@MerchantNumber", this.MerchantNumber, DbType.String));
                    info = WebServices.RiskServices.GetReports("spa_rm_cs_GetDailyForeignCardAnalysis", parameters);
            ...
            case DataBindAction.BindACHAnalysis:
                {
                    ...
                    parameters.Add(new FilterParameter("@ReportDate", DateTime.Today, DbType.Date));
                    parameters.Add(new FilterParameter("@MerchantNumber", this.MerchantNumber, DbType.String));
                    info = WebServices.RiskServices.GetReports("spa_rm_cs_GetACHRejectAnalysis", parameters);
    ...
    private DataTable LoadContractualData(FilterParameterCollection parameters)
    {
        ...
        parameters.Add(new FilterParameter("@ReportDate", DateTime.Today, DbType.Date));
        parameters.Add(new FilterParameter("@MerchantNumber", this.MerchantNumber, DbType.String));
        info = WebServices.RiskServices.GetReports("spa_rm_cs_GetContractualAnalysis", parameters);
        return info;
    }
