...
public partial class UserControls_rm_MCF_Assignment_Parameters_Adhoc : GlobalUserControl, IRiskParamFilter
{
    enum DataBindAction
    {
        BindParameterList
                            ...
                            case "rm_MCF_ParameterFilter_TransactionCodeModal.aspx":
                                {
                                    ...
                                    ht = string.Format(ht, titleParameter + ": ", "'rm_MCF_ParameterFilter_TransactionCodeModal.aspx?{0}','{1}','{2}', 850, 725", 
                                        transactionCode, "tracking-key=\"" + paramId + "_TransactionCode\" tracking-text=\"" + paramId + "_TransactionCode\"", "transactionCode",
                                        "tracking-TransactionCode", tracking);
