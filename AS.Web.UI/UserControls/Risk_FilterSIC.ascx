<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Risk_FilterSIC.ascx.cs"
    Inherits="UserControls_Risk_FilterSIC" %>
    ...
    <div class="col-xs-6 on-top">
        ...
        <as:ASRadAjaxPanel runat="server" ID="RadAjaxPanel1">
            <asp:RadioButtonList ID="uxRadioMode" runat="server" RepeatDirection="horizontal"
                ...
                <asp:ListItem Text="Include"></asp:ListItem>
                <asp:ListItem Text="Exclude"></asp:ListItem>
            </asp:RadioButtonList>
        </as:ASRadAjaxPanel>
    </div>
...
<as:RadCodeBlock ID="RadCodeBlock1" runat="server">
    ...
    <script src="<%= ResolveUrl("~/")%>res/js/risk/Risk_FilterSIC.js"></script>
</as:RadCodeBlock>
