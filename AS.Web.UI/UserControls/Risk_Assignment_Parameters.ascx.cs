...
public partial class UserControls_Risk_Assignment_Parameters : GlobalUserControl, IRiskParamFilter
{
    ...
    private int SaveParameters()
    {
        ...
        if (paramList != null)
        {
            ...
            return WebServices.RiskServices.ExecuteNonQueryCommand("spa_rm_cs_SaveParameterListByAssignment", filterParameters, out paramOut);
        }
        return 0;
    }
    #endregion
    ...
    protected void Page_Load()
    {
        ...
        Literal1.Text = Literal1.Text.ToCurrencySymbol();
    }
    ...
    private DataTable GetAssignmentParameters()
    {
        ...
        return WebServices.RiskServices.GetReports("spa_rm_cs_GetParametersByAssignment", parameters);
    }
                    ...
                    if (modalType != "")
                    {
                        ...
                        switch (modalType)
                        {
                            case "rm_ParameterFilter_TransactionCodeModal.aspx":
                                {
                                    lblParamfilter.Text = VeraCodeSolution.ValidateResponseData(UserControls_Risk_ParameterFilter_TransactionCode.GetSelectedValuesAsString(Mode, PrimaryID, row["ParameterKey"].ToString(), FilterID));
                                    ht = string.Format(ht, "Auth Transaction Code", "'rm_ParameterFilter_TransactionCodeModal.aspx?{0}','{1}','{2}', 850, 725");
    ...
    protected void uxClose_Click(object sender, EventArgs e)
    {
        ...
        {
            case "rm_ParameterFilter_TransactionCodeModal.aspx":
                lblParamfilter.Text = VeraCodeSolution.ValidateResponseData(UserControls_Risk_ParameterFilter_TransactionCode.GetSelectedValuesAsString(Mode, PrimaryID, paramkey, FilterID));
                break;
        }
    }
