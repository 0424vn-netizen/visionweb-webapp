<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MIF_MerchantDetails_GreenBox.ascx.cs" Inherits="UserControls_MIF_MerchantDetails_GreenBox" %>
                        ...
                        <div class="row">
                            <div class="col-md-12 in" id="ciHierarchyInformation">
                                <table class="ASTable">
                                    ...
                                    <tr class="Row">
                                        <td class="heading">
                                            <asp:Literal ID="Literal32" runat="server" Text="Business Chain:" meta:resourcekey="LiteralResource31" />
                                        </td>
                                        <td>
                                            <as:PlaceHolder ID="uxBusinessChain" runat="server" Visible='<%# CheckHierarchy("BUSINESSCHAIN") %>'>
                                                <a id="uxLinkBusinessChain" class="pointer" runat="server"><%= BindValue("BusinessChain")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal12" runat="server" Text='<%# Eval("BusinessChain") %>' Visible='<%# !CheckHierarchy("BUSINESSCHAIN") %>'></as:Literal>
                                        </td>
                                    </tr>
                                    <tr class="AltRow">
                                        <td class="heading">
                                            <asp:Literal ID="Literal33" runat="server" Text="Bank Chain:" meta:resourcekey="LiteralResource34" /></td>
                                        <td>
                                            <as:PlaceHolder ID="uxBankChain" runat="server" Visible='<%# CheckHierarchy("BANKCHAIN") %>'>
                                                <a id="uxLinkBankChain" class="pointer" runat="server"><%= BindValue("BankChain")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal21" runat="server" Text='<%# Eval("BankChain") %>' Visible='<%# !CheckHierarchy("BANKCHAIN") %>'></as:Literal>
                                        </td>
                                    </tr>
                                    <tr class="Row">
                                        <td class="heading">
                                            <asp:Literal ID="Literal29" runat="server" Text="Corporate Chain:" meta:resourcekey="LiteralResource81" />
                                        </td>
                                        <td>
                                            <as:PlaceHolder ID="PlaceHolder2" runat="server" Visible='<%# CheckHierarchy("CORPORATECHAIN") %>'>
                                                <a id="uxLinkCorporateChain" class="pointer" runat="server"><%= BindValue("CorporateChain")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal30" runat="server" Text='<%# Eval("CorporateChain") %>' Visible='<%# !CheckHierarchy("CORPORATECHAIN") %>'></as:Literal>
                                        </td>
                                    </tr>
                                    <tr class="AltRow">
                                        <td class="heading">
                                            <asp:Literal ID="Literal31" runat="server" Text="Agent Chain:" meta:resourcekey="LiteralResource82" /></td>
                                        <td>
                                            <as:PlaceHolder ID="PlaceHolder3" runat="server" Visible='<%# CheckHierarchy("AGENTCHAIN") %>'>
                                                <a id="uxLinkAgentChain" class="pointer" runat="server"><%= BindValue("AgentChain")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal54" runat="server" Text='<%# Eval("AgentChain") %>' Visible='<%# !CheckHierarchy("AGENTCHAIN") %>'></as:Literal>
                                        </td>
                                    </tr>
