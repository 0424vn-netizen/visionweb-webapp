<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_Assignment_Filters.ascx.cs"
    Inherits="UserControls_rm_MCF_Assignment_Filters" %>
...
<%@ Register Src="~/UserControls/rm_MCF_Assignment_Filter_Custom.ascx" TagName="CustomFilter" TagPrefix="uc" %>
...
<%@ Register Src="~/UserControls/rm_MCF_Assignment_Filter_Standard.ascx" TagName="RiskStandardFilter" TagPrefix="uc" %>
...
<%@ Register Src="~/UserControls/rm_MCF_PauseMerchantAlert.ascx" TagName="PauseMerchantAlert" TagPrefix="uc" %>
...
<as:RadAjaxManagerProxy ID="RadAjaxManagerProxyReview" runat="server">
    <AjaxSettings>
        ...
        <tek:AjaxSetting AjaxControlID="btnAddPauseMerchantAlert">
            <UpdatedControls>
                <tek:AjaxUpdatedControl ControlID="uxPauseMerchantAlert" LoadingPanelID="customLoadingPanel" />
            </UpdatedControls>
        </tek:AjaxSetting>

        <tek:AjaxSetting AjaxControlID="btnRiskRating">
            <UpdatedControls>
                <tek:AjaxUpdatedControl ControlID="divRiskRating" />
                <tek:AjaxUpdatedControl ControlID="hdnCountSelectedFilter" />
            </UpdatedControls>
        </tek:AjaxSetting>
...
<div class="row">
    <div class="col-md-12" data-toggle="collapse" data-target="#uxAssignmentFiltersGrid">
        <h2 class="grid-title">
            <as:Literal ID="ltAssignmentFilter" runat="server" Text="Assignment Filters" meta:resourcekey="ltAssignmentFilterResource1"></as:Literal>
        </h2>
    </div>
</div>
<div class="row">
        ...
        <table class="ASTable" style="table-layout: fixed;">
            ...
            <tr class="section-heading">
                <td class="heading valign-middle">
                    <as:Literal ID="Literal2" runat="server" Text="Summary" meta:resourcekey="Literal2Resource1"></as:Literal></td>
                ...
                <label class="first last">
                    <as:Literal ID="Literal1" runat="server" Text="Merchant Count:" meta:resourcekey="Literal1Resource1"></as:Literal>
                </label>
                ...
                <div class="control-inline">
                    <asp:Panel ID="plhRefesh" runat="server" meta:resourcekey="plhRefeshResource1">
                        <asp:Button runat="server" ID="uxBtnMerchantCount" OnClientClick="CalculateMerchantCount(); return false;"
                            Text="Refresh" CssClass="btn btn-default" meta:resourcekey="uxBtnMerchantCountResource1" />
                    </asp:Panel>
                </div>

                </td> 
            </tr>
            <as:PlaceHolder ID="uxPhatchStatus" runat="server">
                <tr class="Row">
                    <td class="heading">
                        <label class="control-label">
                            <as:Literal ID="Literal3" runat="server" Text="Watch Status:" meta:resourcekey="Literal3Resource1"></as:Literal></label>
                    </td>
            ...
            <tr class="Row">
                <td class="heading">
                    <label class="control-label">
                        <as:Literal ID="Literal5" runat="server" Text="Approval Date:" meta:resourcekey="Literal5Resource1"></as:Literal></label>
                </td>
            ...
            <tr class="Row">
                <td class="heading">
                    <label class="control-label">
                        <as:Literal ID="Literal4" runat="server" Text="First Batch Date:" meta:resourcekey="Literal41Resource1"></as:Literal></label>
                </td>
            ...
            <tr class="Row">
                <td class="heading">
                    <label class="control-label">
                        <span id="lbTitleSessionPauseMerchantAlert">Pause Merchant Alert:</span>
                    </label>
                </td>
                <as:ASRadCodeBlock ID="ASRadCodeBlock8" runat="server">
                    <td colspan="<%=FeatureMode == WebSiteEnums.FeatureMode.Edit ?"2":"1"%>">
                </as:ASRadCodeBlock>
                <uc:PauseMerchantAlert runat="server" ID="uxPauseMerchantAlert" />
                <as:LinkButton ID="btnAddPauseMerchantAlert" CssClass="mt-4px display-inline-block fs-14" runat="server" Text="+ Add Condition" OnClientClick="return pauseMerchantAlert_Add();" OnClick="btnAddPauseMerchantAlert_Click"></as:LinkButton>
                </td>               
            </tr>
            <%--PMA--%>
            ...
            <as:PlaceHolder ID="plhAllMerchants" runat="server" Visible="False">
                <td class="heading">
                    <label class="control-label">
                        <as:Literal ID="Literal6" runat="server" Text="All Merchants:" meta:resourcekey="Literal6Resource1"></as:Literal></label>
                </td>
                <as:ASRadCodeBlock ID="ASRadCodeBlock1" runat="server">
                    <td colspan="<%=FeatureMode == WebSiteEnums.FeatureMode.Edit ?"2":"1"%>">
                        <as:CheckBox tracking-required="true" tracking-key="AllMerchants" tracking-type="checkbox" ID="chkAllMerchants" runat="server" meta:resourcekey="chkAllMerchantsResource1" />
                    </td>
                </as:ASRadCodeBlock>
            </as:PlaceHolder>
            ...
            <asp:Repeater ID="uxHierarchyFilterRepeater" runat="server" OnItemDataBound="uxHierarchyFilterRepeater_ItemDataBound">
                <ItemTemplate>
                    ...
                    <as:PlaceHolder ID="uxGroupHierarchyView" runat="server">
                        <tr class="section-heading">
                            <td colspan="2">
                                <asp:Label ID="uxGroupHierarchyTitleView" runat="server" meta:resourcekey="uxGroupHierarchyTitleViewResource2"></asp:Label>
                            </td>
                        </tr>
                    </as:PlaceHolder>
                    <tr class="AltRow">
                        ...
                        <td>
                            <div>
                                <as:Panel ID="divHierarchy" runat="server" meta:resourcekey="divHierarchyResource2">
                                    <asp:Label ID="lblHierarchy" tracking-key='<%# Eval("HierarchyFilterMode") %>' tracking-type="hierarchy" runat="server" Text="N/A" meta:resourcekey="lblHierarchyResource2"></asp:Label>
                                </as:Panel>
                            </div>
                        </td>
                        <as:PlaceHolder runat="server" ID="plhHierarchy" Visible="<%#FeatureMode == WebSiteEnums.FeatureMode.Edit%>">
                            <td class="action-column">
                                <a href="#" onclick='return CallHierarchyFilterModal(&#039;rm_MCF_Filter_Hierarchy_Modal.aspx?<%# HierarchyFilterQueryString(Eval("HierarchyFilterMode").ToString(),"ctl00_ContentPage_uxFilters_uxHierarchyFilterRepeater_ctl" + GetItemIndexAsString(Container.ItemIndex) + "_btnRefreshHierarchy") %>&#039;, &#039;auto&#039;); return false;'>
                                    <as:Literal ID="Literal6" runat="server" Text="Edit" meta:resourcekey="Literal6Resource3"></as:Literal></a>
                ...
                <AlternatingItemTemplate>
                    ...
                    <as:PlaceHolder ID="uxGroupHierarchyView" runat="server">
                        <tr class="section-heading">
                            <td colspan="2">
                                <asp:Label ID="uxGroupHierarchyTitleView" runat="server" meta:resourcekey="uxGroupHierarchyTitleViewResource1"></asp:Label>
                            </td>
                        </tr>
                    </as:PlaceHolder>
                    <tr class="Row">
                        ...
                        <td>
                            <div>
                                <as:Panel ID="divHierarchy" runat="server" meta:resourcekey="divHierarchyResource1">
                                    <asp:Label ID="lblHierarchy" tracking-key='<%# Eval("HierarchyFilterMode") %>' tracking-type="hierarchy" runat="server" Text="N/A" meta:resourcekey="lblHierarchyResource1"></asp:Label>
                                </as:Panel>
                            </div>
                        </td>
                        <as:PlaceHolder runat="server" ID="plhHierarchy" Visible="<%#FeatureMode == WebSiteEnums.FeatureMode.Edit%>">
                            <td class="action-column">
                                <a href="#" onclick='return CallHierarchyFilterModal(&#039;rm_MCF_Filter_Hierarchy_Modal.aspx?<%# HierarchyFilterQueryString(Eval("HierarchyFilterMode").ToString(),"ctl00_ContentPage_uxFilters_uxHierarchyFilterRepeater_ctl" + GetItemIndexAsString(Container.ItemIndex) + "_btnRefreshHierarchy") %>&#039;, &#039;auto&#039;); return false;'>
                                    <as:Literal ID="Literal6" runat="server" Text="Edit" meta:resourcekey="Literal6Resource2"></as:Literal></a>
                                <as:Button ID="btnRefreshHierarchy" runat="server" OnCommand="btnRefreshHierarchy_Command"
            ...
            <uc:SourceHierarchy ID="uxSourceHierarchy" runat="server" />
            <as:PlaceHolder ID="uxGroupDemographicEdit" runat="server" Visible="False">
                <tr class="section-heading">
                    <td colspan="3">
                        <as:Literal ID="Literal7" runat="server" Text="Demographic" meta:resourcekey="Literal7Resource1"></as:Literal>
                    </td>
                </tr>
            </as:PlaceHolder>
            <as:PlaceHolder ID="uxGroupDemographicView" runat="server" Visible="False">
                <tr class="section-heading">
                    <td colspan="2">
                        <as:Literal ID="Literal8" runat="server" Text="Demographic" meta:resourcekey="Literal8Resource1"></as:Literal>
                    </td>
                </tr>
            </as:PlaceHolder>
            <tr class="AltRow">
                <td class="heading">
                    <as:RadCodeBlock ID="RadCodeBlock1" runat="server">
                        <%=  STATE_LABEL_TEXT == string.Empty ? GetLocalResourceObject("Risk_Assignment_Filter_ascx_State").ToString() : STATE_LABEL_TEXT%>:
                    </as:RadCodeBlock>
                </td>
                <td>
                    <div>
                        <div id="divState" runat="server">
                            <asp:Label ID="lblState" tracking-key="State" runat="server" Text="N/A" meta:resourcekey="lblStateResource1"></asp:Label>
                        </div>
                    </div>
                </td>
            ...
            <tr class="Row">
                <td class="heading">
                    <as:Literal ID="Literal10" runat="server" Text="SIC:" meta:resourcekey="Literal10Resource1"></as:Literal></td>
                <td>
                    <div id="divSIC" runat="server">
                        <asp:Label ID="lblSIC" tracking-key="SIC" tracking-type="hierarchy" runat="server" Text="N/A" meta:resourcekey="lblSICResource1"></asp:Label>
                    </div>
                </td>
                <as:PlaceHolder runat="server" ID="plhSIC">
                    <td class="action-column">
                        <a href="#" onclick="return CallFilterModal1('rm_MCF_Filter_SIC_Modal.aspx', 480, 725); return false;">
                            <as:Literal ID="Literal11" runat="server" Text="Edit" meta:resourcekey="Literal11Resource1"></as:Literal></a>
                    </td>
                </as:PlaceHolder>
            </tr>
            ...
            <asp:Panel ID="pnMerchantRank" runat="server" Visible="false">
                <tr class="Row">
                    <td class="heading">
                        <as:Literal ID="Literal14" runat="server" Text="Merchant Rank:" meta:resourcekey="Literal19Resource1"></as:Literal></td>
                    <td>
                        <div id="divMerchantRank" runat="server">
                            <asp:Label tracking-key="MerchantRank" tracking-type="hierarchy" ID="lbMerchantRank" runat="server" Text="N/A" meta:resourcekey="lblMerchantRankResource1"></asp:Label>
                        </div>
                    </td>
                    <as:PlaceHolder runat="server" ID="plhMerchantRank">
                        <td class="action-column">
                            <a href="#" onclick="return CallFilterModal1('rm_MCF_Filter_MerchantRank_Modal.aspx', 480, 725); return false;">
                                <as:Literal ID="Literal20" runat="server" Text="Edit" meta:resourcekey="Literal6Resource2"></as:Literal></a>
                        </td>
                    </as:PlaceHolder>
                </tr>
            </asp:Panel>
                ...
                <tr class="AltRow">
                    ...
                    <td>
                        <div id="divAchHoldDays" runat="server">
                            <asp:Label tracking-key="AchHoldDays" tracking-type="hierarchy" ID="lbAchHoldDays" runat="server" Text="N/A" meta:resourcekey="lblAchHoldDayResource1"></asp:Label>
                        </div>
                    </td>
                    <as:PlaceHolder runat="server" ID="plhAchHoldDay">
                        <td class="action-column">
                            <a href="#" onclick="return CallFilterModal1('rm_MCF_Filter_ACHHoldDays_Modal.aspx', 480, 725); return false;">
                                <as:Literal ID="Literal23" runat="server" Text="Edit" meta:resourcekey="Literal6Resource2"></as:Literal></a>
                        </td>
                    </as:PlaceHolder>
                </tr>
            </asp:Panel>
                ...
                <tr class="Row">
                    ...
                    <td>
                        <div id="divOwnerLastName" runat="server">
                            <asp:Label tracking-key="OwnerLastName" tracking-type="hierarchy" ID="lbOwnerLastName" runat="server" Text="N/A" meta:resourcekey="lblOwnerLastNameResource1"></asp:Label>
                        </div>
                    </td>
                    <as:PlaceHolder runat="server" ID="plhOwnerLastName">
                        <td class="action-column">
                            <a href="#" onclick="return CallFilterModal1('rm_MCF_Filter_OwnerLastName_Modal.aspx', 480, 725); return false;">
                                <as:Literal ID="Literal26" runat="server" Text="Edit" meta:resourcekey="Literal6Resource2"></as:Literal></a>
                        </td>
                    </as:PlaceHolder>
                </tr>
            </asp:Panel>
                ...
                <tr class="AltRow">
                    ...
                    <td>
                        <div id="divZipCode" runat="server">
                            <asp:Label tracking-key="ZipCode" tracking-type="hierarchy" ID="lbZipCode" runat="server" Text="N/A" meta:resourcekey="lblZipCodeResource1"></asp:Label>
                        </div>
                    </td>
                    <as:PlaceHolder runat="server" ID="plhZipCode">
                        <td class="action-column">
                            <a href="#" onclick="return CallFilterModal1('rm_MCF_Filter_ZipCode_Modal.aspx', 480, 725); return false;">
                                <as:Literal ID="Literal29" runat="server" Text="Edit" meta:resourcekey="Literal6Resource2"></as:Literal></a>
                        </td>
                    </as:PlaceHolder>
                </tr>
            </asp:Panel>
                ...
                <tr class="Row">
                    ...
                    <td>
                        <div id="divMerchantFunding" runat="server">
                            <asp:Label tracking-key="MerchantFundingStatus" tracking-type="hierarchy" ID="lbMerchantFundingStatus" runat="server" Text="N/A" meta:resourcekey="lblMerchantRankResource1"></asp:Label>
                        </div>
                    </td>
                    <as:PlaceHolder runat="server" ID="plhMerchantFunding">
                        <td class="action-column">
                            <a href="#" onclick="return CallFilterModal1('rm_MCF_Filter_MerchantFundingStatus_Modal.aspx', 480, 725); return false;">
                                <as:Literal ID="Literal32" runat="server" Text="Edit" meta:resourcekey="Literal6Resource2"></as:Literal></a>
                        </td>
                    </as:PlaceHolder>
                </tr>
            </asp:Panel>
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <as:CheckBox ID="uxChkIsFrom" Width="50px" runat="server" onclick="visibleCreditScoreCb(this, 'uxCbCreditScoreFrom')" Text=""
                                        tracking-key="CreditScoreGreater" tracking-type="checkbox" tracking-refer="uxCbCreditScoreFrom" tracking-refer-type="combobox" meta:resourcekey="lbIsGreater" />
                            ...
                            <tr>
                                <td>
                                    <as:CheckBox ID="uxChkIsTo" Width="50px" runat="server" onclick="visibleCreditScoreCb(this, 'uxCbCreditScoreTo')" Text=""
                                        tracking-key="CreditScoreSmaller" tracking-type="checkbox" tracking-refer="uxCbCreditScoreTo" tracking-refer-type="combobox" meta:resourcekey="lbIsSmaller" />
            ...
            <asp:Panel ID="pnlProfile" runat="server">
                <tr class="AltRow">
                    <td class="heading">
                        <as:Literal ID="Literal12" runat="server" Text="Profile:" meta:resourcekey="Literal12Resource1"></as:Literal></td>
                    <td>
                        <div id="divProfile" runat="server">
                            <asp:Label tracking-key="Profile" tracking-type="hierarchy" ID="lblProfile" runat="server" Text="N/A" meta:resourcekey="lblProfileResource1"></asp:Label>
                        </div>
                    </td>
                    <as:PlaceHolder runat="server" ID="plhProfile">
                        <td class="action-column">
                            <a href="#" onclick="return CallFilterModal1('rm_MCF_Filter_Profile_Modal.aspx', 480, 725); return false;">
                                <as:Literal ID="Literal13" runat="server" Text="Edit" meta:resourcekey="Literal13Resource1"></as:Literal></a>
                        </td>
                    </as:PlaceHolder>
                </tr>
            </asp:Panel>
            ...
            <uc:RiskStandardFilter ID="RiskStandardFilter" runat="server" />

            <uc:ECommerce ID="uxEcommerce" runat="server" />
            <as:PlaceHolder ID="uxHighRisk" runat="server" Visible="false">
                <as:PlaceHolder ID="uxHighRiskView" runat="server" Visible="False">
                    <tr class="section-heading">
                        <td colspan="2">
                            <as:Literal ID="Literal15" runat="server" Text="High Risk" meta:resourcekey="Literal15Resource1"></as:Literal>
                        </td>
                    </tr>
                </as:PlaceHolder>
                <as:PlaceHolder ID="uxHighRiskEdit" runat="server" Visible="False">
                    <tr class="section-heading">
                        <td colspan="3">
                            <as:Literal ID="Literal18" runat="server" Text="High Risk" meta:resourcekey="Literal15Resource1"></as:Literal>
                        </td>
                    </tr>
                </as:PlaceHolder>
                <as:PlaceHolder ID="pnlHRCode" runat="server" Visible="true">
                    <tr class="Row">
                        <td class="heading">
                            <as:Literal ID="Literal16" runat="server" Text="HR Code:" meta:resourcekey="Literal14Resource1"></as:Literal></td>
                        <td>
                            <div id="divHRCode" runat="server">
                                <asp:Label tracking-key="HRCode" tracking-type="hierarchy" ID="lblHRCode" runat="server" Text="N/A" meta:resourcekey="lblHRCodeResource1"></asp:Label>
                            </div>
                        </td>
                        <as:PlaceHolder runat="server" ID="plhHRCode" Visible="False">
                            <td class="action-column">
                                <a href="#" onclick="return CallFilterModal1('rm_MCF_Filter_HRCode_Modal.aspx', 480, 725); return false;">
                                    <as:Literal ID="Literal17" runat="server" Text="Edit" meta:resourcekey="Literal11Resource1"></as:Literal></a>
                            </td>
                        </as:PlaceHolder>
                    </tr>
                </as:PlaceHolder>
            ...
            <tr id="pnlMerchantClassifications" runat="server" visible="true">
                ...
                <td>
                    <div id="div1" runat="server">
                        <asp:Label tracking-key="MerchantClassification" tracking-type="hierarchy" ID="uxMerchantClassificationsLabel" runat="server" Text="N/A" meta:resourcekey="lblHRCodeResource1"></asp:Label>
                    </div>
                </td>

                <td class="action-column" runat="server" id="pnlMerchantClassificationsEdit">
                    <a href="#" onclick="return CallFilterModal1('rm_MCF_Filter_MerchantClassifications_Modal.aspx', 480, 725); return false;">
                        <as:Literal ID="Literal31" runat="server" Text="Edit" meta:resourcekey="Literal11Resource1"></as:Literal></a>
                </td>
            </tr>
            <tr id="pnlGverifyCode" runat="server" visible="false">
                ...
                <td class="action-column" runat="server" id="pnlGverifyCodeEdit">
                    <a href="#" onclick="return CallFilterModal1('rm_MCF_Filter_GverifyCode_Modal.aspx', 480, 725); return false;">
                        <as:Literal ID="Literal22" runat="server" Text="Edit" meta:resourcekey="Literal11Resource1"></as:Literal></a>
                </td>
            </tr>
            <tr id="pnlGauthenticateCode" runat="server" visible="false">
                ...
                <td class="action-column" runat="server" id="pnlGauthenticateCodeEdit">
                    <a href="#" onclick="return CallFilterModal1('rm_MCF_Filter_GauthenticateCode_Modal.aspx', 480, 725); return false;">
                        <as:Literal ID="Literal34" runat="server" Text="Edit" meta:resourcekey="Literal11Resource1"></as:Literal></a>
                </td>
            </tr>
            ...
            <tr id="pnlG2Compass" runat="server" visible="false">
                ...
                <td class="action-column" runat="server" id="pnlG2CompassEdit">
                    <a href="#" onclick="return CallFilterModal1('rm_MCF_Filter_G2CompassAutoApprovalIndicator_Modal.aspx', 480, 725); return false;">
                        <as:Literal ID="Literal37" runat="server" Text="Edit" meta:resourcekey="Literal11Resource1"></as:Literal></a>
                </td>
            </tr>

            <uc:Risk_ExtendFilter ID="Risk_ExtendFilter" runat="server" />

            <%--Begin MVRK - 59109 -  Custom Assignment Filters on Manage Assignment modal--%>

            <uc:CustomFilter ID="uxCustomFilter" runat="server"></uc:CustomFilter>

            <%--End MVRK - 59109 -  Custom Assignment Filters on Manage Assignment modal--%>
...
<as:RadCodeBlock ID="radCodeBlock" runat="server">
    <script type="text/javascript">
        ...
        var Risk_Assignment_Filters_btnRefreshState = '<%= btnRefreshState.ClientID %>';
        var Risk_Assignment_Filters_btnRefreshSIC = '<%= btnRefreshSIC.ClientID %>';
        var Risk_Assignment_Filters_btnRefreshProfile = '<%= btnRefreshProfile.ClientID %>';
        var Risk_Assignment_Filters_pnlMerchantCountOnFilter = '<%=pnlMerchantCountOnFilter.ClientID %>';
        ...
        var Risk_Assignment_Filters_uxChkIsFrom = '<%= uxChkIsFrom.ClientID%>';
        var Risk_Assignment_Filters_uxChkIsTo = '<%= uxChkIsTo.ClientID%>';

        var Risk_Assignment_Filters_btnRefreshHighRisk = '<%=btnRefreshHighRisk.ClientID %>';
        ...
        var Risk_Assignment_Filters_btnCalculateMerchantCount = '<%=btnCalculateMerchantCount.ClientID %>';

        var Risk_Assignment_Filters_Assignment_Filter_Required = '<%=Resources.ValMsg.Assignment_Filter_Required %>';

        var Risk_Assignment_Filters_QueryString = '?<%=QueryString %>';
        ...
        var Risk_Assignment_Filters_lblRefreshGverifyCode = '<%= lblGverifyCode.ClientID %>';
        var Risk_Assignment_Filters_lblGauthenticateCode = '<%= lblGauthenticateCode.ClientID %>';
        var Risk_Assignment_Filters_lblG2Compass = '<%= lblG2Compass.ClientID %>';
        var Risk_Assignment_Filters_MerchantClosedStatus = '<%= chkExcludeMerchantsClosedStatus.ClientID %>';

        var Risk_Assignment_Filters_btnAddPauseMerchantAlert_ClientID = '<%= btnAddPauseMerchantAlert.ClientID %>';
        ...
        function masterAjax_responseEnd(sender, args) {
            ...
            if (typeof loadControlDaytoFundStandard == 'function') {
                setTimeout(loadControlDaytoFundStandard, 100);
            }

            if (typeof checkEnabledControl == 'function') {
                setTimeout(checkEnabledControl, 100);
            }

            if (typeof displayGridParams == 'function') {
                displayGridParams();
            }
            if (typeof loadRiskCategoryControl == 'function') {
    ...
    <script src="<%= ResolveUrl("~/")%>res/js/risk_MCF/rm_MCF_Assignment_Filters.js"></script>
