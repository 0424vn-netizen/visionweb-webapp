...
public partial class UserControls_MIF_MerchantDetails_PPI : ExportMultiSections
{
    #region Constants
    ...
    private const string FILE_NAME_HIERARCHY_INFO = "~/App_Data/tpl_HierarchyInformation_PPI.htm";
    ...
    protected string SetURLForSiteAccessButton()
    {
        return MerchantProfileHelper.BuildURLForSiteAccessInMIF(
             (SecurePage)Page, MerchantNumber, _OptedIn, MifEmail);
    }
    ...
    protected override void OnDataBindControls(Enum type, object sender)
    {
        ...
        switch ((DataBindAction)type)
        {
            case DataBindAction.BindMerchantDetails:
                ...
                {
                    MifTable = dtMerch;
                    this._OptedIn = dtMerch.Rows[0]["SiteAccess"].ToString().Equals(Resources.Template.OptedIn, StringComparison.OrdinalIgnoreCase) ? "1" : "0";
    ...
    public void DoMultiExportExcel()
    {
        ...
        exportNames.Add(1, GetLocalResourceObject("MIF_MerchantDetails_PPICS_Text_BusinessInformation").ToString());

        if (IsRiskInformation)
        {
            exportNames.Add(2, GetLocalResourceObject("MIF_MerchantDetails_Text_RiskInformation").ToString());
            exportNames.Add(3, GetLocalResourceObject("MIF_MerchantDetails_PPICS_Text_HierarchyInformation").ToString());
            exportNames.Add(4, GetLocalResourceObject("MIF_MerchantDetails_PPICS_Text_BankInformation").ToString());
            exportNames.Add(5, GetLocalResourceObject("MIF_MerchantDetail_PPIJS_Text_Text_Memos").ToString());
        }
        else
        {
            exportNames.Add(2, GetLocalResourceObject("MIF_MerchantDetails_PPICS_Text_HierarchyInformation").ToString());
            exportNames.Add(3, GetLocalResourceObject("MIF_MerchantDetails_PPICS_Text_BankInformation").ToString());
            exportNames.Add(4, GetLocalResourceObject("MIF_MerchantDetail_PPIJS_Text_Text_Memos").ToString());
        }
    ...
    protected string ButtonExcelBusinessInformation_Click()
    {
        ...
        {
            strExcelTemplate.Replace("BI_SITE_ACCESS", "&nbsp;" + GetLocalResourceObject("MIF_MerchantDetails_PPIJS_Text_NotAvailable").ToString());
        }
        ...
        string excelFileName = GeneralFuncsLib.GetFileName(GetLocalResourceObject("MIF_MerchantDetails_PPICS_Text_BusinessInformation").ToString());
    ...
    protected string ButtonExcelHierarchyInformation_Click()
    {
        ...
        string excelFileName = GeneralFuncsLib.GetFileName(GetLocalResourceObject("MIF_MerchantDetails_PPICS_Text_HierarchyInformation").ToString());
        return WriteContentToFile(PATH_EXPORT_EXCEL_FILE, excelFileName, "xls", strExcelTemplate.ToString());
    }
    ...
    protected string ButtonExcelBankInformation_Click()
    {
        ...
        string excelFileName = GeneralFuncsLib.GetFileName(GetLocalResourceObject("MIF_MerchantDetails_PPICS_Text_BankInformation").ToString());
        return WriteContentToFile(PATH_EXPORT_EXCEL_FILE, excelFileName, "xls", strExcelTemplate.ToString());
    }
    ...
    {
        return Page.IsUserWithPermission("AddEditChain")
