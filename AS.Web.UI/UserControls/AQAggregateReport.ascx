<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AQAggregateReport.ascx.cs"
    Inherits="UserControls_AQAggregateReport" %>
<%--<%@ Register TagPrefix="uc" TagName="UxExport" Src="~/UserControls/UxExport.ascx" %>--%>
...
<as:RadAjaxManagerProxy ID="RadAjaxManager" runat="server">
    <AjaxSettings>
        <tek:AjaxSetting AjaxControlID="uxReportAggregateGrid">
            <UpdatedControls>
                <tek:AjaxUpdatedControl ControlID="uxReportAggregateGrid" LoadingPanelID="uxLoadingPanelCustom" />
...
<uc:UxExport ID="uxExporterAggregateTop" runat="server" IsOnTop="true" GridID="uxReportAggregateGrid"
...
<as:ASGrid ID="uxReportAggregateGrid" runat="server" AllowFilteringByColumn="false" CssClass="freeze-table"
    AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" AllowSortFilterWhenExport="true"
    ASPagingMethod="SPASingleMethod" GridName="Risk Management - Risk Analysis - Detection Queue Aggregate Report"
    OnNeedDataSource="uxReportGrid_NeedDataSource" OnItemDataBound="uxReportGrid_ItemDataBound" OnItemCommand="uxReportAggregateGrid_ItemCommand"
    OnDataSourceReady="uxReportGrid_DataSourceReady" PageSize="100" Width="100%" OnSortCommand="uxReportAggregateGrid_SortCommand"
    ClientSettings-EnableAlternatingItems="true" OnPreRender="uxReportAggregateGrid_PreRender" meta:resourcekey="uxReportAggregateGridResource1">
    <MasterTableView TableLayout="Fixed" Width="100%">
        <Columns>
            <as:ASGridTemplateColumn HeaderText="Wk" UniqueName="CheckBoxColumn" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="44px"
                ItemStyle-HorizontalAlign="Center" meta:resourcekey="ASGridTemplateColumnResource0">
                <ItemTemplate>
                    <span class="checkbox-middle">
                        <input type="checkbox" id="cBox" runat="server" onclick="ChangeAQMerchantWorked(this)" />
                        &nbsp;</span>
                </ItemTemplate>
            ...
            <as:ASGridBoundColumn DataField="MerchantNumber" UniqueName="MerchantNumber" HeaderText="Merchant ID"
                HeaderTooltip="Merchant ID" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false"
            ...
            <as:ASGridBoundColumn DataField="MerchantName" UniqueName="MerchantName" HeaderText="Merchant Name"
                ...
                ItemStyle-CssClass="merchantName" ASFormat="DynamicString" meta:resourcekey="ASGridBoundColumnResource2">
                <ColumnValidationSettings>
                    <ModelErrorMessage Text=""></ModelErrorMessage>
                </ColumnValidationSettings>
            ...
            <as:ASGridBoundColumn DataField="Worked" UniqueName="Worked" HeaderText="Worked" ItemStyle-CssClass="workLast30"
                HeaderTooltip="Worked (Last 30-Days)" HeaderStyle-Wrap="false" ItemStyle-Wrap="false"
            ...
            <as:ASGridBoundColumn DataField="RulesViolatedToday" UniqueName="RulesViolatedToday" ItemStyle-CssClass="ellipsis"
                HeaderText="RV" HeaderTooltip="Rules Violated Today" HeaderStyle-Width="86px" ItemStyle-Width="86px"
                ...
                <ItemTemplate>
                    <div class="row card-view">
                        <div class="col-xs-3">
                            <div class="row w-min-180 mb-4x">
                                <div class="col-xs-2 rdHeader">
                                    ...
                                    <div class="checkbox-middle">
                                        <input type="checkbox" id="cBoxCV" runat="server" onclick="ChangeAQMerchantWorked(this)" />
                                    </div>
                                </div>
                                <div class="col-xs-4 rdHeader" id="colRQColumn" runat="server">
                            ...
                            <div class="row w-min-180 mb-4x">
                                <div class="col-xs-6">
                                    <asp:LinkButton ID="lbtSort_MerchantNumber" CssClass="rdHeader" runat="server" Text="Merchant ID" CommandName="Sort_MerchantNumber" meta:resourcekey="ASGridBoundColumnCardResource0"></asp:LinkButton>
                        ...
                        <div class="col-xs-9">
                            <div class="auto-grid">
                                <div class="item ">
                                    <asp:LinkButton ID="lbtSort_Worked" CssClass="rdHeader" runat="server" CommandName="Sort_Worked" Text="# WKD 30" ToolTip="Worked (Last 30-Days)" meta:resourcekey="ASGridBoundColumnCardResource3"></asp:LinkButton>
                                    <span class="icon-sort"></span>
                                ...
                                <div class="item ">
                                    <asp:LinkButton ID="lbtSort_RulesViolatedToday" CssClass="rdHeader" runat="server" CommandName="Sort_RulesViolatedToday" ToolTip="Rules Violated Today" Text="RV" meta:resourcekey="ASGridBoundColumnCardResource25"></asp:LinkButton>
                                    <span class="icon-sort"></span>
                                     <div id="Div24" runat="server" title='<%# Eval("RulesViolatedToday") %>' ><%# Eval("RulesViolatedToday").ToSafeString().Length > 35 ?  (Eval("RulesViolatedToday").ToSafeString().Substring(0, 35) + "...") : Eval("RulesViolatedToday") %></div>
                                </div>
                                <div class="item ">
...
<as:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        var AQAggregateReport_uxExporterAggregateTop = "<%= uxExporterAggregateTop.ClientID%>";
    </script>
    <script type="text/javascript" src="<%=ResolveUrl("~") %>res/js/risk/AQAggregateReport.js"></script>
</as:RadCodeBlock>
