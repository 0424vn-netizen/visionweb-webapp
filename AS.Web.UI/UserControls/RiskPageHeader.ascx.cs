...
public partial class UserControls_RiskPageHeader : GlobalUserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (SessionManager.CurrentUser.UserSecRole == "FDUSER")
            {
                ...
                uxSiteList.DataSource = WebServices.RiskServices.GetReports("spa_rm_cs_GetAllRiskSites", new FilterParameterCollection());
                uxSiteList.DataBind();
