<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_Assignment_Parameters_Adhoc.ascx.cs" Inherits="UserControls_rm_MCF_Assignment_Parameters_Adhoc" %>
        ...
        <div class="header-card">
            ...
            <div class="groups">
                <div class="group">
                    ...
                    <div class="item w-control-center"><%= GetLocalResourceObject("Literal1Resource1.Text") %></div>
                                ...
                                <ItemTemplate>
                                    <div id='param_<%# GetValue(Eval("ParameterKey")) %>' data-key="<%# WebServices.SecurityServices.EncryptText(GetValue(Eval("ParameterKey"))) %>" data-order="<%# GetValue(Eval("RowNumber")) %>" data-is-source="<%# GetValue(Eval("IsSourceParam")) %>" class="group">
                                        ...
                                        <div class="item flex-grow-1">
                                            <span title='<%# Eval("ParameterDescription")%>'><%# Eval("ParameterName")%></span>
                                        ...
                                        <div class="item  w-control-center">
                                            <as:PlaceHolder ID="uxIndicatorNomal" runat="server">
                                                <div class="control-center">
                                                    ...
                                                    <div class="w-input">
                                                        ...
                                                        <as:Literal ID="lblIndicatorNA" runat="server" Text="" Visible="False" meta:resourcekey="lblIndicatorNAResource1"></as:Literal>
                                                    </div>
                                                    <label>
                                            ...
                                            <as:PlaceHolder ID="uxIndicatorHigh" runat="server" Visible="False">
                                                ...
                                                <div class="control-center">
                                                    ...
                                                    <label>
                                                        <as:Literal ID="Literal1" runat="server" Text='<%# GetValue(Eval("ParameterDataType")) %>'></as:Literal>
                                                    </label>
                                                </div>
                                            </as:PlaceHolder>
                                        </div>
                                        ...
                                        <div class="item  w-control-center">
                                            <as:PlaceHolder ID="lblNA" runat="server" Visible="False">
                                                <label></label>
                                                <as:Literal ID="Literal71" runat="server" Text="" meta:resourcekey="Literal71Resource1"></as:Literal>
                                                <label></label>
                                            </as:PlaceHolder>
...
<as:ASRadCodeBlock ID="ASRadCodeBlock1" runat="server">
    <script>
        ...
        //var Code = '<%=  UserControls_rm_MCF_ParameterFilter_TransactionCode.GetSelectedValuesAsString(Mode, PrimaryID, uxPramKey.Value, FilterID)["Label"] %>'
    </script>
    ...
    <script src="<%= ResolveUrl("~/")%>res/js/risk_MCF/rm_MCF_Assignment_Parameters_Adhoc.js"></script>
</as:ASRadCodeBlock>
