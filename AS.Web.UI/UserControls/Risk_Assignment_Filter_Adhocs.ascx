<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Risk_Assignment_Filter_Adhocs.ascx.cs"
    Inherits="UserControls_Risk_Assignment_Filter_Adhocs" %>
...
<%@ Register Src="~/UserControls/Risk_WatchStatus.ascx" TagName="Risk_WatchStatus"
    TagPrefix="uc" %>
...
<%--<as:Validator ID="HieararchyFilterValidator" runat="server" MessageType="Inline"
    ...
    <Items>
       ...
       <as:CustomValidationItem ResMessage="Resources.ValMsg.To_Greater" ClientValidationFunction="ValidateMerchantRangeFromTo" ControlToValidateID="txtMerchantRangeFrom" />
        <as:CustomValidationItem ResMessage="Resources.ValMsg.CustomRequired" ClientValidationFunction="ValidateMerchantRangeFromRequired" ResParams="Merchant ID From" ControlToValidateID="txtMerchantRangeFrom" />
        <as:CustomValidationItem ResMessage="Resources.ValMsg.CustomRequired" ClientValidationFunction="ValidateMerchantRangeToRequired" ResParams="Merchant ID To" ControlToValidateID="txtMerchantRangeTo" />
        <as:BasicValidationItem Rule="Number" ResMessage="Resources.ValMsg.Number"
...
<div class="row">
    <div class="col-md-12 in" id="uxAssignmentFiltersGrid">
        <table class="ASTable" style="table-layout: fixed;">
            ...
            <tr class="AltRow">
                <td class="heading">
                    <as:ValidatorLabel ID="ValidatorLabel1" runat="server" CssClass="control-label" Text="Merchant ID:" ApplyFor="txtMerchantNumber" meta:resourcekey="ValidatorLabel1Resource1"></as:ValidatorLabel>
                </td>
            ...
            <%--   <tr class="Row">
                <td class="heading">
                    <as:ValidatorLabel ID="VltLblMerchantRange" runat="server" CssClass="control-label" Text="Merchant ID Range:" ApplyFor="txtMerchantRangeFrom" meta:resourcekey="VltLblMerchantRangeResource1"></as:ValidatorLabel>
                </td>
                <as:ASRadCodeBlock ID="ASRadCodeBlock4" runat="server">
                    <td colspan="<%=FeatureMode == WebSiteEnums.FeatureMode.Edit ?"2":"1"%>">
                        <label class="first"><as:Literal ID="ltFrom" runat="server" Text="From" meta:resourcekey="ltFromResource1" /></label>
                        <div class="control-inline">
                        ...
                        <label><as:Literal ID="Literal11" runat="server" Text="To" meta:resourcekey="ltToResource1" /></label>
...
<as:RadCodeBlock ID="radCodeBlock2" runat="server">
    ...
    <script src="<%= ResolveUrl("~/")%>res/js/risk/Risk_Assignment_Filters_Adhoc.js"></script>
</as:RadCodeBlock>
