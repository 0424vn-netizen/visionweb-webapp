...
public partial class UserControls_rm_MCF_ApprovalDate : GlobalUserControl, IRiskParamFilter
{
    #region Enums
    enum DataBindAction
    {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            cbNewMerchantOnly.Enabled = chkIsNewMerchantOnly.Checked;
            cbEstablishedMerchants.Enabled = chkIsEstablishedMerchants.Checked;
        }
    }
    ...
    private DataTable GetDataTable()
    {
        ...
        return WebServices.RiskServices.GetReports("spa_RM_MCF_GetApprovalDateByFilter", parameters);
    }
    ...
    private void BindData()
    {
        ...
        cbNewMerchantOnly.DataSource = WebServices.RiskServices.GetReports("spa_RM_MCF_GetApprovalDate", parameters);
        ...
        cbEstablishedMerchants.DataSource = WebServices.RiskServices.GetReports("spa_RM_MCF_GetApprovalDate", parametersx);
    ...
    public int Save()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_InsertUpdateApprovalDate", parameter, out parameterOut);
        return 0;
    }
