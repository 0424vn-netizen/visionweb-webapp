<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MIF_MerchantDetails_FDR.ascx.cs"
    Inherits="UserControls_MIF_MerchantDetails" %>
...
<asp:PlaceHolder ID="phdMerchantDetail" runat="server">
                ...
                <tr class="Row">
                    ...
                    <td>
                        <div class="display-flex space-between">
                            ...
                            <span>
                                <as:PlaceHolder ID="uxPlhSwitchTSYSMID" runat="server">
                                    <asp:HyperLink ID="uxSwitchTSYSMID" runat="server" meta:resourcekey="uxLiteralSwitchToTSYSResource" Text="Switch to TSYS MID"></asp:HyperLink>
                                </as:PlaceHolder>
                            </span>
                        </div>
                    </td>
                    ...
                    <td colspan="5" class="valign-top">
                        <as:Panel runat="server" ID="uxpnlRMCtrls" meta:resourcekey="uxpnlRMCtrlsResource1">
                            <as:Panel runat="server" ID="uxpnlAddEdit" CssClass="opt-in-out-text w-100" meta:resourcekey="uxpnlAddEditResource1">
                                ...
                                <div class="pull-right valign-top">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row" id="businessinfo">
                        <div class="col-xs-9" data-toggle="collapse" data-target="#ciBusinessInformation">
                            <h2 class="grid-title">
                                <asp:Literal ID="Literal10" runat="server" Text="Business Information" meta:resourcekey="LiteralResource10" /></h2>
                        </div>
                        <div class="col-xs-3">
                            <div class="report-export dropdown pull-right" runat="server" id="litExport" visible='<%# !IsCaseManagement %>'>
                                <ul class="dropdown-menu">
                                    <li id="uxLiExcel" runat="server">
                                        <asp:LinkButton ID="LinkButton1" runat="server" meta:resourcekey="LinkButton1Resource1">
                                            <asp:Literal ID="Literal12" runat="server" Text="Excel" meta:resourcekey="LiteralResource12" />
                                        </asp:LinkButton>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <tr class="Row">
                                    ...
                                    <td>
                                        <div class="<%# HasMSProductEnvironment()? "mt-1x" :"" %>">
                                            <asp:Literal ID="ltrSiteAccess" runat="server" Text='<%# HasMSProductEnvironment()?Eval("SiteAccess"):GetLocalResourceObject("MIF_MerchantDetail_FDRASCX_Text_NA").ToString() %>' />
                                        </div>
                                        <div class="pull-right opt-in-out-button">
                ...
                <div class="col-md-6">
                    ...
                    <asp:PlaceHolder ID="phdHierarchy" runat="server">
                        <div class="row" id="hierarchyinfo">
                            <div class="col-xs-9" data-toggle="collapse" data-target="#ciHierarchyInformation">
                                <h2 class="grid-title">
                                    <asp:Literal ID="Literal34" runat="server" Text="Hierarchy Information" meta:resourcekey="LiteralResource34" /></h2>
                            </div>
                            <div class="col-xs-3">
                                <div class="report-export dropdown pull-right" runat="server" id="div1" visible='<%# !IsCaseManagement %>'>
                                    <ul class="dropdown-menu">
                    ...
                    <div class="row" id="bankinfo">
                        <div class="col-xs-9" data-toggle="collapse" data-target="#ciBankInformation">
                            <h2 class="grid-title">
                                <asp:Literal ID="Literal44" runat="server" Text="Bank Information" meta:resourcekey="LiteralResource44" /></h2>
                        </div>
                        <div class="col-xs-3">
                            <div class="report-export dropdown pull-right" runat="server" id="div2" visible='<%# !IsCaseManagement %>'>
                                <ul class="dropdown-menu">
                                    <li id="Li2" runat="server"></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <asp:Repeater ID="rptPricingInfo" runat="server">
        <ItemTemplate>
            <!--Pricing Information-->
            <div class="row" id="pricinginfo">
                <div class="col-xs-9" data-toggle="collapse" data-target="#ciPricingInformation">
                    <h2 class="grid-title">
                        <asp:Literal ID="Literal68" runat="server" Text="Pricing Information" meta:resourcekey="LiteralResource68" /></h2>
                </div>
                <div class="col-xs-3">
                    <div class="report-export dropdown pull-right" runat="server" id="div5" visible='<%# !IsCaseManagement %>'>
                        <ul class="dropdown-menu">
    ...
    <asp:Repeater ID="rptCardInfo" runat="server">
        <ItemTemplate>
            <!--Merchant Card Information-->
            <div class="row" id="merchantcardinfo">
                <div class="col-xs-9" data-toggle="collapse" data-target="#ciMerchantCardInformation">
                    <h2 class="grid-title">
                        <asp:Literal ID="Literal118" runat="server" Text="Merchant Card Information" meta:resourcekey="LiteralResource118" /></h2>
                </div>
                <div class="col-xs-3">
                    <div class="report-export dropdown pull-right" runat="server" id="div6" visible='<%# !IsCaseManagement %>'>
                        <ul class="dropdown-menu">
...
<asp:PlaceHolder runat="server" ID="uxCustomReport">
    <div class="row" id="reportaccess">
        <div class="col-xs-9" data-toggle="collapse" data-target="#ciReportAccess">
            <h2 class="grid-title">
                <asp:Literal ID="Literal174" runat="server" Text="Report Access" meta:resourcekey="LiteralResource173" /></h2>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12 in" id="ciReportAccess">
            <div>
                <as:CheckBox runat="server" ID="chkCustomReport" onclick="EnableTextBox(this);" meta:resourcekey="chkCustomReportResource1" /><label><asp:Literal ID="Literal175" runat="server" Text="HQ Daily/Monthly Transaction Report" meta:resourcekey="LiteralResource174" /></label>
            </div>
            <div class="height-8"></div>
            <div>
                <label>
                    <asp:Literal ID="Literal176" runat="server" Text="Email Recipients (comma separated):" meta:resourcekey="LiteralResource175" /></label>
            </div>
            <div class="height-4"></div>
            <div>
                <as:TextBox ID="uxEmailRecipents" runat="server" TextMode="MultiLine" MaxLength="500"
                    Rows="4" CssClass="form-control" meta:resourcekey="uxEmailRecipentsResource1"></as:TextBox><div class="bottom-error">
                        <as:ValidatorMessage ID="ValidatorMessage2" ApplyFor="uxEmailRecipents" runat="server"></as:ValidatorMessage>
                    </div>
                <as:Validator ID="Validator2" runat="server" ValidationFunction="validationEmail" MessageType="Inline" meta:resourcekey="Validator2Resource1">
                    <Items>
                        <as:BasicValidationItem Rule="Email" ControlToValidateID="uxEmailRecipents"
                            Message="You have entered an incorrect email address format. Please try again." meta:resourcekey="MIF_MerchantDetail_FDRASCX_Text_IncorrectEmail" />
                    </Items>
                </as:Validator>
            </div>
            <div class="row">
                <div class="col-md-12 form-action-container">
                    <as:Button ID="uxUpdateEmail" runat="server" Text="Submit" OnClientClick="return validationEmail();"
                        OnClick="uxUpdateEmail_Click" CssClass="btn btn-default" meta:resourcekey="uxUpdateEmailResource1" />
                </div>
            </div>
...
<as:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        var MIF_MerchantDetails_FDR_uxEmailRecipents = '<%=uxEmailRecipents.ClientID %>';
    </script>
