<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_Filter_Lead_Source.ascx.cs" Inherits="UserControls_rm_MCF_Filter_Lead_Source" %>
<as:MultiSelector ID="uxLeadSource" runat="server" DataTextField="DataText" XmlFilterItemsFilePath="~/App_Data/AssigmentFilters.xml" DataValueField="DataKey"
