...
public partial class UserControls_DQDistinctReport : GlobalUserControl
{
    #region Enums
    ...
    private const string SPA_GET_DQ_DISTINCT_AS = "spa_rm_cs_GetDQDistinctMerchantListReport";
    ...
    private void GenerateAllColumnsReportGrid()
    {
        ...
        foreach (GridColumn col in colGrid)
        {
            listColumns.Add(new ColumnDisplayedConfigurationItem
            {
                ...
                ColumnText = col.UniqueName.Replace("$", SessionManager.CurrencySymbol), //GetLocalResourceObject(col.UniqueName + ".HeaderText").ToString(),
                IsDisplayed = false,
