...
public partial class UserControls_MIF_MerchantDetails_Fulton : ExportMultiSections
{
    #region Enums
    ...
    // SPA
    private const string SPA_GET_MERCHANT_PROFILE = "spa_cs_GetMerchantProfile_TSYS_Detail";
