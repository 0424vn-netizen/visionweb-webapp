<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MIF_MechantDetails_SPHERE.ascx.cs" Inherits="UserControls_MIF_MechantDetails_SPHERE" %>
    ...
    <div class="row">
        <div class="col-md-12 in" id="ciMerchantInformation">
            <table class="ASTable" id="tblMerchantInformation">
                ...
                <tr class="AltRow">
                    <td class="heading valign-middle">
                        <asp:Literal ID="Literal19" runat="server" Text="Url:" meta:resourcekey="LiteralResourceUrl" />
                    </td>
                    <td>
                            ...
                            <div class="col-md-12 in" id="ciHierarchyInformation">
                                <table class="ASTable">
                                    ...
                                    <tr class="Row">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxBank" runat="server" Visible='<%# CheckHierarchy("SPHEREBNK") %>'>
                                                <a href="#" id="uxLinkBank" runat="server"><%= BindValue("BankName")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal12" runat="server" Text='<%# Eval("BankName") %>' Visible='<%# !CheckHierarchy("SPHEREBNK") %>'></as:Literal>
                                        </td>
                                    </tr>

                                    <tr class="AltRow">
                                        <td class="heading">
                                            <asp:Literal ID="Literal35" runat="server" Text="Group:" meta:resourcekey="LiteralResource61" />
                                        </td>
                                        <td>
                                            <as:PlaceHolder ID="uxGroup" runat="server" Visible='<%# CheckHierarchy("SPHEREGRP") %>'>
                                                <a href="#" id="uxLinkGroup" runat="server"><%= BindValue("GroupName")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal36" runat="server" Text='<%# Eval("GroupName") %>' Visible='<%# !CheckHierarchy("SPHEREGRP") %>'></as:Literal>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="Row">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxAssociation" runat="server" Visible='<%# CheckHierarchy("SPHEREASSO") %>'>
                                                <a href="#" id="uxLinkAssociation" runat="server"><%= BindValue("AssoName")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal21" runat="server" Text='<%# Eval("AssoName") %>' Visible='<%# !CheckHierarchy("SPHEREASSO") %>'></as:Literal>
                                        </td>
                                    </tr>

                                     <tr class="AltRow">
                                        <td class="heading">
                                            <asp:Literal ID="Literal23" runat="server" Text="Funding Method:" meta:resourcekey="LiteralResourceFundingMethod" /></td>
                                        <td>
                                            <as:PlaceHolder ID="PlaceHolder2" runat="server" Visible='<%# CheckHierarchy("SPHEREFUND") %>'>
                                                <a href="#" id="uxLinkSPHEREFUND" runat="server"><%= BindValue("EntityNumber2")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal29" runat="server" Text='<%# Eval("EntityNumber2") %>' Visible='<%# !CheckHierarchy("SPHEREFUND") %>'></as:Literal>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="Row">
                                        <td class="heading">
                                            <asp:Literal ID="Literal30" runat="server" Text="Referral Partner:" meta:resourcekey="LiteralResourceReferralPartner" /></td>
                                        <td>
                                            <as:PlaceHolder ID="PlaceHolder3" runat="server" Visible='<%# CheckHierarchy("SPHEREREF") %>'>
                                                <a href="#" id="uxLinkReferralPartner" runat="server"><%= BindValue("EntityNumber4")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal31" runat="server" Text='<%# Eval("EntityNumber4") %>' Visible='<%# !CheckHierarchy("SPHEREREF") %>'></as:Literal>
                                        </td>
                                    </tr>
                                    
                                    <tr class="AltRow">
                                        <td class="heading">
                                            <asp:Literal ID="Literal37" runat="server" Text="Referral Source:" meta:resourcekey="LiteralResource62" /></td>
                                        <td>
                                            <as:PlaceHolder ID="uxReferralSource" runat="server" Visible='<%# CheckHierarchy("SPHEREREFS") %>'>
                                                <a href="#" id="uxLinkReferralSource" runat="server"><%= BindValue("EntityNumber6")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal38" runat="server" Text='<%# Eval("EntityNumber6") %>' Visible='<%# !CheckHierarchy("SPHEREREFS") %>'></as:Literal>
                                        </td>
                                    </tr>

                                     <tr class="Row">
                                        <td class="heading">
                                            <asp:Literal ID="Literal39" runat="server" Text="Referral Partner User ID:" meta:resourcekey="LiteralResourceReferralPartnerUserID" /></td>
                                        <td>                                          
                                            <as:Literal ID="Literal42" runat="server" Text='<%# BindValueEmpDash("RefPartnerUserID") %>'></as:Literal>
                                        </td>
                                    </tr>
                                    
                                    <tr class="AltRow">
                                        <td class="heading">
                                            <asp:Literal ID="Literal43" runat="server" Text="Referral Source User ID:" meta:resourcekey="LiteralResourceReferralSourceUserID" /></td>
                                        <td>                                         
                                            <as:Literal ID="Literal48" runat="server" Text='<%# BindValueEmpDash("RefSourceUserID") %>'></as:Literal>
                                        </td>
                                    </tr>
