...
public partial class UserControls_rm_MCF_Filter_MerchantClassifications_Modal : GlobalUserControl, IRiskParamFilter
{
    ...
    #endregion
    public string PATH_PAGE = "~/UserControls/rm_MCF_Filter_MerchantClassifications_Modal.ascx";
    ...
    private DataTable GetFilterList(WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        return WebServices.RiskServices.GetReports("spa_RM_MCF_MRS_Get_ListMIFClassificationFilter", parames);
    }
    ...
    public Dictionary<string, string> GetSelectedValuesAsString(WebSiteEnums.ParamFilterMode mode, string primaryID, string paramID, string FilterID)
    {
        ...
        parames.AddLanguageID();
        DataSet ds = WebServices.RiskServices.GetReportsAsDataSet("spa_RM_MCF_MRS_Get_ListMIFClassificationFilter", parames);
    ...
    public int Save()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_MRS_Save_MIFClassificationAssignment", paramsIn, out paramsOut);
