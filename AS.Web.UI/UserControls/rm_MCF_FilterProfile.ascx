<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_FilterProfile.ascx.cs" Inherits="UserControls_rm_MCF_FilterProfile" %>

<as:MultiSelector ID="uxProfiles" runat="server" DataTextField="DataText" XmlFilterItemsFilePath="~/App_Data/AssigmentFilters.xml" DataValueField="DataKey"
