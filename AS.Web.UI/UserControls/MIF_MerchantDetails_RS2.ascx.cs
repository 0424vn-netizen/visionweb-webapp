...
public partial class UserControls_MIF_MerchantDetails_RS2 : ExportMultiSections
{
    #region Enums
    ...
    private const string FILE_NAME_BUSINESS_INFO = "~/App_Data/tpl_BusinessInformation_SIGNA.htm";
    private const string FILE_NAME_HIERARCHY_INFO = "~/App_Data/tpl_HierarchyInformation_RS2.htm";
    ...
    private const string FILE_NAME_MERCHANT_INFO = "~/App_Data/tpl_MerchantInformation_SignaPay.htm";
    private const string FILE_NAME_MERCHANT_INFO_REP = "~/App_Data/tpl_MerchantInformation_ORI_Rep.htm";
    // SPA
    private const string SPA_GET_MERCHANT_PROFILE = "spa_cs_GetMerchantProfile_TSYS_Detail_RS2";
    //TK 41447
        ...
        switch ((DataBindAction)type)
        {
            case DataBindAction.BindMerchantDetails:
                ...
                if (dtMerch.Rows.Count > 0)
                {
                    ...
                    {
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkBank", "EntityNumber1", HierarchyMode.RS2_BANK);
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkAcquirer", "EntityNumber2", HierarchyMode.RS2_ACQUIRER);
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkSubAcquirer", "EntityNumber3", HierarchyMode.RS2_SUBACQUIRER);
    ...
    protected string ButtonExcelHierarchyInformation_Click()
    {
        ...
        strExcelTemplate.Replace("[tpl_HierarchyInformation_htm_Acquirer]", Resources.Template.tpl_HierarchyInformation_RS2_htm_Acquirer);
        strExcelTemplate.Replace("[tpl_HierarchyInformation_htm_Sub_Acquirer]", Resources.Template.tpl_HierarchyInformation_RS2_htm_Sub_Acquirer);
        ...
        strExcelTemplate.Replace("HI_ACQUIRER", "&nbsp;" + dataSource.Rows[0]["EntityNumber2"].ToString());
        strExcelTemplate.Replace("HI_SUBACQUIRER", "&nbsp;" + dataSource.Rows[0]["EntityNumber3"].ToString());
