<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_Assignment_Parameters.ascx.cs"
    Inherits="UserControls_rm_MCF_Assignment_Parameters" %>
<%@ Register TagName="UxExport" Src="~/UserControls/UxExport.ascx" TagPrefix="uc" %>
<%@ Register TagName="UxTransCodeFilter" Src="~/UserControls/rm_MCF_ParameterFilter_TransactionCode.ascx"
    TagPrefix="uc" %>
            ...
            <asp:PlaceHolder ID="plhParameter" runat="server">
                <tr class="Row">
                    <td colspan="<%=FeatureMode == WebSiteEnums.FeatureMode.Edit ? "5" : "4"%>">
                        <a href="#" class="heading" onclick="return parameter_Add('rm_MCF_ParameterListModal.aspx');"><as:Literal ID="Literal14" runat="server" Text="+ Please click here to add more parameters." meta:resourcekey="Literal14Resource1"></as:Literal></a>
                    </td>
                </tr>
            </asp:PlaceHolder>
        </table>
...
<as:ASRadCodeBlock ID="ASRadCodeBlock1" runat="server">
    ...
    <script src="<%= ResolveUrl("~/")%>res/js/risk_MCF/rm_MCF_Assignment_Parameters.js"></script>
</as:ASRadCodeBlock>
