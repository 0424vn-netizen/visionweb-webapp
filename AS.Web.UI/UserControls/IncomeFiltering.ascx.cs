...
public partial class UserControls_IncomeFiltering : GlobalUserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            DataTable table = WebServices.RiskServices.GetReports("spa_rm_cs_GetAllProfiles", parameters);
