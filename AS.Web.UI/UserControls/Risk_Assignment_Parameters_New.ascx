<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Risk_Assignment_Parameters_New.ascx.cs" Inherits="UserControls_Risk_Assignment_Parameters_New" %>
<%@ Register TagName="UxExport" Src="~/UserControls/UxExport.ascx" TagPrefix="uc" %>
<%@ Register TagName="UxTransCodeFilter" Src="~/UserControls/Risk_ParameterFilter_TransactionCode.ascx" TagPrefix="uc" %>
...
<div class="row">
    <div class="col-md-12">
        <div class="control-inline ">
            <as:RadioButton ID="rdMatchSpecific" runat="server" TabIndex="4" GroupName="rdMatch" Text="Match specific parameters"
        ...
        <div class="control-inline">
            <as:RadioButton ID="rdMatchAll" runat="server" TabIndex="4" GroupName="rdMatch"
...
<div class="row">
    <div class="col-md-12 in" id="uxAssignmentParamsGrid">
        <div class="header-card">
            ...
            <div class="groups">
                <div class="group">
                    <div class="item flex-grow-1"><%= GetLocalResourceObject("Literal2Resource2.Text") %></div>
                    <div class="item w-control-center"><%= GetLocalResourceObject("Literal1Resource1.Text").ToString().Replace("$",SessionManager.CurrencySymbol) %></div>
                    <div class="item w-control-center"><%= GetLocalResourceObject("ltThresholdResource1.Text") %></div>
                    <div class="item w-links"><%= GetLocalResourceObject("Literal6Resource1.Text") %></div>
                </div>
            </div>
        </div>
                    ...
                    <div runat="server" id="divGroup" class="row-card">
                        ...
                        <div class="groups">
                            <asp:Repeater ID="uxParameterInGroupRepeater" runat="server" OnItemDataBound="uxParameterInGroupRepeater_ItemDataBound">
                                <ItemTemplate>
                                    <div id='param_<%# GetValue(Eval("ParameterKey")) %>' data-key="<%# WebServices.SecurityServices.EncryptText(GetValue(Eval("ParameterKey"))) %>" data-order="<%# GetValue(Eval("RowNumber")) %>" data-is-source="<%# GetValue(Eval("IsSourceParam")) %>" class="group">
                                        ...
                                        <div class="item  w-control-center">
                                            <as:PlaceHolder ID="uxIndicatorNomal" runat="server">
                                                <div class="control-center">
                                                    ...
                                                    <div class="w-input">
                                                        <as:ASRadNumericTextBox ID="txtParameterValue" runat="server" Width="60px" text='<%# GetParameterNumber(Eval("ParameterValue").ToString()) %>' CssClass="form-control edit" Culture="en-US" DbValueFactor="1" LabelCssClass="" LabelWidth="64px">
                                            ...
                                            <as:PlaceHolder ID="uxIndicatorHigh" runat="server" Visible="False">
                                                ...
                                                <div class="control-center">
                                                    ...
                                                    <div class="w-input w-input">
                                                        <as:ASRadNumericTextBox ID="txtFrom" runat="server" Text='<%# string.Format("{0:n0}", GetParameterNumber(Eval("ParameterValue").ToString())) %>'
                                                ...
                                                <div class="control-center">
                                                    ...
                                                    <label>
                                                        <as:Literal ID="Literal61" runat="server" Text="day(s)" meta:resourcekey="Literal113Resource1"></as:Literal>
                                                    </label>
                                                </div>
                                            </as:PlaceHolder>
                                        </div>
                                        ...
                                        <div class="item  w-control-center">
                                            <as:PlaceHolder ID="lblNA" runat="server" Visible="False">
                                                <label></label>
                                                <as:Literal ID="Literal71" runat="server" Text="N/A" meta:resourcekey="Literal71Resource1"></as:Literal>
                                                <label></label>
                                            </as:PlaceHolder>
        ...
        <div class="mt-6x">
            ...
            <a href="#" class="heading link-back" onclick="return parameter_Add('rm_ParameterListModal.aspx');">
                <as:Literal ID="Literal14" runat="server" Text="+ Add parameters" meta:resourcekey="lbAddParameter"></as:Literal></a>
        </div>
...
<as:ASRadCodeBlock ID="ASRadCodeBlock1" runat="server">
    <script>
        ...
        var Code = '<%= AS.Core.Common.VeraCode.VeraCodeSolution.ValidateResponseData(UserControls_Risk_ParameterFilter_TransactionCode.GetSelectedValuesAsString(Mode, PrimaryID, uxPramKey.Value, FilterID))%>'
    </script>
    ...
    <script src="<%= ResolveUrl("~/")%>res/js/risk/Risk_Assignment_Parameters_New.js"></script>
</as:ASRadCodeBlock>
