...
public partial class UserControls_rm_MCF_FilterMerchantRank : GlobalUserControl, IRiskParamFilter
{
    #region Enums
    enum DataBindAction
    {
    ...
    #endregion
    static string PAGE_PATH = "~/UserControls/rm_MCF_FilterMerchantRank.ascx";
    ...
    {
        get { return uxMerchantRank.GetSelectedItemsAsString(","); }
    }
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        //uxMerchantRank.WidthSelector = (_WidthUC - 75) / 2;
        //uxMerchantRank.HeightSelector = _HeightUC;
    }


    protected void Page_Load(object sender, EventArgs e)
    {
        MESSAGE_MODE = "<b>" + GetLocalResourceObject("Risk_FilterMerchantRank_ascx_cs_MessageCode").ToString() + "</b><br />";
        _includedIn = GetLocalResourceObject("Risk_FilterMerchantRank_ascx_cs_IncludedIn").ToString();
        _excludedFrom = GetLocalResourceObject("Risk_FilterMerchantRank_ascx_cs_ExcludedFrom").ToString();
        _defaultValueNA = GetLocalResourceObject("Risk_FilterMerchantRank_ascx_cs_NA").ToString();
        if (!IsPostBack)
        {
            //BindData();
    ...
    private void BindData()
    {
        ...
        uxMerchantRank.DataSourceOrigination = listOri;
        uxMerchantRank.DataSourceDestination = listDes;
    }
    ...
    private DataTable GetFilterList(WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        return WebServices.RiskServices.GetReports("spa_RM_MCF_GetFilterMerchantRank", paramsIn);
    }
    ...
    public static Dictionary<string, string> GetSelectedValuesAsString(WebSiteEnums.ParamFilterMode mode, string primaryID, string paramID, string FilterID)
    {
        ...
        DataSet ds = WebServices.RiskServices.GetReportsAsDataSet("spa_RM_MCF_GetFilterMerchantRank", paramsIn);
    ...
    private static Dictionary<string, string> BuildeSelectedValues(DataTable dt, bool isInclude)
    {
        ...
        MESSAGE_MODE = "<b>" + HttpContext.GetLocalResourceObject(PAGE_PATH, "Risk_FilterMerchantRank_ascx_cs_MessageCode").ToString() + "</b><br />";
        _includedIn = HttpContext.GetLocalResourceObject(PAGE_PATH, "Risk_FilterMerchantRank_ascx_cs_IncludedIn").ToString();
        _excludedFrom = HttpContext.GetLocalResourceObject(PAGE_PATH, "Risk_FilterMerchantRank_ascx_cs_ExcludedFrom").ToString();
        _defaultValueNA = HttpContext.GetLocalResourceObject(PAGE_PATH, "Risk_FilterMerchantRank_ascx_cs_NA").ToString();
    ...
    public int Save()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_SaveMerchantRankAssignment", paramsIn, out paramsOut);
