<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_Filter_Referral_Source.ascx.cs" Inherits="UserControls_rm_MCF_Filter_Referral_Source" %>
<as:VWMultiSelector ID="uxReferralSource" runat="server" DataTextField="DataText" XmlFilterItemsFilePath="~/App_Data/AssigmentFilters.xml" DataValueField="DataKey"
