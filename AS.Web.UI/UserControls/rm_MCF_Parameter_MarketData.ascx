<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_Parameter_MarketData.ascx.cs"
    Inherits="UserControls_rm_MCF_Parameter_MarketData" %>

<%@ Register TagName="Export" Src="~/UserControls/UxExport.ascx" TagPrefix="uc" %>
<%@ Register TagName="RiskParameterFilter" Src="~/UserControls/rm_MCF_ParameterFilter_TransactionCode.ascx"
    TagPrefix="uc" %>
