...
public partial class UserControls_RiskTransactionHistory : GlobalUserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (FlagLink == 1)
        {
            ...
            string url = string.Format("<span class=\"dark-blue\"><a class=\"link-back\" href=\"#\" onclick=\"OpenInstanceWindow('rm_TransactionHistoryModal.aspx?{0}','DQWindow'); return false;\">[", queryString);
