<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MIF_MerchantDetails_RS2.ascx.cs" Inherits="UserControls_MIF_MerchantDetails_RS2" %>
                                    ...
                                    <tr class="Row">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxBank" runat="server" Visible='<%# CheckHierarchy("BANK") %>'>
                                                <a id="uxLinkBank" class="pointer" runat="server"><%= BindValue("EntityNumber1")%></a>
                                            </as:PlaceHolder>
                                             <as:Literal ID="Literal12" runat="server" Text='<%# Eval("EntityNumber1") %>' Visible='<%# !CheckHierarchy("BANK") %>'></as:Literal>                                
                                        </td>
                                    </tr>
                                    <tr class="AltRow">
                                        <td class="heading">
                                            <asp:Literal ID="Literal33" runat="server" Text="Acquirer:" meta:resourcekey="LiteralResource34" /></td>
                                        <td>
                                             <as:PlaceHolder ID="uxAssociation" runat="server" Visible='<%# CheckHierarchy("ACQUIRER") %>'>
                                                <a id="uxLinkAcquirer" class="pointer" runat="server"><%= BindValue("EntityNumber2")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal21" runat="server" Text='<%# Eval("EntityNumber2") %>' Visible='<%# !CheckHierarchy("ACQUIRER") %>'></as:Literal>  
                                        </td>
                                    </tr>
                                    <tr class="Row">
                                        <td class="heading">
                                            <asp:Literal ID="Literal23" runat="server" Text="Sub-Acquirer:" meta:resourcekey="LiteralResource_SubAcquirer" /></td>
                                        <td>
                                             <as:PlaceHolder ID="PlaceHolder2" runat="server" Visible='<%# CheckHierarchy("SUBACQUIRER") %>'>
                                                <a id="uxLinkSubAcquirer" class="pointer" runat="server"><%= BindValue("EntityNumber3")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal35" runat="server" Text='<%# Eval("EntityNumber3") %>' Visible='<%# !CheckHierarchy("SUBACQUIRER") %>'></as:Literal>  
                                        </td>
                                    </tr>
