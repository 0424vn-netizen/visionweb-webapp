...
public partial class UserControls_rm_MCF_Assignment_CancelButton : GlobalUserControl
{
    #region Enums
    enum DataBindAction { }
    enum PostBackAction
    ...
    private void EliminateTemporaryAssignment()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_EliminateTemporaryAssignment", paramsIn, out paramsOut);
    }
}
