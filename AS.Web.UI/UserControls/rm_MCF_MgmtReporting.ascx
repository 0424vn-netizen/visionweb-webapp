<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_MgmtReporting.ascx.cs" Inherits="UserControls_rm_MCF_MgmtReporting" %>
                            ...
                            <div class="filter-item">
                                ...
                                <as:ASRadComboBox ID="uxRCBMerchant" runat="server" OnClientSelectedIndexChanged="uxCboMerchant_ClientSelectedIndexChanged" Width="160px">
                                    <Items>
                                        ...
                                        <as:ASRadComboBoxItem Value="MERCHANTNUMBER" Text="Merchant Number" meta:resourcekey="ASRadComboBoxItemResource2" />
                                    </Items>
                                </as:ASRadComboBox>
                            </div>
                            <div class="filter-item">
...
<tek:RadCodeBlock ID="uxRadCodeBlock" runat="server">
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~/") %>res/js/risk_MCF/rm_MCF_MgmtReporting.js"></script>
