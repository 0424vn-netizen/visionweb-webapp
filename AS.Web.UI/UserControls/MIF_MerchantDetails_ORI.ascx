<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MIF_MerchantDetails_ORI.ascx.cs" Inherits="UserControls_MIF_MerchantDetails_ORI" %>
    ...
    <div class="row">
        <div class="col-md-12 in" id="ciMerchantInformation">
            <table class="ASTable" id="tblMerchantInformation">
                ...
                <tr class="Row">
                    <td class="heading  valign-top"><asp:Literal ID="Literal2" runat="server" Text="Merchant ID:" meta:resourcekey="LiteralResource2" />
                    </td>
                    <td>
                        <%= BindValue("MerchantNumber")%>
                    </td>
                    <td class="heading  valign-top"><asp:Literal ID="Literal3" runat="server" Text="Contact:" meta:resourcekey="LiteralResource3" />
                    </td>
                    <td>
                        <%= BindValue("Contact")%>
                    </td>
                    <td class="heading  valign-top"><asp:Literal ID="Literal4" runat="server" Text="Status:" meta:resourcekey="LiteralResource4" />
                    </td>
                    <td>
                ...
                <tr class="AltRow">
                    <td class="heading valign-top"><asp:Literal ID="Literal5" runat="server" Text="Merchant Name:" meta:resourcekey="LiteralResource5" />
                    </td>
                    <td>
                        <%= BindValue("MerchantName")%>
                    </td>
                    <td class="heading  valign-top"><asp:Literal ID="Literal6" runat="server" Text="Phone:" meta:resourcekey="LiteralResource6" />
                    </td>
                    <td>
                        <%= FormatPhone(BindValue("Phone"))%>
                    </td>
                    <td class="heading  valign-top text-nowrap"><asp:Literal ID="Literal7" runat="server" Text="Last Batch Activity:" meta:resourcekey="LiteralResource7" />
                    </td>
                    <td>
                ...
                <tr class="Row">
                    <td class="heading valign-top"><asp:Literal ID="Literal8" runat="server" Text="Address:" meta:resourcekey="LiteralResource8" />
                    </td>
                    <td>
                        <%= BindAddress(BindValue("Address1"), BindValue("Address2"), BindValue("Address3"), BindValue("City"), BindValue("State"), BindValue("Zip"))%>
                        
                    </td>
                    <td class="heading  valign-top"><asp:Literal ID="Literal9" runat="server" Text="Email:" meta:resourcekey="LiteralResource9" />                    
                    </td>
                    ...
                    <div class="row" id="businessinfo">
                        ...
                        <div class="col-md-12 in" id="ciBusinessInformation">
                            <table class="ASTable">
                                ...
                                <tr class="Row">
                                    <td class="heading"><asp:Literal ID="Literal12" runat="server" Text="Corporate Name:" meta:resourcekey="LiteralResource12" /></td>
                                    <td>
                                        <%# Eval("CorporateName") %>
                                    </td>
                                </tr>
                                <tr class="AltRow">
                                    <td class="heading"><asp:Literal ID="Literal13" runat="server" Text="Billing Address:" meta:resourcekey="LiteralResource13" /></td>
                                    <td>
                                        <%# Eval("CorporateAddress") %>
                                    </td>
                                </tr>
                                <tr class="Row">
                                    <td class="heading"><asp:Literal ID="Literal14" runat="server" Text="Phone:" meta:resourcekey="LiteralResource14" /></td>
                                    <td>
                                        <%# FormatPhone(Eval("Phone"))%>
                                    </td>
                                </tr>
                                <tr class="AltRow">
                                    <td class="heading"><asp:Literal ID="Literal15" runat="server" Text="Fax:" meta:resourcekey="LiteralResource15" /></td>
                                    <td>
                                        <%# FormatPhone(Eval("Fax"))%>
                                    </td>
                                </tr>
                                <tr class="Row">
                                    <td class="heading"><asp:Literal ID="Literal16" runat="server" Text="Approval Date:" meta:resourcekey="LiteralResource16" /></td>
                                    <td>
                                        <%# FormatDate(Eval("ApprovalDate"))%>
                                    </td>
                                </tr>
                                <tr class="AltRow">
                                    <td class="heading"><asp:Literal ID="Literal17" runat="server" Text="Closed Date:" meta:resourcekey="LiteralResource17" /></td>
                                    <td>
                                        <%# FormatDate(Eval("ClosedDate"))%>
                                    </td>
                                </tr>
                                <tr class="Row">
                                    <td class="heading"><asp:Literal ID="Literal18" runat="server" Text="Status:" meta:resourcekey="LiteralResource18" /></td>
                                    <td>
                                        <%# Eval("ActivityStatus")%>
                                    </td>
                                </tr>
                                <tr class="AltRow">
                                    <td class="heading valign-middle"><asp:Literal ID="Literal19" runat="server" Text="Site Access:" meta:resourcekey="LiteralResource19" /></td>
                                    <td><div class="opt-in-out-text w-50 <%# HasMSProductEnvironment()? "mt-1x" :"" %>">
                                            <asp:Literal ID="ltrSiteAccess" runat="server" Text='<%# HasMSProductEnvironment()?Eval("SiteAccess"):GetLocalResourceObject("MIF_MerchantDetails_ORIJS_Text_NA").ToString() %>' /></div>
                                        ...
                                        <as:PlaceHolder runat="server" ID="PlaceHolder1" Visible='<%# !IsCaseManagement %>'>
                                            <div class="opt-in-out-button pull-right">
                                                <as:Button ID="uxSiteAccess" runat="server" Text='<%# SetStatusText(Eval("SiteAccess")) %>'
                                                    Visible='<%# SetVisible(Eval("SiteAccess")) %>' OnClientClick='<%# SetURLForSiteAccessButton() %>' CssClass="btn btn-default" IsStandardButton="False" meta:resourcekey="uxSiteAccessResource1" /></div>
                                        </as:PlaceHolder>
                                    </td>
                                </tr>
                                <tr class="Row">
                                    <td class="heading"><asp:Literal ID="Literal20" runat="server" Text="Tax ID:" meta:resourcekey="LiteralResource20" /></td>
                                    <td>
                                        <%# CheckPermisson(Eval("TaxID"), WebSiteConstants.SEC_PERMISSION_TAX_ID)%>
                                    </td>
                                </tr>
                                <tr class="AltRow">
                                    <td class="heading"><asp:Literal ID="Literal21" runat="server" Text="SIC/MCC:" meta:resourcekey="LiteralResource21" /></td>
                                    <td>
                                        <%# FormatSIC(Eval("SICCode"), Eval("SICCodeDesc"))%>
                                    </td>
                                </tr>
                                <tr class="Row">
                                    <td class="heading"><asp:Literal ID="Literal22" runat="server" Text="Average Sales Amount:" meta:resourcekey="LiteralResource22" /></td>
                                    <td>
                            ...
                            <div class="col-md-12 in" id="ciHierarchyInformation">
                                <table class="ASTable">
                                    ...
                                    <tr class="AltRow">
                                        ...
                                        <td class="heading">
                                            <asp:Literal ID="Literal28" runat="server" Text="Porfolio:" meta:resourcekey="LiteralResource28" /></td>
                                        <td>
                                            <as:PlaceHolder ID="uxHPofolio" runat="server" visible='<%# CheckHierarchy("POR") %>'>
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;101&#039;, &#039;POR&#039;, &#039;<%# Eval("Porfolio") %>&#039;);'><%# Eval("Porfolio")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="uxLHPorfolio" runat="server" visible='<%# !CheckHierarchy("POR") %>' Text='<%# Eval("Porfolio") %>'></as:Literal></td></tr><tr class="Row">
                                        <td class="heading">
                                            <asp:Literal ID="Literal29" runat="server" Text="Group:" meta:resourcekey="LiteralResource29" /></td>
                                        <td>
                                            <as:PlaceHolder ID="uxHGroup" runat="server" visible='<%# CheckHierarchy("GROUP") %>'>
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;102&#039;, &#039;GROUP&#039;, &#039;<%# Eval("Group") %>&#039;);'><%# Eval("Group")%></a>                                                            
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal1" runat="server" visible='<%# !CheckHierarchy("GROUP") %>' Text='<%# Eval("Group") %>'></as:Literal></td><td class="heading">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxPlaceChain" runat="server">
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;103&#039;, &#039;CHAIN&#039;, &#039;<%# Eval("Chain") %>&#039;);'><%# Eval("Chain")%></a>
                                            </as:PlaceHolder>
                                            <as:PlaceHolder ID="uxPlaceChainNew" runat="server" Visible='<%# CheckPermissionAddEditChain(Eval("SiteAccess")) %>'>
                                                <a href="#" onclick="return ShowPopupModal('CreateNewChainModal.aspx?'+'<%# Page.BuildSecureQueryString("MerchNum="+Eval("MerchantNumber")) %>','auto');"><asp:Literal ID="Literal31" runat="server" Text="Create New Chain" meta:resourcekey="LiteralResource56" /></a></as:PlaceHolder><as:PlaceHolder ID="uxPlaceExistChain" runat="server" Visible='<%# CheckPermissionAddEditChain(Eval("SiteAccess")) %>'>
                                                <asp:Literal ID="Literal10" runat="server" Text="or" meta:resourcekey="LiteralResourceOR"></asp:Literal>  <a href="#" onclick="return ShowPopupModal('ModifyMerchantChainModal.aspx?'+'<%# Page.BuildSecureQueryString("MerchNum="+Eval("MerchantNumber")+"&Chain="+Eval("Chain")) %>','auto');"><asp:Literal ID="Literal32" runat="server" Text="Add to Existing Chain" meta:resourcekey="LiteralResource57" /></a></as:PlaceHolder><as:Literal ID="uxLHChain" runat="server" Text='<%# Eval("Chain") %>'></as:Literal></td></tr></table></div></div></asp:PlaceHolder></div><div class="col-md-6">
                    ...
                    <as:PlaceHolder runat="server" ID="PlaceHolder2" Visible='<%# !IsCaseManagement %>'>
                        ...
                        <div class="row" id="pricinginfo">
                            <div class="col-xs-12" data-toggle="collapse" data-target="#ciPricingInformation">
                                <h2 class="grid-title"><asp:Literal ID="Literal39" runat="server" Text="Pricing Information" meta:resourcekey="LiteralResource37" /></h2>
                            </div></div>
                        <div class="row">
