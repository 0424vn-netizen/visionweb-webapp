...
public partial class UserControls_Risk_FilterParameter : GlobalUserControl, IRiskParamFilter
{
    DataTable source;
    /// <summary>
    ...
    private DataTable GetParameterList()
    {
        ...
        source = WebServices.RiskServices.GetReports("spa_rm_cs_GetFilterParameterList", paramIns);
        return source;
    }
    ...
    public int Save()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_rm_cs_SaveFilterParameterList", paramIns, out paramOuts);
        return 0;
    }
