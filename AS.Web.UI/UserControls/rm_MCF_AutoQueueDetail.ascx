<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_AutoQueueDetail.ascx.cs" Inherits="UserControls_rm_MCF_AutoQueueDetail" %>
...
<as:ASRadCodeBlock ID="ASRadCodeBlock1" runat="server">
    <script src="<%= ResolveUrl("~/")%>res/js/risk_MCF/rm_MCF_AutoQueueDetail.js"></script>
    <script>
