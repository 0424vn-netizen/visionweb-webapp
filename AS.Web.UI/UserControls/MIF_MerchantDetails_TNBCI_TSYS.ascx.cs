...
public partial class UserControls_MIF_MerchantDetails_TNBCI_TSYS : ExportMultiSections
{
    #region Enums
    ...
    private const string FILE_NAME_HIERARCHY_INFO = "~/App_Data/tpl_HierarchyInformation_TNBCI_TSYS.htm";
    ...
    // SPA
    private const string SPA_GET_MERCHANT_PROFILE = "spa_cs_GetMerchantProfile_TSYS_Detail_TNBCI";
    ...
    protected string ButtonExcelHierarchyInformation_Click()
    {
        ...
        strExcelTemplate.Replace("[tpl_HierarchyInformation_FIS_htm_ASSOCIATION]", Resources.Template.tpl_HierarchyInformation_Fulton_htm_Association);
        ...
        strExcelTemplate.Replace("[tpl_HierarchyInformation_eVANCE_htm_MerchantHierarchy]", Resources.Template.tpl_HierarchyInformation_Fulton_htm_MerchantHierarchy);
        ...
        // Merchant Hierarchy
        strExcelTemplate.Replace("HI_BANK", "&nbsp;" + dataSource.Rows[0]["EntityNumber7"].ToString());
        strExcelTemplate.Replace("HI_ASSOCIATION", "&nbsp;" + dataSource.Rows[0]["EntityName9"].ToString());
        strExcelTemplate.Replace("HI_CHAIN_CODE", "&nbsp;" + dataSource.Rows[0]["Chain"].ToString());
    ...
    {
        return discoverRetained != DBNull.Value && discoverRetained.ToSafeString().ToBoolean() && !discoverRetained.IsNullOrEmpty()
