...
public partial class UserControls_Risk_FilterHierarchy : GlobalUserControl, IRiskParamFilter
{
    #region Enums
    enum DataBindAction
    {
    ...
    private DataTable GetFilterList(WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        return WebServices.RiskServices.GetReports("spa_rm_GetHierarchyFilter", parames);
    }
    ...
    public static string GetSelectedValuesAsString(WebSiteEnums.ParamFilterMode mode, string primaryID, string paramID, string FilterID, string hierarchyFilterMode)
    {
        FilterParameterCollection parames = new FilterParameterCollection();
        parames.AddLoggedInUserParams(SessionManager.CurrentUser.SiteID);
        parames.Add(new FilterParameter("@HierarchyFilterMode", hierarchyFilterMode, DbType.AnsiString));
        ...
        DataTable dt = WebServices.RiskServices.GetReports("spa_rm_GetHierarchyFilter", parames);
    ...
    private static bool GetIncludeStatus(string primaryID, int mode, string hierarchyFilterMode)
    {
        ...
        // Get OutParams value
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_rm_cs_GetFilterHierarchy_Info", parames, out paramesOut);
    ...
    private static string BuildeSelectedValues(DataTable dt, bool isInclude, string hierarchyFilterMode)
    {
