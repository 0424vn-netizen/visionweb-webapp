...
public partial class UserControls_Risk_Assignment_Group : GlobalUserControl, IRiskParamFilter
{
    #region properties
    ...
    private DataTable GetGroupList(int AssignmentID, WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        return WebServices.RiskServices.GetReports("spa_rm_cs_GetGroupListByAssignment", paramsIn);
    }
    ...
    public static string GetSelectedValuesAsString(WebSiteEnums.ParamFilterMode mode, string primaryID, string paramID, string FilterID)
    {
        ...
        DataTable tmp = WebServices.RiskServices.GetReports("spa_rm_cs_GetGroupListByAssignment", paramsIn);
    ...
    public int Save()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_rm_cs_AddAssignmentGroups", paramsIn, out paramsOut);
