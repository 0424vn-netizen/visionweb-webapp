...
public partial class UserControls_rm_MCF_Score : GlobalUserControl
{
    #region Properties   
    ...
    protected string RiskParameterKeysAllowDecimal
    {
        get
        {
            var arrAllowDecimal = BuGeneralFuncsLib.SplitToArray(WebSiteSettings.RiskParameterKeysAllowDecimal, ',');
            return javaScriptSerializer.Serialize(arrAllowDecimal);
        }
    }
    ...
    protected void uxParamList_ItemDataBound(object sender, Telerik.Web.UI.RadComboBoxItemEventArgs e)
    {
        ...
        item.ToolTip = row["ParameterDescription"].ToString();
        ...
        string parameterDataType = row["ParameterDataType"].ToString();
        item.Attributes["ParameterDataType"] = !string.IsNullOrEmpty(parameterDataType) && parameterDataType.Contains("#") ? "" : parameterDataType;
    }
    ...
    private void InsertRiskScores(int DDSClient, string ParameterKey, decimal ParameterIndicatorFrom, decimal ParameterIndicatorTo, decimal ParameterThreshold, decimal ParameterThresholdHigh, int ParameterScore, string UserId)
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_InsertRiskScores", parameters, out outParameters);
    }
    ...
    public void DoBindData(string paramId, string param, string from, string to, string threshold, string thresholdHigh, string score)
    {
        ...
        DataTable table = WebServices.RiskServices.GetReports("spa_RM_MCF_GetRiskParameterList", parameters);
