...
public partial class UserControls_MIF_MechantDetails_TSYS_CAYAN : ExportMultiSections
{
    #region Enums
    ...
    private const string FILE_NAME_BUSINESS_INFO = "~/App_Data/tpl_BusinessInformation_TSYS_CAYAN.htm";
    private const string FILE_NAME_HIERARCHY_INFO = "~/App_Data/tpl_HierarchyInformation_TYS_CAYAN.htm";
    ...
    // SPA
    private const string SPA_GET_MERCHANT_PROFILE = "spa_cs_GetMerchantProfile_TSYS_Detail_CAYAN";
    //TK 41447
            ...
            case DataBindAction.BindMerchantDetails:
                ...
                if (dtMerch.Rows.Count > 0)
                {
                    ...
                    foreach (RepeaterItem item in rptMerchantInfo.Items)
                    {
                        ...
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkAssociation", "EntityNumber6", HierarchyMode.CAYAN_ASSOCIATION);
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkBank", "EntityNumber5", HierarchyMode.CAYAN_BANK);
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkSalesAgent", "EntityNumber4", HierarchyMode.CAYAN_SALESAGENT);
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkSubSalesAgent", "EntityNumber7", HierarchyMode.CAYAN_SUB_SALESAGENT);
                    }
                }
                else
                {
    ...
    protected string ButtonExcelBusinessInformation_Click()
    {
        ...
        strExcelTemplate.Replace("[tpl_BusinessInformation_htm_LegalAddress]", GetLocalResourceObject("LiteralResource50.Text").ToString());
        ...
        strExcelTemplate.Replace("BI_LEGAL_ADDRESS", "&nbsp;" + BindAddress(dataSource.Rows[0]["LegalAddress"].ToString(), string.Empty, string.Empty,
            dataSource.Rows[0]["LegalCity"].ToString(),dataSource.Rows[0]["LegalState"].ToString(),dataSource.Rows[0]["LegalZip"].ToString()));
    ...
    protected string ButtonExcelHierarchyInformation_Click()
    {
        ...
        strExcelTemplate.Replace("[tpl_HierarchyInformation_htm_SalesAgent]", GetLocalResourceObject("LiteralResource37.Text").ToString());
        strExcelTemplate.Replace("[tpl_HierarchyInformation_htm_Sub_SalesAgent]", GetLocalResourceObject("LiteralResource60.Text").ToString());
        ...
        // Merchant Hierarchy
        strExcelTemplate.Replace("HI_BANK", "&nbsp;" + dataSource.Rows[0]["EntityNumber5"].ToString());
        strExcelTemplate.Replace("HI_ASSOCIATION", "&nbsp;" + dataSource.Rows[0]["EntityNumber6"].ToString());
        strExcelTemplate.Replace("HI_CHAIN", "&nbsp;" + dataSource.Rows[0]["Chain"].ToString());
        strExcelTemplate.Replace("HI_SALE_AGENTS", "&nbsp;" + dataSource.Rows[0]["EntityNumber4"].ToString());
        strExcelTemplate.Replace("HI_SUB_SALE_AGENTS", "&nbsp;" + dataSource.Rows[0]["EntityNumber7"].ToString());
