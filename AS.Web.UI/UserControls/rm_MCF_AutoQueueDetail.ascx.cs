...
public partial class UserControls_rm_MCF_AutoQueueDetail : GlobalUserControl
{
    #region Fields
    ...
    protected string AqEditLink
    {
        get
        {
            ...
            if (AutoQueueItem.ID > 0)
            {
                ...
                urlString = "rm_MCF_CreateEditAutoQueueModal.aspx?" + queryString;
            }
    ...
    protected string AqAllChangeLog
    {
        get
        {
            ...
            if (AutoQueueItem.ID > 0)
            {
                ...
                var page = this.Page as ReportPage;
                string queryString = page.BuildSecureQueryString(string.Format("AutoQueueID={0}", autoQueueID));
                urlString = "rm_MCF_AutoQueueMonitoringViewAllChanges.aspx?" + queryString;
            }
    ...
    {
        return GetDataChangeLog(queueId, false);
    }

    private DataTable GetDataChangeLog(long queueId, bool isMCFRisk)
    {
        ...
        _dataSourceChangelog = Rm_AutoQueueBusiness.GetDataChangeLog(queueId, false, isMCFRisk);
    ...
    private DataTable GetWorkQueueList(long queueId)
    {
        ...
        DataTable dataList = Rm_AutoQueueBusiness.GetDataAssignments(1, queueId, true);
    ...
    private DataTable GetAssignments(long queueId)
    {
        ...
        _dataSourceAssignments = Rm_AutoQueueBusiness.GetDataAssignments(0, queueId, true);
    ...
    public void BindDataDetail(long queueId)
    {
        ...
        ChangeLogGrid.DataSource = GetDataChangeLog(queueId, true);
