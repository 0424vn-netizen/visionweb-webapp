<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MIF_MerchantDetails_MLS.ascx.cs"
    Inherits="UserControls_MIF_MerchantDetails_MLS" %>
                            ...
                            <div class="col-md-12 in" id="ciBusinessInformation">
                                <table class="ASTable">
                                    <colgroup>
                                     ...
                                     <tr class="Row">
                                        <td class="heading">
                                            <asp:Literal ID="Literal19" runat="server" Text="Corporate Name:" meta:resourcekey="LiteralResourceCorporateName" /></td>
                                        <td>
                            ...
                            <div class="col-md-12 in" id="ciHierarchyInformation">
                                <table class="ASTable">
                                    ...
                                    <tr class="Row">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxBank" runat="server" Visible='<%# CheckHierarchy("BANK") && !Eval("EntityNumber1").IsNullOrEmpty() %>'>
                                                <a id="uxLinkBank" class="pointer" runat="server"><%# Eval("EntityNumber1")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="uxLHBank" runat="server" Visible='<%# !CheckHierarchy("BANK") %>'
                                                Text='<%# Eval("EntityNumber1") %>'></as:Literal></td>
                                    </tr>
                                    <tr class="AltRow">
                                        <td class="heading">
                                            <asp:Literal ID="Literal12" runat="server" Text="Group:" meta:resourcekey="LiteralResource30" /></td>
                                        <td>
                                            <as:PlaceHolder ID="PlaceHolder2" runat="server" Visible='<%# CheckHierarchy("GROUP") && !Eval("EntityNumber2").IsNullOrEmpty() %>'>
                                                <a id="uxLinkGroup" class="pointer" runat="server"><%# Eval("EntityNumber2")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal21" runat="server" Visible='<%# !CheckHierarchy("GROUP") %>'
                                                Text='<%# Eval("EntityNumber2") %>'></as:Literal></td>
                                    </tr>
                                    <tr class="Row">
                                        <td class="heading">
                                            <asp:Literal ID="Literal22" runat="server" Text="Association:" meta:resourcekey="LiteralResource34" /></td>
                                        <td>
                                            <as:PlaceHolder ID="PlaceHolder3" runat="server" Visible='<%# CheckHierarchy("ASSOCIATION") && !Eval("EntityNumber3").IsNullOrEmpty() %>'>
                                                <a id="uxLinkAssociation" class="pointer" runat="server"><%# Eval("EntityNumber3")%></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="Literal27" runat="server" Visible='<%# !CheckHierarchy("ASSOCIATION") %>'
                                                Text='<%# Eval("EntityNumber3") %>'></as:Literal></td>
                                    </tr>
                                    <tr class="AltRow">
                                        <td class="heading">
                                        ...
                                        <td>
                                            ...
                                            <as:PlaceHolder ID="uxPlaceChainNew" runat="server" Visible='<%# !CheckPermissionAddEditChain(Eval("SiteAccess")) %>'>
                                                <a href="#" onclick="return ShowPopupModal('CreateNewChainModal.aspx?'+'<%# Page.BuildSecureQueryString("MerchNum="+Eval("MerchantNumber")) %>','auto');">
                                                    <asp:Literal ID="Literal11" runat="server" Text="Create New Chain" meta:resourcekey="LiteralResource56" />
                                                </a>
                                            </as:PlaceHolder>
                                            <as:PlaceHolder ID="uxPlaceExistChain" runat="server" Visible='<%# CheckPermissionAddEditChain(Eval("SiteAccess")) %>'>
                                                <asp:Literal ID="Literal23" runat="server" Text=" or " meta:resourcekey="LiteralResourceOR"></asp:Literal>
                                     ...
                                     <tr class="Row">
                                        <td class="heading">
                                            <asp:Literal ID="Literal29" runat="server" Text="Secondary Access Chain:" meta:resourcekey="ltrSecondaryChain" /></td>
                                        <td>
                                            <as:PlaceHolder ID="uxPlaceAccessChain" runat="server"  Visible='<%# CheckHierarchy("ACCESSCHAIN") %>'>
                                                 <a href="#" id="uxLinkAccessChain" runat="server"><%= BindValue("EntityNumber4")%> </a>
                                            </as:PlaceHolder>
                                            <as:PlaceHolder ID="uxPlaceAccessChainNew" runat="server" Visible='<%# CheckPermissionAddEditAccessChain(Eval("SiteAccess")) %>'>
                                                <a href="#" onclick="return ShowPopupModal('CreateNewSecondaryAccessChainModal.aspx?'+'<%# Page.BuildSecureQueryString("MerchNum="+Eval("MerchantNumber")) %>','auto');"><%= this.GetLocalResourceObject("CHAIN_Create_New_Secondary").ToString() %></a>
                                            </as:PlaceHolder>
                                            <as:PlaceHolder ID="uxPlaceExistAccessChain" runat="server" Visible='<%# CheckPermissionAddEditAccessChain(Eval("SiteAccess")) %>'>
                                                <asp:Literal ID="Literal30" runat="server" Text="or" meta:resourcekey="LiteralResourceOR"></asp:Literal> <a href="#" onclick="return ShowPopupModal('ModifyMerchantSecondaryAccessChainModal.aspx?'+'<%# Page.BuildSecureQueryString("MerchNum="+Eval("MerchantNumber")+"&AccessChain="+Eval("EntityNumber4")) %>','auto');"><%= this.GetLocalResourceObject("CHAIN_Add_Existing_Secondary").ToString() %></a>
                                            </as:PlaceHolder>
                                            <as:Literal ID="uxLHAccessChain" runat="server" Text='<%# Eval("EntityNumber4") %>'></as:Literal></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
