...
public partial class UserControls_rm_MCF_MerchantFundingStatus : GlobalUserControl, IRiskParamFilter
{
    #region Enums
    enum DataBindAction
    {
    ...
    #endregion
    static string PAGE_PATH = "~/UserControls/rm_MCF_MerchantFundingStatus.ascx";
    ...
    {
        get { return uxMerchantFundingStatus.GetSelectedItemsAsString(","); }
    }
    ...
    {
        MESSAGE_MODE = "<b>" + GetLocalResourceObject("Risk_MerchantFundingStatus_ascx_cs_MessageCode").ToString() + "</b><br />";
    ...
    private void BindData()
    {
        ...
        uxMerchantFundingStatus.DataSourceOrigination = listOri;
        uxMerchantFundingStatus.DataSourceDestination = listDes;
    }
    ...
    private DataTable GetFilterList(WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        return WebServices.RiskServices.GetReports("spa_RM_MCF_GetFilterFundingStatus", paramsIn);
    }
    ...
    public static Dictionary<string, string> GetSelectedValuesAsString(WebSiteEnums.ParamFilterMode mode, string primaryID, string paramID, string FilterID)
    {
        ...
        DataSet ds = WebServices.RiskServices.GetReportsAsDataSet("spa_RM_MCF_GetFilterFundingStatus", paramsIn);
    ...
    private static Dictionary<string, string> BuildeSelectedValues(DataTable dt, bool isInclude)
    {
        ...
        MESSAGE_MODE = "<b>" + HttpContext.GetLocalResourceObject(PAGE_PATH, "Risk_MerchantFundingStatus_ascx_cs_MessageCode").ToString() + "</b><br />";
    ...
    public int Save()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_SaveFundingStatusAssignment", paramsIn, out paramsOut);
