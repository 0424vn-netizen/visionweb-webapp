...
public partial class UserControls_rm_MCF_FilterMarketData : GlobalUserControl, IRiskParamFilter
{
    #region Enums
    enum DataBindAction
    {
    ...
    private DataTable GetFilterList(WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        return WebServices.RiskServices.GetReports("spa_RM_MCF_GetFilterMarketData", parames);
    }
    ...
    public static string GetSelectedValuesAsString(WebSiteEnums.ParamFilterMode mode, string primaryID, string paramID, string FilterID, out string marketdata)
    {
        ...
        DataTable dt = WebServices.RiskServices.GetReports("spa_RM_MCF_GetFilterMarketData", parames);
        marketdata = "1";
    ...
    public int Save()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_SaveFilterMarketData", paramesIn, out paramesOut);
        return 0;
    }
    ...
    private bool validateMarketData(string codelist)
    {
        ...
        DataTable dt = WebServices.RiskServices.GetReports("spa_RM_MCF_CheckMarketDataSetup", paramesIn);
        if (dt != null)
        {
