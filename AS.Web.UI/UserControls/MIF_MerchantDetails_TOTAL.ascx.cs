...
public partial class UserControls_MIF_MerchantDetails_TOTAL : ExportMultiSections
{
    #region Constants

    private string PATH_EXPORT_EXCEL_FILE = ConfigurationManager.AppSettings["ExportTempFolder"];
    private const string FILE_NAME_BUSINESS_INFO = "~/App_Data/tpl_BusinessInformation_TOTAL.htm";
    private const string FILE_NAME_BANK_INFO = "~/App_Data/tpl_BankInformation_TOTAL.htm";
    private const string FILE_NAME_HIERARCHY_INFO = "~/App_Data/tpl_HierarchyInformation_TOTAL.htm";
    ...
    public void DoMultiExportExcel()
    {
        ...
        exportNames.Add(1, GetLocalResourceObject("MIF_MerchantDetails_TOTALCS_Text_BusinessInformation").ToString());
        if (IsRiskInformation)
        {
            exportNames.Add(2, GetLocalResourceObject("MIF_MerchantDetails_Text_RiskInformation").ToString());
            exportNames.Add(3, GetLocalResourceObject("MIF_MerchantDetails_TOTALCS_Text_HierarchyInformation").ToString());
            exportNames.Add(4, GetLocalResourceObject("MIF_MerchantDetails_TOTALCS_Text_BankInformation").ToString());
        }
        else
        {
            exportNames.Add(2, GetLocalResourceObject("MIF_MerchantDetails_TOTALCS_Text_HierarchyInformation").ToString());
            exportNames.Add(3, GetLocalResourceObject("MIF_MerchantDetails_TOTALCS_Text_BankInformation").ToString());
        }
    ...
    protected string ButtonExcelBusinessInformation_Click()
    {
        ...
        //StringBuilder strExcelTemplate = new StringBuilder(File.ReadAllText(Server.MapPath("~/App_Data/tpl_BusinessInformation_TOTAL.htm")));
        ...
        {
            strExcelTemplate.Replace("BI_SITE_ACCESS", "&nbsp;" + GetLocalResourceObject("MIF_MerchantDetails_TOTALJS_Text_NotAvailable").ToString());
        }
        ...
        string excelFileName = GeneralFuncsLib.GetFileName(GetLocalResourceObject("MIF_MerchantDetails_TOTALCS_Text_BusinessInformation").ToString());
    ...
    protected string ButtonExcelHierarchyInformation_Click()
    {
        ...
        strExcelTemplate.Replace("[tpl_HierarchyInformation_TOTAL_htm_Business]", Resources.Template.tpl_HierarchyInformation_TOTAL_htm_Business);
        ...
        string excelFileName = GeneralFuncsLib.GetFileName(GetLocalResourceObject("MIF_MerchantDetails_TOTALCS_Text_HierarchyInformation").ToString());
        return WriteContentToFile(PATH_EXPORT_EXCEL_FILE, excelFileName, "xls", strExcelTemplate.ToString());
    }
    ...
    protected string ButtonExcelBankInformation_Click()
    {
        ...
        string excelFileName = GeneralFuncsLib.GetFileName(GetLocalResourceObject("MIF_MerchantDetails_TOTALCS_Text_BankInformation").ToString());
        return WriteContentToFile(PATH_EXPORT_EXCEL_FILE, excelFileName, "xls", strExcelTemplate.ToString());
    }
