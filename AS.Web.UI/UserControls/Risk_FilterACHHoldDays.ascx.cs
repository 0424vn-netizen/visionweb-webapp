...
public partial class UserControls_Risk_FilterACHHoldDays : GlobalUserControl, IRiskParamFilter
{
    #region Enums
    enum DataBindAction
    {
    ...
    private DataTable GetFilterList(WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        return WebServices.RiskServices.GetReports("spa_rm_cs_GetFilterACHHoldDay", paramsIn);
    }
    ...
    public static string GetSelectedValuesAsString(WebSiteEnums.ParamFilterMode mode, string primaryID, string paramID, string FilterID)
    {
        ...
        DataSet ds = WebServices.RiskServices.GetReportsAsDataSet("spa_rm_cs_GetFilterACHHoldDay", paramsIn);
    ...
    public int Save()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_rm_cs_SaveACHHoldDayAssignment", paramsIn, out paramsOut);
