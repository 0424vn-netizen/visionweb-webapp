<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_AQAggregateReport.ascx.cs"
    Inherits="UserControls_rm_MCF_AQAggregateReport" %>
...
<as:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript" src="<%=ResolveUrl("~") %>res/js/risk_MCF/rm_MCF_AQAggregateReport.js"></script>
</as:RadCodeBlock>
