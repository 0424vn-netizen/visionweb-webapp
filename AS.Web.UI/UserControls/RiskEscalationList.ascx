<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RiskEscalationList.ascx.cs"
    Inherits="UserControls_RiskEscalationList" %>
...
<as:ASGrid ID="uxEscalationGrid"
    ...
    <MasterTableView Width="100%">
        <Columns>
            ...
            <as:ASGridBoundColumn HeaderText="Merchant ID"
