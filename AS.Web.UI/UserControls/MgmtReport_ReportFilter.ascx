<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MgmtReport_ReportFilter.ascx.cs" Inherits="UserControls_MgmtReport_ReportFilter" %>
            ...
            <div class="filter-block">
                <table>
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="filter-item default-width text-right">
                                    ...
                                    <as:MultiChooser IsSearchContains="true" ID="uxAgentList" runat="server" Placeholder=" " meta:resourcekey="uxAgentListResource1">
                                    </as:MultiChooser>
                                    ...
                                    <as:MultiChooser IsSearchContains="true" ID="uxGroupList" runat="server" Placeholder=" " meta:resourcekey="uxGroupListResource1">
                                    </as:MultiChooser>
                                </asp:Panel>
                            </td>
                        </tr>
                    ...
                    <as:PlaceHolder ID="uxMerchantPanel" runat="server" Visible="False">
                        <tr>
                            <td class="text-right">
                                <label class="filter-label"><asp:Literal ID="Literal1" runat="server" Text="Merchant ID:" meta:resourcekey="LiteralResource1" /></label></td>
                            <td class="text-left">
                                ...
                                <span class="filter-text mr-9x-neg">
                                    <a href="#" onclick="return ShowPopupModal('rm_MgmtReport_MerchantFilter.aspx', 'auto'); return false;"><asp:Literal ID="Literal2" runat="server" Text="Find" meta:resourcekey="LiteralResource2" /></a>
                                </span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="filter-item risk-mgmt-big-chosen">
                                    <as:MultiChooser IsSearchContains="true" ID="uxAssignmentList" runat="server" Width="100%" Placeholder=" " CssClass="rf_TextBox" meta:resourcekey="uxAssignmentListResource1">
                                    </as:MultiChooser>
                                </div>
                            </td>
                        </tr>
                    ...
                    <as:PlaceHolder ID="uxParameterPanel" runat="server" Visible="False">
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="filter-item risk-mgmt-big-chosen">
                                    <as:MultiChooser IsSearchContains="true" ID="uxParameterList" runat="server" Width="100%" Placeholder=" " meta:resourcekey="uxParameterListResource1">
                                    </as:MultiChooser>
                                </div>
                            </td>
                        </tr>
...
<script type="text/javascript">
    ...
    var MgmtReport_ReportFilter_MsgInvalidMerchantID = "<%=GetLocalResourceObject("InvalidMerchantNumber").ToString() %>";
    ...
    var msgMIDLessThan3Chars = '<%= GetLocalResourceObject("msgMIDLessThan3Chars").ToString()%>';
    var funcValidate = 'ValidateData';

</script>
<script src="<%=ResolveUrl("~") %>res/js/risk/MgmtReport_ReportFilter.js"></script>