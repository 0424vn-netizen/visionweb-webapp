<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NewRiskReport_TransactionVolumeAnalysis.ascx.cs"
    Inherits="UserControls_NewRiskReportRiskManagement" %>
...
<tek:RadAjaxManagerProxy ID="RadAjaxManager1" runat="server">
    <AjaxSettings>
        <tek:AjaxSetting AjaxControlID="uxTransVolumeAnalysisDataGrid">
            <UpdatedControls>
                <tek:AjaxUpdatedControl ControlID="uxExportTransVolumeAnalysis" LoadingPanelID="uxLoadingPanelCustom" />
                <tek:AjaxUpdatedControl ControlID="uxTransVolumeAnalysisDataGrid" LoadingPanelID="uxLoadingPanelCustom" />
            </UpdatedControls>
        </tek:AjaxSetting>
        ...
        <tek:AjaxSetting AjaxControlID="btnRebind">
            <UpdatedControls>
                <tek:AjaxUpdatedControl ControlID="uxViewColumns" LoadingPanelID="uxLoadingPanelCustom" />
                <tek:AjaxUpdatedControl ControlID="uxTransVolumeAnalysisDataGrid" LoadingPanelID="uxLoadingPanelCustom" />
            </UpdatedControls>
        </tek:AjaxSetting>
    </AjaxSettings>
...
<div class="row" id="transvolumne">
    <div class="col-md-10">
        ...
        <asp:Label ID="iconContractExpectedInfo" CssClass="info-link" runat="server"></asp:Label>
    </div>
...
<div class="row ipmt">
    <div class="col-md-4">
        ...
        <div class="inline-block">
            <as:RadComboBox ID="uxViewColumns" runat="server" AutoPostBack="true" OnSelectedIndexChanged="uxViewColumns_SelectedIndexChanged"
                DataValueField="CustomViewID" DataTextField="ViewName" Width="200px">
            </as:RadComboBox>

        </div>
        <span class="dark-blue ml-4x">
            <asp:LinkButton runat="server" ID="uxCustomizeColumnLink" CssClass="link-back" Text="Customize" meta:resourcekey="Literal16Resource1"></asp:LinkButton></span>
    </div>
        ...
        <MasterTableView>
            <Columns>
                ...
                <as:ASGridTemplateColumn HeaderText="CB$" UniqueName="ChargeBackVolume" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="100px"
                    ...
                    <HeaderTemplate>
                        <span id="ASGridBoundColumnResource47" title="CB$"><%#GetLocalResourceObject("ChargeBackVolume.HeaderText").ToString().Replace("$",SessionManager.CurrencySymbol) %></span>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <as:ASGridTemplateColumn HeaderText="Sales $" UniqueName="SaleAmount" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="100px"
                    ...
                    <HeaderTemplate>
                        <span id="ASGridBoundColumnResource54" title="Sales $"><%#GetLocalResourceObject("SaleAmount.HeaderText").ToString().Replace("$",SessionManager.CurrencySymbol) %></span>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <as:ASGridTemplateColumn HeaderText="Auth Decl $" UniqueName="DeclinedAuthorizationAmount" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="100px"
                    ...
                    <HeaderTemplate>
                        <span id="ASGridBoundColumnResource58" title="Auth Decl $"><%#GetLocalResourceObject("DeclinedAuthorizationAmount.HeaderText").ToString().Replace("$",SessionManager.CurrencySymbol) %></span>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <as:ASGridTemplateColumn HeaderText="Auth Decl $ %" UniqueName="DeclinedAuthorizationAmountPercent" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="100px"
                    ...
                    <HeaderTemplate>
                        <span id="ASGridBoundColumnResource60" title="Auth Decl $ %"><%#GetLocalResourceObject("DeclinedAuthorizationAmountPercent.HeaderText").ToString().Replace("$",SessionManager.CurrencySymbol) %></span>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <as:ASGridTemplateColumn HeaderText="Retrieval $ %" UniqueName="RetrievalAmountPercent" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="100px"
                    ...
                    <HeaderTemplate>
                        <span id="ASGridBoundColumnResource63" title="Retrieval $ %"><%#GetLocalResourceObject("RetrievalAmountPercent.HeaderText").ToString().Replace("$",SessionManager.CurrencySymbol) %></span>
                    </HeaderTemplate>
                    <ItemTemplate>
