<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_FilterMerchantRank.ascx.cs" Inherits="UserControls_rm_MCF_FilterMerchantRank" %>
<as:MultiSelector ID="uxMerchantRank" runat="server" DataTextField="DataText" XmlFilterItemsFilePath="~/App_Data/AssigmentFilters.xml" DataValueField="DataKey"
