...
public partial class UserControls_rm_MCF_FilterZipCode : GlobalUserControl, IRiskParamFilter
{
    #region Enums
    enum DataBindAction
    {
    ...
    #endregion
    static string PAGE_PATH = "~/UserControls/rm_MCF_FilterZipCode.ascx";
    ...
    private DataTable GetFilterList(WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        return WebServices.RiskServices.GetReports("spa_RM_MCF_GetFilterZip", paramsIn);
    }
    ...
    public static Dictionary<string, string> GetSelectedValuesAsString(WebSiteEnums.ParamFilterMode mode, string primaryID, string paramID, string FilterID)
    {
        ...
        DataSet ds = WebServices.RiskServices.GetReportsAsDataSet("spa_RM_MCF_GetFilterZip", paramsIn);
    ...
    private static Dictionary<string, string> BuildeSelectedValues(DataTable dt, bool isInclude)
    {
        ...
        MESSAGE_MODE = "<b>" + HttpContext.GetLocalResourceObject(PAGE_PATH, "Risk_FilterZipCode2_ascx_cs_MessageCode").ToString() + "</b><br />";
    ...
    public int Save()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_SaveZipAssignment", paramsIn, out paramsOut);
