<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_EditRiskScore.ascx.cs" Inherits="UserControls_rm_MCF_EditRiskScore" %>
...
<div class="text-center">
    <div class="risk-form">
        <div class="risk-form-row">
            ...
            <asp:HiddenField ID="uxIsAllowDecimalValue" runat="server" />
             <asp:HiddenField ID="uxPrecisionValue" runat="server" />
            ...
            <div class="text-center">
                <div class="bottom-error">
                    <label id="uxParameterIndicatorFromEditPrecisionMsg" class="error"></label>
                ...
                <div class="bottom-error">
                    <label id="uxParameterIndicatorToEditPrecisionMsg" class="error"></label>
...
<as:Validator ID="ctrlValidatorForEdit" runat="server" ValidationFunction="doValidationForEdit" MessageType="Inline" MessageContainerClientID="" meta:resourcekey="ctrlValidatorForEditResource1">
    <Items>
        <as:CustomValidationItem ControlToValidateID="uxParameterIndicatorFrom" ClientValidationFunction="paramIndicatorFromRequiredForEdit" Message=" "/>
        <as:CustomValidationItem ControlToValidateID="uxParameterIndicatorFrom" ClientValidationFunction="CheckValidFromPrecisionForEdit" Message=" "/>
        <as:CustomValidationItem ControlToValidateID="uxParameterIndicatorFrom" ClientValidationFunction="CheckIndicatorFromGreaterZeroForEdit" Message=" " />
        <as:CustomValidationItem ControlToValidateID="uxParameterIndicatorFrom" ClientValidationFunction="paramIndicatorFromValidForEdit" Message=" " />



        <as:CustomValidationItem ControlToValidateID="uxParameterIndicatorTo" ClientValidationFunction="paramIndicatorToRequiredForEdit" Message=" "/>
        <as:CustomValidationItem ControlToValidateID="uxParameterIndicatorTo" ClientValidationFunction="CheckIndicatorToGreaterZeroForEdit" Message=" " />
        <as:CustomValidationItem ControlToValidateID="uxParameterIndicatorTo" ClientValidationFunction="paramIndicatorToValidForEdit" Message=" " />
        <as:CustomValidationItem ControlToValidateID="uxParameterIndicatorTo" ClientValidationFunction="CheckValidToPrecisionForEdit" Message=" " />
...
<as:ASRadCodeBlock ID="RadCodeBlock" runat="server">
    <script type="text/javascript">
        ...
        var EditRiskScore_uxParameterIndicatorFromPrecisionMsg = '<%= GetLocalResourceObject("RiskScore_ascx_IndicatorFromPrecision.Message").ToString() %>';
        var EditRiskScore_uxParameterIndicatorToPrecisionMsg = '<%= GetLocalResourceObject("RiskScore_ascx_IndicatorToPrecision.Message").ToString() %>';
        var editRiskScore_uxParameterIndicatorFromGreaterZeroPoint1Msg = '<%= GetLocalResourceObject("RiskScore_ascx_IndicatorFromNumberGreaterZeroPoint1.Message").ToString() %>';
        var editRiskScore_uxParameterIndicatorFromGreaterMinByPrecisionMsg = '<%= GetLocalResourceObject("RiskScore_ascx_IndicatorFromNumberGreaterMinByPrecision.Message").ToString() %>';
        var editRiskScore_uxParameterIndicatorToGreaterZeroPoint1Msg = '<%= GetLocalResourceObject("RiskScore_ascx_IndicatorToNumberGreaterZeroPoint1.Message").ToString() %>';
        var editRiskScore_uxParameterIndicatorToGreaterMinByPrecisionMsg = '<%= GetLocalResourceObject("RiskScore_ascx_IndicatorToNumberGreaterMinByPrecision.Message").ToString() %>';
        ...
        var EditRiskScore_uxIsAllowDecimalValue = '<%=uxIsAllowDecimalValue.ClientID%>';
        var EditRiskScore_uxPrecisionValue = '<%=uxPrecisionValue.ClientID%>';
    </script>
    <script src="<%= ResolveUrl("~/")%>res/js/risk_MCF/rm_MCF_EditRiskScore.js">
    </script>
</as:ASRadCodeBlock>
