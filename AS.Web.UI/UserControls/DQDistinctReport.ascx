<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DQDistinctReport.ascx.cs"
    Inherits="UserControls_DQDistinctReport" %>
...
<as:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript" src="<%=ResolveUrl("~") %>res/js/risk/DQDistinctReport.js"></script>
</as:RadCodeBlock>
