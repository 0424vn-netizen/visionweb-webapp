...
public partial class UserControls_MIF_MerchantDetails_TSYS : ExportMultiSections
{
    #region Constants

    private string PATH_EXPORT_EXCEL_FILE = ConfigurationManager.AppSettings["ExportTempFolder"];
    private const string FILE_NAME_BUSINESS_INFO = "~/App_Data/tpl_BusinessInformation_TSYS.htm";
    private const string FILE_NAME_BANK_INFO = "~/App_Data/tpl_BankInformation_TSYS.htm";
    private const string FILE_NAME_HIERARCHY_INFO = "~/App_Data/tpl_HierarchyInformation_TSYS.htm";
    ...
    private const string SPA_GET_MERCHANT_PROFILE = "spa_cs_GetMerchantProfile_TSYS";
    ...
    public void Rebind()
    {
        ...
        {
            uxPlhSwitchFDRMID.Visible = true;
            this.BindSwitchMID();
        }
        else
        {
            uxPlhSwitchFDRMID.Visible = false;
        }
    }
    ...
    public void DoMultiExportExcel()
    {
        ...
        exportNames.Add(0, GetLocalResourceObject("LiteralResource45.Text").ToString());
        exportNames.Add(1, GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_BusinessInformation").ToString());
        if (IsRiskInformation)
        {
            exportNames.Add(2, GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_RiskInformation").ToString());
            exportNames.Add(3, GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_HierarchyInformation").ToString());
            exportNames.Add(4, GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_BankInformation").ToString());
            exportNames.Add(5, GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_TerminalInformation").ToString());
            exportNames.Add(6, GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_Memos").ToString());
        }
        else
        {

            exportNames.Add(2, GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_HierarchyInformation").ToString());
            exportNames.Add(3, GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_BankInformation").ToString());
            exportNames.Add(4, GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_TerminalInformation").ToString());
            exportNames.Add(5, GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_Memos").ToString());
        }
    ...
    protected string ButtonExcelBusinessInformation_Click()
    {
        ...
        strExcelTemplate.Replace("[tpl_BusinessInformation_htm_OpenDate]", Resources.Template.tpl_BusinessInformation_EMS_htm_Date);
        strExcelTemplate.Replace("[tpl_BusinessInformation_TSYS_htm_FederalTaxID]", Resources.Template.tpl_BusinessInformation_TSYS_htm_FederalTaxID);
        ...
        strExcelTemplate.Replace("[tpl_BusinessInformation_TSYS_htm_Lessor]", Resources.Template.tpl_BusinessInformation_TSYS_htm_Lessor);
        strExcelTemplate.Replace("[tpl_BusinessInformation_TSYS_htm_GiftCardCustomerNumber]", Resources.Template.tpl_BusinessInformation_TSYS_htm_GiftCardCustomerNumber);
        ...
        if (GeneralFuncsLib.EnabledTSYSConversion())
        {
            string conversionDateHtml = "<tr class='borderTop'><td width='40%' valign='top'>{0}</td><td>{1}</td></tr>";
            strExcelTemplate.Replace("[CONVERSION_DATE]", string.Format(conversionDateHtml, Resources.Template.tpl_BusinessInformation_TSYS_htm_ConversionDate, FormatDate(dataSource.Rows[0]["ActualConversionDate"].ToString())));
        }
        string excelFileName = GeneralFuncsLib.GetFileName(GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_BusinessInformation").ToString());
    ...
    protected string ButtonExcelHierarchyInformation_Click()
    {
        ...
        strExcelTemplate.Replace("[tpl_HierarchyInformation_TSYS_htm_ChainNumber]", Resources.Template.tpl_HierarchyInformation_TSYS_htm_ChainNumber);
        ...
        strExcelTemplate.Replace("HI_ChainNumber", "&nbsp;" + _datasource.Rows[0]["ChainNumber"].ToString());
        string excelFileName = GeneralFuncsLib.GetFileName(GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_HierarchyInformation").ToString());
        return WriteContentToFile(PATH_EXPORT_EXCEL_FILE, excelFileName, "xls", strExcelTemplate.ToString());
    }
    ...
    protected string ButtonExcelBankInformation_Click()
    {
        ...
        strExcelTemplate.Replace("BI_RoutingNumber", "&nbsp;" + _datasource.Rows[0]["PartialRoutingNumber"].ToString());
        strExcelTemplate.Replace("BI_AccountNumber", "&nbsp;" + _datasource.Rows[0]["AccountNumber"].ToString());
        string excelFileName = GeneralFuncsLib.GetFileName(GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_BankInformation").ToString());
        return WriteContentToFile(PATH_EXPORT_EXCEL_FILE, excelFileName, "xls", strExcelTemplate.ToString());
    }
    ...
    protected string ButtonExcelTerminalInformation_Click()
    {
        ...
        strExcelTemplate.Replace("BI_OtherCardType", "&nbsp;" + _datasource.Rows[0]["OtherCardType"].ToString());
        string excelFileName = GeneralFuncsLib.GetFileName(GetLocalResourceObject("MIF_MerchantDetails_TSYSCS_Text_TerminalInformation").ToString());
        return WriteContentToFile(PATH_EXPORT_EXCEL_FILE, excelFileName, "xls", strExcelTemplate.ToString());
    }
    ...
    protected string ButtonExcelMerchantInformation_Click()
    {
        ...
        string excelFileName = GeneralFuncsLib.GetFileName(GetLocalResourceObject("LiteralResource45.Text").ToString());
        return WriteContentToFile(PATH_EXPORT_EXCEL_FILE, excelFileName, "xls", strExcelTemplate.ToString());
    }
    ...
    private void BindSwitchMID()
    {
        ...
        parameters.AddLoggedInUserReportingParams();
        parameters.Add(new FilterParameter("@MerchantNumber", GetMerchantNrParameter(), DbType.AnsiString));
        parameters.Add(new FilterParameter("@Processor", BackEndProcessor.TSYS, DbType.String));
        ...
        {
            uxPlhSwitchFDRMID.Visible = true;
            uxSwitchFDRMID.NavigateUrl = "#";
            uxSwitchFDRMID.Attributes.Add("onclick", MerchantProfileHelper.BuildSubmitReportFilterJavascriptCall(HierarchyMode.MERCHANT_NR, data.Rows[0][FDR_MID].ToString()));
