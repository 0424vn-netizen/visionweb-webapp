...
public partial class UserControls_Risk_FilterMerchantRank : GlobalUserControl, IRiskParamFilter
{
    #region Enums
    enum DataBindAction
    {
    ...
    private DataTable GetFilterList(WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        return WebServices.RiskServices.GetReports("spa_rm_cs_GetFilterMerchantRank", paramsIn);
    }
    ...
    public static string GetSelectedValuesAsString(WebSiteEnums.ParamFilterMode mode, string primaryID, string paramID, string FilterID)
    {
        ...
        DataSet ds = WebServices.RiskServices.GetReportsAsDataSet("spa_rm_cs_GetFilterMerchantRank", paramsIn);
    ...
    public int Save()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_rm_cs_SaveMerchantRankAssignment", paramsIn, out paramsOut);
