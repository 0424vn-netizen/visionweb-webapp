<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MIF_MerchantDetails_Fulton.ascx.cs"
    Inherits="UserControls_MIF_MerchantDetails_Fulton" %>
                                    ...
                                    <tr class="Row">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxHCorp" runat="server" Visible='<%# CheckHierarchy("CORP") && !Eval("Corporate").IsNullOrEmpty() %>'>
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;9101&#039;, &#039;CORP&#039;, &#039;<%# Eval("Corporate") %>&#039;);'>
                                                    <%# Eval("Corporate")%></a>
                                            </as:PlaceHolder>
                                    ...
                                    <tr class="AltRow">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxHBank" runat="server" Visible='<%# CheckHierarchy("FBBANK") && !Eval("Bank").IsNullOrEmpty() %>'>
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;9102&#039;, &#039;FBBANK&#039;, &#039;<%# Eval("Bank") %>&#039;);'>
                                                    <%# Eval("Bank")%></a>
                                            </as:PlaceHolder>
                                    ...
                                    <tr class="Row">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxHRegion" runat="server" Visible='<%# CheckHierarchy("REG") && !Eval("Region").IsNullOrEmpty() %>'>
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;9103&#039;, &#039;REG&#039;, &#039;<%# Eval("Region") %>&#039;);'>
                                                    <%# Eval("Region")%></a>
                                            </as:PlaceHolder>
                                    ...
                                    <tr class="AltRow">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxHAssoSubGrp" runat="server" Visible='<%# CheckHierarchy("ASSOSUBGROUP") && !Eval("ASSOSUBGROUP").IsNullOrEmpty() %>'>
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;9104&#039;, &#039;ASSOSUBGROUP&#039;, &#039;<%# Eval("ASSOSUBGROUP") %>&#039;);'>
                                                    <%# Eval("ASSOSUBGROUP")%></a>
                                            </as:PlaceHolder>
                                    ...
                                    <tr class="Row">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxHAsso" runat="server" Visible='<%# CheckHierarchy("FBASSO") && !Eval("Association").IsNullOrEmpty() %>'>
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;9105&#039;, &#039;FBASSO&#039;, &#039;<%# Eval("Association") %>&#039;);'>
                                                    <%# Eval("Association")%></a>
                                            </as:PlaceHolder>
                                    ...
                                    <tr class="Row">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxHSarm" runat="server" Visible='<%# CheckHierarchy("SARM") %>'>
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;9106&#039;, &#039;SARM&#039;, &#039;<%# Eval("SARM") %>&#039;);'>
                                                    <%# Eval("SARM")%></a>
                                            </as:PlaceHolder>
                                    ...
                                    <tr class="AltRow">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxHSam" runat="server" Visible='<%# CheckHierarchy("SAM") %>'>
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;9107&#039;, &#039;SAM&#039;, &#039;<%# Eval("SalesAgentManager") %>&#039;);'>
                                    ...
                                    <tr class="Row">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="PlaceHolder2" runat="server" Visible='<%# CheckHierarchy("FBSALESAGENT") %>'>
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;9108&#039;, &#039;FBSALESAGENT&#039;, &#039;<%# Eval("SalesAgent") %>&#039;);'>
                                                    <%# Eval("SalesAgent")%></a>
                                            </as:PlaceHolder>
                                    ...
                                    <tr class="AltRow">
                                        ...
                                        <td>
                                            <as:PlaceHolder ID="uxPlaceChain" runat="server">
                                                <a href="#" onclick='return rf_SubmitReportFilterValues(&#039;9109&#039;, &#039;CHAIN&#039;, &#039;<%# Eval("Chain") %>&#039;);'>
                                                    <%# Eval("Chain")%></a>
                                            </as:PlaceHolder>
