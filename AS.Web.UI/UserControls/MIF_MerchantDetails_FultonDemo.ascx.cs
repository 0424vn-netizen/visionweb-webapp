...
public partial class UserControls_MIF_MerchantDetails_FultonDemo : ExportMultiSections
{
    #region Enums
    ...
    private const string FILE_NAME_HIERARCHY_INFO = "~/App_Data/tpl_HierarchyInformation_Fulton.htm";
    ...
    // SPA
    private const string SPA_GET_MERCHANT_PROFILE = "spa_cs_GetMerchantProfile_TSYS_Detail_DEMO";
    ...
    protected string ButtonExcelHierarchyInformation_Click()
    {
        ...
        strExcelTemplate.Replace("[tpl_HierarchyInformation_Fulton_htm_MerchantHierarchy]", Resources.Template.tpl_HierarchyInformation_Fulton_htm_MerchantHierarchy);
        ...
        strExcelTemplate.Replace("[tpl_HierarchyInformation_Fulton_htm_Association_Sub_Group]", Resources.Template.tpl_HierarchyInformation_Fulton_htm_Association_Sub_Group);
        ...
        strExcelTemplate.Replace("[tpl_HierarchyInformation_Fulton_htm_SalesHierarchy]", Resources.Template.tpl_HierarchyInformation_Fulton_htm_SalesHierarchy);
        strExcelTemplate.Replace("[tpl_HierarchyInformation_Fulton_htm_SalesAgentRegionalManager]", Resources.Template.tpl_HierarchyInformation_Fulton_htm_SalesAgentRegionalManager);
        strExcelTemplate.Replace("[tpl_HierarchyInformation_Fulton_htm_SalesAgentManager]", Resources.Template.tpl_HierarchyInformation_Fulton_htm_SalesAgentManager);
        ...
        // Merchant Hierarchy
        strExcelTemplate.Replace("HI_CORP", "&nbsp;" + dataSource.Rows[0]["Corporate"].ToString());
        strExcelTemplate.Replace("HI_BANK", "&nbsp;" + dataSource.Rows[0]["Bank"].ToString());
        strExcelTemplate.Replace("HI_REGION", "&nbsp;" + dataSource.Rows[0]["Region"].ToString());
        strExcelTemplate.Replace("HI_ASSOSUBGROUP", "&nbsp;" + dataSource.Rows[0]["ASSOSUBGROUP"].ToString());
        strExcelTemplate.Replace("HI_ASSOCIATION", "&nbsp;" + dataSource.Rows[0]["Association"].ToString());

        // Sales Hierarchy
        strExcelTemplate.Replace("HI_SARM", "&nbsp;" + dataSource.Rows[0]["SARM"].ToString());
        strExcelTemplate.Replace("HI_SAM", "&nbsp;" + dataSource.Rows[0]["SalesAgentManager"].ToString());
        strExcelTemplate.Replace("HI_SALESAGENT", "&nbsp;" + dataSource.Rows[0]["SalesAgent"].ToString());
