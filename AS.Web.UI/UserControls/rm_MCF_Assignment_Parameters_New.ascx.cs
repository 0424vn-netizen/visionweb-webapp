...
public partial class UserControls_rm_MCF_Assignment_Parameters_New : GlobalUserControl, IRiskParamFilter
{
    enum DataBindAction
    {
        BindParameterList
    ...
    public bool IsViewMode
    {
        get
        {
            return FeatureMode == WebSiteEnums.FeatureMode.View;
        }
    }
            ...
            case PostBackAction.RefreshParameterList:
                {
                    ...
                    ((BaseMasterPage)Page.Master).AjaxAddResponseScript("showFinishButton();");
                    ((BaseMasterPage)Page.Master).AjaxAddResponseScript("showGroupButton();");
                }
                break;
    ...
    protected void uxClose_Click(object sender, EventArgs e)
    {
        switch (uxModalType.Value)
        {
            case "rm_MCF_ParameterFilter_TransactionCodeModal.aspx":
                //string codes = VeraCodeSolution.ValidateResponseData(UserControls_rm_MCF_ParameterFilter_TransactionCode.GetSelectedValuesAsString(Mode, PrimaryID, uxPramKey.Value, FilterID));
                break;
        }
    }
    ...
    protected void uxGroupParameterRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        {
            CheckBox chkParam = e.Item.FindControl("chkParam") as CheckBox;
            chkParam.Enabled = !IsViewMode;
    ...
    protected void uxParameterInGroupRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        LinkButton uxUnGroup = e.Item.FindControl("uxUnGroup") as LinkButton;
        LinkButton uxDuplicate = e.Item.FindControl("uxDuplicate") as LinkButton;
        LinkButton btnDelete = e.Item.FindControl("btnDelete") as LinkButton;

        uxUnGroup.Visible = uxDuplicate.Visible = btnDelete.Visible = !IsViewMode;
        ...
        HtmlGenericControl lblIndicatorText = e.Item.FindControl("lblIndicatorText") as HtmlGenericControl;
        ...
        CheckBox ckGroupNRT = e.Item.FindControl("chkGroupNRT") as CheckBox;

        RadNumericTextBox txtNRTParameterValue = e.Item.FindControl("txtNRTParameterValue") as RadNumericTextBox;
        Literal lblTypeNRT = e.Item.FindControl("lblNRTParameterType") as Literal;
        Literal lblNRTIndicatorDollar = e.Item.FindControl("lblNRTIndicatorDollar") as Literal;
        HtmlGenericControl spanErrMessageNRT = e.Item.FindControl("spanNRTErrMsg") as HtmlGenericControl;
        Literal lblNRTIndicatorNA = e.Item.FindControl("lblNRTIndicatorNA") as Literal;
        HtmlGenericControl lblMCFIndicatorText = e.Item.FindControl("lblMCFIndicatorText") as HtmlGenericControl;

        //Set format number is decimal for type=%
        DataRowView dataRowNRT = e.Item.DataItem as DataRowView;
        if (lblTypeNRT.Text.Equals("%"))
        {
            int precisionNRT = 0;
            int.TryParse(dataRowNRT["ParameterPrecision"].ToString(), out precisionNRT);
            txtNRTParameterValue.NumberFormat.DecimalDigits = precisionNRT;
        }
        ...
        if (!isView)
        {
            ...
            txtParameterValue.Attributes["onblur"] = "return txtValue_Blur(event);";
            txtParameterValue.Attributes["onfocus"] = "return txtParameterValue_Focus(event);";
            txtParameterValue.Attributes["oninput"] = "return maxLengthCheck(this);";
            txtParameterValue.Attributes["onpaste"] = "return false";
            txtThreshold.Attributes["onkeypress"] = "return txtThreshold_KeyPress(event);";
            txtThreshold.Attributes["onblur"] = "return txtValue_Blur(event);";
            txtThreshold.Attributes["onfocus"] = "return txtThreshold_Focus(event);";
            txtThreshold.Attributes["oninput"] = "return maxLengthCheck(this);";
            txtThreshold.Attributes["onpaste"] = "return false";
            txtThresholdLow.Attributes["onkeypress"] = "return txtThreshold_KeyPress(event);";
            txtThresholdLow.Attributes["onblur"] = "return txtValue_Blur(event);";
            txtThresholdLow.Attributes["onfocus"] = "return txtThreshold_Focus(event);";
            txtThresholdLow.Attributes["oninput"] = "return maxLengthCheck(this);";
            txtThresholdLow.Attributes["onpaste"] = "return false";
            txtThresholdHigh.Attributes["onkeypress"] = "return txtThreshold_KeyPress(event);";
            txtThresholdHigh.Attributes["onblur"] = "return txtValue_Blur(event);";
            txtThresholdHigh.Attributes["onfocus"] = "return txtThreshold_Focus(event);";
            txtThresholdHigh.Attributes["oninput"] = "return maxLengthCheck(this);";
            txtThresholdHigh.Attributes["onpaste"] = "return false";
            txtFrom.Attributes["onkeypress"] = "return txtParameterValue_KeyPress(event);";
            txtFrom.Attributes["onblur"] = "return txtValue_Blur(event);";
            txtFrom.Attributes["onfocus"] = "return txtParameterValue_Focus(event);";
            txtFrom.Attributes["oninput"] = "return maxLengthCheck(this);";
            txtFrom.Attributes["onpaste"] = "return false";
            txtTo.Attributes["onkeypress"] = "return txtParameterValue_KeyPress(event);";
            txtTo.Attributes["onblur"] = "return txtValue_Blur(event);";
            txtTo.Attributes["onfocus"] = "return txtParameterValue_Focus(event);";
            txtTo.Attributes["oninput"] = "return maxLengthCheck(this);";
            txtTo.Attributes["onpaste"] = "return false";
        }
        txtParameterValue.ReadOnly = txtThreshold.ReadOnly = txtThresholdLow.ReadOnly = txtThresholdHigh.ReadOnly = txtFrom.ReadOnly = txtTo.ReadOnly = isView;
            ...
            case System.Web.UI.WebControls.ListItemType.AlternatingItem:
                {
                        ...
                        && row["ParameterValueHigh"] != DBNull.Value && !row["ParameterValueHigh"].ToString().IsNullOrEmpty())
                    {
                        ...
                        string paramKey = row["ParameterKey"].ToString();
                        int parameterPrecision = !string.IsNullOrEmpty(row["ParameterPrecision"].ToString()) ? int.Parse(row["ParameterPrecision"].ToString()) : 0;
                        var isDecimal = IsDecimalOrModelTypeInConfig(paramKey);
                        ...
                        if (isDecimal)
                            txtFrom.NumberFormat.DecimalDigits = txtTo.NumberFormat.DecimalDigits = parameterPrecision;

                        //add to check indicator max, min, precision, error controlID value
                        if (dataRow["IndicatorMax"].ToString().Replace("&nbsp", string.Empty).Trim() != string.Empty)
                            txtFrom.Attributes["MaxValue"] = txtTo.Attributes["MaxValue"] = row["IndicatorMax"].ToString();
                        txtFrom.Attributes["MinValue"] = txtTo.Attributes["MinValue"] = row["IndicatorMin"].ToString();
                        txtFrom.Attributes["Precision"] = txtTo.Attributes["Precision"] = row["ParameterPrecision"].ToString();
                        txtFrom.Attributes["ErrControlID"] = txtTo.Attributes["ErrControlID"] = spanErrMessage.ClientID;
                    }

                    ProcessIndicatorColumn(txtParameterValue, lblType, lblIndicatorDollar, lblIndicatorNA, spanErrMessage, lblIndicatorText, e);
                    ...
                    if (modalType != "")
                    {
                        ...
                        if (dataRow["IsSourceParam"].ToBoolean() && !isView)
                            ht = "<div class=\"row\"><div class=\"col-xs-10\"><strong>{0}</strong>" +
                                "<span {3} id='{5}' class='hide'>{6}</span>" +
                                "<span  id='{4}'>{2}</span>" +
                                "</div><div class=\"col-xs-2 text-right\">" +
                                "<a id=\"edit-transactioncode\" class=\"text-button dark-blue pointer\" onclick=\"parameter_ShowFilter({1})\">"
                                + GetLocalResourceObject("Risk_Assignment_Parameters_ascx_cs_Edit").ToString() + "</a></div></div>";
                        else
                            ht = "<div class=\"row\"><div class=\"col-xs-10\"><strong>{0}</strong>" +
                                "<span {3} id='{5}' class='hide'>{6}</span>" +
                                "<span  id='{4}'>{2}</span>" +
                                "</div><div class=\"col-xs-2 text-right\">" +
                                "<a id=\"edit-transactioncode\" class=\"text-button dark-blue pointer hide\" onclick=\"parameter_ShowFilter({1})\">"
                                + GetLocalResourceObject("Risk_Assignment_Parameters_ascx_cs_Edit").ToString() + "</a></div></div>";
                        switch (modalType)
                        {
                            case "rm_MCF_ParameterFilter_TransactionCodeModal.aspx":
                                {
                                    ...
                                    Dictionary<string, string> data = UserControls_rm_MCF_ParameterFilter_TransactionCode.GetSelectedValuesAsString(Mode, PrimaryID, paramId, FilterID);
                                    string code = data["Label"];
                                    string tracking = data["Tracking"];
                                    string transactionCode = string.Format("{0}", !code.IsNullOrEmpty() ? code : string.Empty);
                                    string titleParameter = GetTitleParameter(paramId);
                                    string trackingToHtml = GetTrackingToHtml(paramId, titleParameter);
                                    ht = string.Format(ht,
                                        titleParameter + ": ",
                                        "'rm_MCF_ParameterFilter_TransactionCodeModal.aspx?{0}','{1}','{2}', 850, 725",
                                        transactionCode,
                                        trackingToHtml,
                                        "transactionCode",
                                ...
                                break;
                            case "RISK_ParameterFilter_ACHReturnCodeModal.aspx":
                                {
                                    var showViewLink =  dataRow["IsSourceParam"].ToBoolean() ? "hide" : "";
                                    var showEditLink = !dataRow["IsSourceParam"].ToBoolean() ? "hide" : "";

                                    ht = "<div class=\"row\"><div class=\"col-xs-10\"><strong>{0}</strong><span {3} id='{4}'>{2}</span></div><div class=\"col-xs-2 text-right\">" +
                                               "<a id=\"edit-transactioncode\" class=\"text-button dark-blue pointer {5}\" onclick=\"parameter_ShowFilter({1})\">"
                                               + (isView ? GetLocalResourceObject("Risk_Assignment_Parameters_ascx_cs_View").ToString() : GetLocalResourceObject("Risk_Assignment_Parameters_ascx_cs_Edit").ToString()) + "</a>" +
                                               "<a id=\"view-transactioncode\" class=\"text-button dark-blue pointer {6}\" onclick=\"parameter_ShowFilter({7})\">"
                                               + GetLocalResourceObject("Risk_Assignment_Parameters_ascx_cs_View").ToString() + "</a>" +
                                               "</div></div>";
                                    var included = false;
                                    string code = VeraCodeSolution.ValidateResponseData(UserControls_rm_MCF_ParameterFilter_ACHReturnCode.GetSelectedValuesAsString(Mode, PrimaryID, paramId, ref included));
                                    string achReturnCode = string.Format("{0}", !code.IsNullOrEmpty() ? code : string.Empty);
                                    string queryString = Page.BuildSecureQueryString(string.Format("PrimaryID=" + PrimaryID + "&Mode=" + (Mode == WebSiteEnums.ParamFilterMode.Adhoc ? (int)WebSiteEnums.ParamFilterMode.Adhoc : (int)WebSiteEnums.ParamFilterMode.Assignment) + "&ParamID=" + row["ParameterKey"].ToString() + "&IsView=" + isView.ToString()));
                                    string queryStringView = Page.BuildSecureQueryString(string.Format("PrimaryID=" + PrimaryID + "&Mode=" + (Mode == WebSiteEnums.ParamFilterMode.Adhoc ? (int)WebSiteEnums.ParamFilterMode.Adhoc : (int)WebSiteEnums.ParamFilterMode.Assignment) + "&ParamID=" + row["ParameterKey"].ToString() + "&IsView=" + "True"));
                                    ht = string.Format(ht, GetLocalResourceObject("Risk_Assignment_Parameters_ascx_ACH_ReturnCode").ToString() + ": ", "'rm_MCF_ParameterFilter_ACHReturnCodeModal.aspx?{0}','{1}','{2}', 850, 725", achReturnCode,
                                        "class=\"hide\" tracking-key=\"" + paramId + "_ACHReturnCode\" tracking-text=\"" + paramId + "_ACHReturnCode\"", "achReturnCode", showEditLink, showViewLink, "'rm_MCF_ParameterFilter_ACHReturnCodeModal.aspx?{3}','{1}','{2}', 850, 725");
                                    asContainer.HeaderText = VeraCodeSolution.DoVeraCode(string.Format(ht, queryString, e.Item.ItemIndex, paramId, queryStringView));
                                }
                                break;
                        }
                    }
        ...
        RadNumericTextBox txtNRTThreshold = e.Item.FindControl("txtNRTThreshold") as RadNumericTextBox;
        RadNumericTextBox txtNRTThresholdLow = e.Item.FindControl("txtNRTThresholdLow") as RadNumericTextBox;
        RadNumericTextBox txtNRTThresholdHigh = e.Item.FindControl("txtNRTThresholdHigh") as RadNumericTextBox;
        RadNumericTextBox txtNRTFrom = e.Item.FindControl("txtNRTFrom") as RadNumericTextBox;
        RadNumericTextBox txtNRTTo = e.Item.FindControl("txtNRTTo") as RadNumericTextBox;

        DataRowView rowViewNRT = e.Item.DataItem as DataRowView;
        Literal lblNRTDollar = e.Item.FindControl("lblNRTDollar") as Literal;
        Literal lblNRTpercent = e.Item.FindControl("lblNRTpercent") as Literal;
        HtmlGenericControl spanErrMessageThsNRT = e.Item.FindControl("spanNRTErrMsgThs") as HtmlGenericControl;

        Literal lblNRTDollarThresholdLow = e.Item.FindControl("lblNRTDollarThresholdLow") as Literal;
        Literal lblNRTPercentThresholdLow = e.Item.FindControl("lblNRTPercentThresholdLow") as Literal;

        Literal lblNRTDollarThresholdHigh = e.Item.FindControl("lblNRTDollarThresholdHigh") as Literal;
        Literal lblNRTPercentThresholdHigh = e.Item.FindControl("lblNRTPercentThresholdHigh") as Literal;
        ...
        //Label
        Literal lbNRTParameterValue = e.Item.FindControl("lbNRTParameterValue") as Literal;
        Literal lbNRTFrom = e.Item.FindControl("lbNRTFrom") as Literal;
        Literal lbNRTTo = e.Item.FindControl("lbNRTTo") as Literal;
        Literal lbNRTThreshold = e.Item.FindControl("lbNRTThreshold") as Literal;
        Literal lbNRTThresholdLow = e.Item.FindControl("lbNRTThresholdLow") as Literal;
        Literal lbNRTThresholdHigh = e.Item.FindControl("lbNRTThresholdHigh") as Literal;

        //Hidden field
        HtmlGenericControl uxParameterValueNRT = e.Item.FindControl("ucNRTParameterValue") as HtmlGenericControl;
        HtmlGenericControl ucNRTFrom = e.Item.FindControl("ucNRTFrom") as HtmlGenericControl;
        HtmlGenericControl ucNRTTo = e.Item.FindControl("ucNRTTo") as HtmlGenericControl;
        HtmlGenericControl ucNRTThreshold = e.Item.FindControl("ucNRTThreshold") as HtmlGenericControl;
        HtmlGenericControl ucNRThresholdLow = e.Item.FindControl("ucNRThresholdLow") as HtmlGenericControl;
        HtmlGenericControl ucNRTThresholdHigh = e.Item.FindControl("ucNRTThresholdHigh") as HtmlGenericControl;

        //uxPanelMatchAllNRT.Visible = !rdMatchAll.Checked;
        txtNRTParameterValue.Visible = txtNRTFrom.Visible = txtNRTTo.Visible = txtNRTThreshold.Visible = txtNRTThresholdLow.Visible = txtNRTThresholdHigh.Visible
                                = dataRow["IsSourceParam"].ToBoolean();

        uxParameterValueNRT.Attributes["class"] = ucNRTFrom.Attributes["class"] = ucNRTTo.Attributes["class"] = ucNRTThreshold.Attributes["class"] = ucNRThresholdLow.Attributes["class"] = ucNRTThresholdHigh.Attributes["class"]
            = dataRow["IsSourceParam"].ToBoolean() ? "non-edit hide" : "non-edit";

        bool isViewNRT = FeatureMode == WebSiteEnums.FeatureMode.View;
        if (!isViewNRT)
        {
            txtNRTParameterValue.Attributes["onkeypress"] = "return txtParameterValue_KeyPress(event);";
            txtNRTParameterValue.Attributes["onblur"] = "return txtValue_Blur(event, true);";
            txtNRTParameterValue.Attributes["onfocus"] = "return txtParameterValue_Focus(event);";
            txtNRTParameterValue.Attributes["oninput"] = "return maxLengthCheck(this);";
            txtNRTParameterValue.Attributes["onpaste"] = "return false";
            txtNRTThreshold.Attributes["onkeypress"] = "return txtThreshold_KeyPress(event);";
            txtNRTThreshold.Attributes["onblur"] = "return txtValue_Blur(event, true);";
            txtNRTThreshold.Attributes["onfocus"] = "return txtThreshold_Focus(event);";
            txtNRTThreshold.Attributes["oninput"] = "return maxLengthCheck(this);";
            txtNRTThreshold.Attributes["onpaste"] = "return false";
            txtNRTThresholdLow.Attributes["onkeypress"] = "return txtThreshold_KeyPress(event);";
            txtNRTThresholdLow.Attributes["onblur"] = "return txtValue_Blur(event, true);";
            txtNRTThresholdLow.Attributes["onfocus"] = "return txtThreshold_Focus(event);";
            txtNRTThresholdLow.Attributes["oninput"] = "return maxLengthCheck(this);";
            txtNRTThresholdLow.Attributes["onpaste"] = "return false";
            txtNRTThresholdHigh.Attributes["onkeypress"] = "return txtThreshold_KeyPress(event);";
            txtNRTThresholdHigh.Attributes["onblur"] = "return txtValue_Blur(event, true);";
            txtNRTThresholdHigh.Attributes["onfocus"] = "return txtThreshold_Focus(event, true);";
            txtNRTThresholdHigh.Attributes["oninput"] = "return maxLengthCheck(this);";
            txtNRTThresholdHigh.Attributes["onpaste"] = "return false";
            txtNRTFrom.Attributes["onkeypress"] = "return txtParameterValue_KeyPress(event);";
            txtNRTFrom.Attributes["onblur"] = "return txtValue_Blur(event, true);";
            txtNRTFrom.Attributes["onfocus"] = "return txtParameterValue_Focus(event);";
            txtNRTFrom.Attributes["oninput"] = "return maxLengthCheck(this);";
            txtNRTFrom.Attributes["onpaste"] = "return false";
            txtNRTTo.Attributes["onkeypress"] = "return txtParameterValue_KeyPress(event);";
            txtNRTTo.Attributes["onblur"] = "return txtValue_Blur(event, true);";
            txtNRTTo.Attributes["onfocus"] = "return txtParameterValue_Focus(event);";
            txtNRTTo.Attributes["oninput"] = "return maxLengthCheck(this);";
            txtNRTTo.Attributes["onpaste"] = "return false";
        }
        txtNRTParameterValue.ReadOnly = txtNRTThreshold.ReadOnly = txtNRTThresholdLow.ReadOnly = txtNRTThresholdHigh.ReadOnly = isViewNRT;
            ...
            case System.Web.UI.WebControls.ListItemType.AlternatingItem:
                {
                    ...
                    string modalTypeNRT = row["FilterTypeModal"].ToString();

                    string isThresholdNegativeNRT = row["IsThresholdNegative"].ToString();
                    string isIndicatorNagativeNRT = row["IsIndicatorNegative"].ToString();
                    ...
                    var isEditReAlertParameterIndicator = row["IsEditRealertParameterIndicator"].ToBoolean();
                    var isEditReAlertParameterThreshold = row["IsEditReAlertParameterThreshold"].ToBoolean();

                    if (row["ParameterValue"] != DBNull.Value && !row["ParameterValue"].ToString().IsNullOrEmpty()
                        && row["ReAlertParameterIndicatorHigh"] != DBNull.Value && !row["ReAlertParameterIndicatorHigh"].ToString().IsNullOrEmpty())
                    {
                        ((PlaceHolder)e.Item.FindControl("uxNRTIndicatorNomal")).Visible = false;
                        ((PlaceHolder)e.Item.FindControl("uxNRTIndicatorHigh")).Visible = true;
                    ...
                    ProcessIndicatorColumn(txtNRTParameterValue, lblTypeNRT, lblNRTIndicatorDollar, lblNRTIndicatorNA, spanErrMessageNRT, lblMCFIndicatorText, e, isEditReAlertParameterIndicator);
                    if (isIndicatorNagativeNRT != "" && isIndicatorNagativeNRT == "True")
                    {
                        FormatNegativeSignForIndicator(txtNRTParameterValue, ParameterValueNRT);
                    }

                    bool isNANRT = false;
                    if (ParameterThresholdTypeNRT == "LowHigh")
                    {
                        if (ParameterThresholdLowNRT.IsNullOrEmpty() && ParameterThresholdHighNRT.IsNullOrEmpty() && !isEditReAlertParameterThreshold)
                        {
                            isNANRT = true;
                        }
                    }
                    ...
                    {
                        if (ParameterThresholdNRT.IsNullOrEmpty() && !isEditReAlertParameterThreshold)
                        {
                            isNANRT = true;
                        }
                    }
                    ...
                    else
                    {
                        switch (ParameterThresholdTypeNRT)
                        {
                            case "LowHigh":
                                ...
                                ProcessThresholdColumn(txtNRTThresholdLow, lblNRTDollarThresholdLow, lblNRTPercentThresholdLow, spanNRTErrMsgThresholdLow, e, isEditReAlertParameterIndicator, isEditReAlertParameterThreshold);
                                ProcessThresholdColumn(txtNRTThresholdHigh, lblNRTDollarThresholdHigh, lblNRTPercentThresholdHigh, spanNRTErrMsgThresholdHigh, e, isEditReAlertParameterIndicator, isEditReAlertParameterThreshold);
                            ...
                            default:
                                ...
                                ProcessThresholdColumn(txtNRTThreshold, lblNRTDollar, lblNRTpercent, spanErrMessageThsNRT, e, isEditReAlertParameterIndicator, isEditReAlertParameterThreshold);
                                break;
                        }

                        if (isThresholdNegativeNRT != "" && isThresholdNegativeNRT == "True")
                        {
                            switch (ParameterThresholdTypeNRT)
                            {
                                case "LowHigh":
                                    FormatNegativeSignForThreshold(txtNRTThresholdLow, ParameterThresholdLowNRT);
                                    FormatNegativeSignForThreshold(txtNRTThresholdHigh, ParameterThresholdHighNRT);
                                    break;
                                default:
                                    FormatNegativeSignForThreshold(txtNRTThreshold, ParameterThresholdNRT);
                                    break;
                            }
    ...
    public void BinAssignmentAudit(DataTable dt)
    {
        GeneralFuncsLib.BinAssignmentAuditLink(dt, this.Page, this.GetLocalResourceObject("LasModifyAuditTemplate").ToString(),
            plAudit, ltAutitReportDetail, hdLinkAudit);
    }
    ...
    private void DeleteParameterOnStagging()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_DeleteAssignmentCriteriasStaging", filterParameters, out paramOut);
    }
        ...
        if (dt.Rows.Count > 0)
        {
            if (dt.Rows[0]["RiskScoreFrom"].ToString() != "" || dt.Rows[0]["RiskScoreTo"].ToString() != "")
            {
                if (dt.Rows[0]["RiskScoreFrom"].ToString() != "-1" || dt.Rows[0]["RiskScoreTo"].ToString() != "-1")
                {
                    ...
                    txtRCFrom.Enabled = true && !IsViewMode;
                    txtRCTo.Enabled = true && !IsViewMode;
    ...
    private void ProcessIndicatorColumn(RadNumericTextBox txtParameterValue, Literal lblType, Literal lblIndicatorDollar, Literal lblIndicatorNA, HtmlGenericControl errControl, HtmlGenericControl lblIndicatorText, RepeaterItemEventArgs e)
    {
        ProcessIndicatorColumn(txtParameterValue, lblType, lblIndicatorDollar, lblIndicatorNA, errControl, lblIndicatorText, e, true);
    }

    private void ProcessIndicatorColumn(RadNumericTextBox txtParameterValue, Literal lblType, Literal lblIndicatorDollar, Literal lblIndicatorNA, HtmlGenericControl errControl, HtmlGenericControl lblIndicatorText, RepeaterItemEventArgs e, bool IsEditRealert)
    {
        DataRowView dataRow = e.Item.DataItem as DataRowView;

        var type = lblType.Text.Replace("&nbsp", string.Empty).Trim();
        if (txtParameterValue.Text.Trim() != string.Empty || IsEditRealert)
        {
            ...
            txtParameterValue.Attributes["MaxLength"] = string.IsNullOrEmpty(dataRow["IndicatorMax"].ToString()) ? string.Empty : dataRow["IndicatorMax"].ToString().Length.ToString();
            if (type == "$")
            {
                lblType.Visible = false;
                lblIndicatorDollar.Visible = true;
                lblIndicatorDollar.Text = VeraCodeSolution.DoVeraCode(type);
                txtParameterValue.Text = string.IsNullOrEmpty(txtParameterValue.Text) ? string.Empty : VeraCodeSolution.DoVeraCode(this.GetDouble4Precision(txtParameterValue.Text));
            }
            else
            {
                ...
                else if (type.Length == 0)
                {
                    ...
                    lblIndicatorText.Visible = false;
                    lblIndicatorNA.Visible = true;
                    lblIndicatorNA.Text = string.Empty;
                }
            }
        }
        if (lblType.Text.Trim() == string.Empty || !IsEditRealert)
        {
            lblIndicatorDollar.Visible = false;
            txtParameterValue.Visible = false;
            lblType.Visible = false;
    ...
    {
        ProcessThresholdColumn(txtThreshold, lblDollar, lblpercent, errControl, e, false, false);
    }

    private void ProcessThresholdColumn(RadNumericTextBox txtThreshold, Literal lblDollar, Literal lblpercent, HtmlGenericControl errControl, RepeaterItemEventArgs e, bool isEditIndicatorNRT, bool isEditThresholdNRT)
    {
        ...
        if (txtThreshold.Text == "" && !isEditThresholdNRT)
        {
            DataRowView row = e.Item.DataItem as DataRowView;
            ...
            if (Threshold == "")
            {
                txtThreshold.Visible = false;
                lblpercent.Visible = true;
                lblpercent.Text = string.Empty; // "<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + WebSiteConstants.HTML_EM_DASH_ENCODE + "</span>";
                return;
            }
        }
        ...
        txtThreshold.Attributes["Precision"] = VeraCodeSolution.DoVeraCode(dataRow["ParameterPrecision"].ToString());
        ...
        txtThreshold.Attributes["MaxLength"] = string.IsNullOrEmpty(dataRow["ThresholdMax"].ToString()) ? string.Empty : dataRow["ThresholdMax"].ToString().Length.ToString();
    }
    ...
    private DataTable GetAssignmentParameters()
    {
        ...
        DataTable dt = WebServices.RiskServices.GetReports("spa_RM_MCF_GetParametersByAssignment", parameters);
        return dt;
    }
    ...
    private DataTable GetListGroup()
    {
        ...
        DataTable dt = WebServices.RiskServices.GetReports("spa_RM_MCF_GetListGroupParameterByAssignment", parameters);
        return dt;
    }
    #endregion
    #region ---- Static methods ----
    public static string GetACHReturnCode(string mode, string assignmentID, string paramKey)
    {
        bool included = false;
        return UserControls_rm_MCF_ParameterFilter_ACHReturnCode.GetSelectedValuesAsString(WebSiteEnums.ParamFilterMode.Assignment, assignmentID, paramKey, ref included);
    }
    #endregion ---- Static methods ----
    public void ProcessForSubsite(bool isVisible, WebSiteEnums.FeatureMode mode)
    {
        ...
        if (currentUserType != WebSiteEnums.UserHierarchyMode.CS && currentUserType != WebSiteEnums.UserHierarchyMode.AS)
        {
            ...
            {
                FeatureMode = WebSiteEnums.FeatureMode.View;
            }
        }

        uxPhRiskScore.Visible = isVisible;
    }
    public void InitControlForSubsite()
    {
    ...
    {
        if (IsDecimalOrModelTypeInConfig(paramKey))
        {
            return GetLocalResourceObject("Risk_Assignment_Parameters_ascx_ModelType").ToString();
        }
        return GetLocalResourceObject("Risk_Assignment_Parameters_ascx_Auth_TransactionCode").ToString();
    }
    private bool IsDecimalOrModelTypeInConfig(string paramKey)
    {
        return BuGeneralFuncsLib.CheckExistsInSplitToArray(WebSiteSettings.ParametersAllowDecimal, ',', paramKey);
    }
    private string GetTrackingToHtml(string paramKey, string title)
    {
        title = string.IsNullOrEmpty(title) ? "AuthTransactionCode" : title;
        var txt = string.Concat(paramKey, "_", title.Replace(" ", ""));
        return "tracking-key=\"" + txt + "\" tracking-text=\"" + txt + "\"";
    }
}