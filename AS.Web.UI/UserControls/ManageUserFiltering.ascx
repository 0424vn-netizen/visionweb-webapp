<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ManageUserFiltering.ascx.cs" Inherits="UserControls_ManageUserFiltering" %>
                    ...
                    <td class="text-right">
                        <as:RadComboBox runat="server" Width="248px" ID="uxSearchType" CssClass="filter-item" OnClientSelectedIndexChanged="SearchTypeOnClientSelectedIndexChanged">
                            <Items>
                                ...
                                <as:RadComboBoxItem Value="USERTYPE" Text="User Type" meta:resourcekey="ManageUserFilteringASCX_ItemCombobox_UserType"/>
                                <as:RadComboBoxItem Value="USERROLE" Text="User Role" meta:resourcekey="ManageUserFilteringASCX_ItemCombobox_UserRole"/>
                                <as:RadComboBoxItem Value="USERID" Text="User ID" meta:resourcekey="ManageUserFilteringASCX_ItemCombobox_UserID"/>
                                ...
                                <as:RadComboBoxItem Value="EMAIL" Text="Email Address" meta:resourcekey="ManageUserFilteringASCX_ItemCombobox_Email"/>
                            </Items>
                        </as:RadComboBox>
                    </td>
                    <td></td>
...
<script src="<%= ResolveUrl("~/")%>res/js/usermaintenance/ManageUserFiltering.js"></script>
