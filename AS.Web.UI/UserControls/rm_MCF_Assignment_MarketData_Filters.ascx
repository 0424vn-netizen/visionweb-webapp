<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_Assignment_MarketData_Filters.ascx.cs" Inherits="UserControls_rm_MCF_Assignment_MarketData_Filters" %>
    ...
    <table width="100%" border="1" class="MPSBorder" style="min-width:800px; table-layout:fixed;">
        ...
        <as:RadCodeBlock ID="RadCodeBlock3" runat="server">        
            <td colspan="<%=FeatureMode == WebSiteEnums.FeatureMode.Edit ?"2":"1"%>" >
                <table>
                    <tr>
                        <td style="font-weight:bold; padding:0;"><as:Literal ID="Literal2" runat="server" Text="Merchant # Range:" meta:resourcekey="Literal2Resource1"></as:Literal></td>
