...
public partial class UserControls_RiskEscalationList : GlobalUserControl
{
    ...
    protected void uxGrid_NeedDataSource(object source, GridNeedDataSourceEventArgs e)
    {
        ...
        uxEscalationGrid.DataSource = WebServices.RiskServices.GetReports("spa_rm_cs_GetEscalation", parameters);
    }
    ...
    protected void uxGrid_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            string url = string.Format("<a class=\"link\" href=\"#\" style=\"cursor:pointer\" onclick=\"parent.location = 'rm_RiskReport.aspx?{0}';\">", queryString);
