<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_MerchantWorked.ascx.cs" Inherits="UserControls_rm_MCF_MerchantWorked" %>
    ...
    <as:ASGrid ID="uxGroupList" runat="server" AutoGenerateColumns="false" AllowSorting="true" ASPagingMethod="SPASingleMethod"
        ...
        <MasterTableView>
            <Columns>
                ...
                <%--Merchant Number--%>
                <as:ASGridBoundColumn HeaderText="Merchant Number" HeaderTooltip="Merchant Number" UniqueName="MerchantNumber" SortExpression="MerchantNumber" HeaderStyle-Width="150px"
                ...
                <as:ASGridBoundColumn HeaderText="Today's Volume" HeaderTooltip="Today's Volume" UniqueName="Volume" SortExpression="Volume"
                    ASFormat="Currency" DataField="Volume" meta:resourcekey="ASGridTemplateColumnResource5">
                </as:ASGridBoundColumn>
                <%--Highest Ticket--%>
                <as:ASGridBoundColumn HeaderText="Highest Ticket" HeaderTooltip="Highest Ticket" UniqueName="HighestTicket" SortExpression="HighestTicket"
                    ASFormat="Currency" DataField="HighestTicket" meta:resourcekey="ASGridTemplateColumnResource6">
                </as:ASGridBoundColumn>
            </Columns>
        </MasterTableView>
    </as:ASGrid>
