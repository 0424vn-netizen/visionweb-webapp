...
public partial class UserControls_MIF_MechantDetails_SOFTEK : ExportMultiSections
{
    ...
    private const string FILE_NAME_HIERARCHY_INFO = "~/App_Data/tpl_HierarchyInformation_SOFTEK.htm";
    private const string FILE_NAME_PRICING_INFO = "~/App_Data/tpl_PricingInformation_SOFTEK.htm";
            ...
            case DataBindAction.BindMerchantDetails:
                ...
                if (dtMerch.Rows.Count > 0)
                {
                    ...
                    foreach (RepeaterItem item in rptMerchantInfo.Items)
                    {
                        ...
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkChain", "Chain", HierarchyMode.Softek_CHAIN);
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkCorporate", "EntityNumber1", HierarchyMode.Softek_CORP);
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkRegion", "EntityNumber2", HierarchyMode.Softek_REGN);
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkPrincipal", "EntityNumber3", HierarchyMode.Softek_PRINC);
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkServiceRep", "EntityNumber4", HierarchyMode.Softek_SERVICEREP);
                        MerchantProfileHelper.BuildMIFDetailHierarchyLink(dtMerch, item, "uxLinkAssc", "EntityNumber5", HierarchyMode.Softek_ASSC);
                    }
    ...
    protected string FormatPercentText(object abc, string nullText)
    {
        return abc == DBNull.Value ? nullText
            : string.Format("<span>{0} %</span>", abc);
    }
    ...
    protected string ButtonExcelHierarchyInformation_Click()
    {
        ...
        strExcelTemplate.Replace("[tpl_HierarchyInformation_SOFTEK_htm_CORPORATE]", Resources.Template.tpl_HierarchyInformation_Fulton_htm_Corporate);
        strExcelTemplate.Replace("[tpl_HierarchyInformation_SOFTEK_htm_REGION]", Resources.Template.tpl_HierarchyInformation_Fulton_htm_Region);
        strExcelTemplate.Replace("[tpl_HierarchyInformation_SOFTEK_htm_PRINCIPAL]", Resources.Template.tpl_HierarchyInformation_TNBCI_htm_Principal);
        strExcelTemplate.Replace("[tpl_HierarchyInformation_SOFTEK_htm_SERVICEREP]", Resources.Template.tpl_HierarchyInformation_SOFTEK_htm_ServiceRep);
        strExcelTemplate.Replace("[tpl_HierarchyInformation_SOFTEK_htm_ASSC]", Resources.Template.tpl_HierarchyInformation_Fulton_htm_Association);
        ...
        strExcelTemplate.Replace("HI_CORPORATE", "&nbsp;" + _datasource.Rows[0]["EntityNumber1"].ToString());
        strExcelTemplate.Replace("HI_REGION", "&nbsp;" + _datasource.Rows[0]["EntityNumber2"].ToString());
        strExcelTemplate.Replace("HI_PRINCIPAL", "&nbsp;" + _datasource.Rows[0]["EntityNumber3"].ToString());
        strExcelTemplate.Replace("HI_SERVICEREP", "&nbsp;" + _datasource.Rows[0]["EntityNumber4"].ToString());
        strExcelTemplate.Replace("HI_ASSC", "&nbsp;" + _datasource.Rows[0]["EntityNumber5"].ToString());
    ...
    protected string ButtonExcelPricingInformation_Click()
    {
        ...
        //42039
        strExcelTemplate.Replace("[tpl_PricingInformation_ORION_htm_DiscountRate]", Resources.Template.tpl_PricingInformation_ORION_htm_DiscountRate);
        ...
        //42039
        strExcelTemplate.Replace("PI_MC_DISCOUNT_RATE", "&nbsp;" + FormatPercentText(_datasource.Rows[0]["MCDiscountRate"], "N/A"));
        strExcelTemplate.Replace("PI_VS_DISCOUNT_RATE", "&nbsp;" + FormatPercentText(_datasource.Rows[0]["VSDiscountRate"], "N/A"));
