<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_G2MoneyLaundering_Filter.ascx.cs" Inherits="UserControls_rm_MCF_G2MoneyLaundering_Filter" %>
...
<tek:RadCodeBlock ID="uxRadCodeBlock" runat="server">
    ...
    <script type="text/javascript" src="<%=ResolveUrl("~/") %>res/js/risk_MCF/rm_MCF_G2MoneyLaundering.js"></script>
</tek:RadCodeBlock>
