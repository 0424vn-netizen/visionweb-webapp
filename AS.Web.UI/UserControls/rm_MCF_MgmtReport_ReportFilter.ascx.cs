...
public partial class UserControls_rm_MCF_MgmtReport_ReportFilter : GlobalUserControl
{
            ...
            case DataBindAction.BindAgentList:
                {
                    ...
                    uxAgentList.DataSource = WebServices.RiskServices.GetReports("spa_RM_MCF_GetRiskUsers_MgmtReport", parameters);
            ...
            case DataBindAction.BindGroupList:
                {
                    ...
                    uxGroupList.DataSource = WebServices.RiskServices.GetReports("spa_RM_MCF_GetAllGroups", parameters);
