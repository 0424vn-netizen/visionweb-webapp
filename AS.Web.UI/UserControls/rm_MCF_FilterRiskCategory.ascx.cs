...
public partial class UserControls_rm_MCF_FilterRiskCategory : GlobalUserControl, IRiskParamFilter
{
    #region Enums
    enum DataBindAction
    {
    ...
    #region properties
    static string PAGE_PATH = "~/UserControls/rm_MCF_FilterRiskCategory.ascx";
    ...
    {
        MESSAGE_MODE = "<b>" + GetLocalResourceObject("Risk_FilterRiskCategory_ascx_cs_MessageCode").ToString() + "</b><br />";
        ...
        _defaultValueNA = GetLocalResourceObject("Risk_FilterRiskCategory_ascx_cs_NA").ToString();
        if (!IsPostBack)
        {
            OnDataBindControls(DataBindAction.LoadRiskCategory);
        }
    }
    ...
    {
        uxFilterRiskCategory.DataSourceOrigination = GetFilterList(WebSiteEnums.AssignmentFilterModes.NotAssigned);
        uxFilterRiskCategory.DataSourceDestination = GetFilterList(WebSiteEnums.AssignmentFilterModes.Assigned);
    }
    ...
    private DataTable GetFilterList(WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        parames.Add(new FilterParameter("@FilterName", this.FilterName, DbType.AnsiString));
    ...
    private static Dictionary<string, string> convertTable2String(DataTable dt, bool isInclude)
    {
        ...
        MESSAGE_MODE = "<b>" + HttpContext.GetLocalResourceObject(PAGE_PATH, "Risk_FilterRiskCategory_ascx_cs_MessageCode").ToString() + "</b><br />";
        ...
        _defaultValueNA = HttpContext.GetLocalResourceObject(PAGE_PATH, "Risk_FilterRiskCategory_ascx_cs_NA").ToString();
    ...
    public int Save()
    {
        ...
        string _CodeList = uxFilterRiskCategory.GetSelectedItemsAsString(",");
        ...
        paramesIn.Add(new FilterParameter("@FilterName", this.FilterName, DbType.AnsiString));
