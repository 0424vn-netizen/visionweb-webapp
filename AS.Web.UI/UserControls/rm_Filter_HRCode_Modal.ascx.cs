...
public partial class UserControls_rm_Filter_HRCode_Modal : GlobalUserControl, IRiskParamFilter
{
    ...
    #endregion
    public string PATH_PAGE = "~/UserControls/rm_Filter_HRCode_Modal.ascx";
    ...
    private DataTable GetFilterList(WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        return WebServices.RiskServices.GetReports("spa_rm_cs_GetFilterHRCode", parames);
    }
    ...
    public string GetSelectedValuesAsString(WebSiteEnums.ParamFilterMode mode, string primaryID, string paramID, string FilterID)
    {
        ...
        DataSet ds = WebServices.RiskServices.GetReportsAsDataSet("spa_rm_cs_GetFilterHRCode", parames);
    ...
    public int Save()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_rm_cs_SaveFilterHRCode", paramsIn, out paramsOut);
