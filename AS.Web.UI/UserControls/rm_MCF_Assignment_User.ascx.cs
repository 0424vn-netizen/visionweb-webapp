...
public partial class UserControls_rm_MCF_Assignment_User : GlobalUserControl, IRiskParamFilter
{
    #region Enums
    enum DataBindAction
    {
    ...
    private DataTable GetUserList(int AssignmentID, WebSiteEnums.AssignmentFilterModes whichMode)
    {
        ...
        return WebServices.RiskServices.GetReports("spa_RM_MCF_GetUserListByAssignment", paramsIn);
    }
    ...
    private static Dictionary<string, string> DataTableToString(DataTable list)
    {
        ...
        foreach (DataRow row in list.Rows)
        {
            ...
            tracking += row["DisplayName"].ToString() + ", ";
        }
    ...
    public static Dictionary<string, string> GetSelectedValuesAsString(WebSiteEnums.ParamFilterMode mode, string primaryID, string paramID, string FilterID)
    {
        ...
        DataTable tmp = WebServices.RiskServices.GetReports("spa_RM_MCF_GetUserListByAssignment", paramsIn);
    ...
    public int Save()
    {
        ...
        WebServices.RiskServices.ExecuteNonQueryCommand("spa_RM_MCF_AddAssignmentUsers", paramsIn, out paramsOut);
        return 0;
    }
