...
public partial class UserControls_MIF_MerchantDetails_NORTH : ExportMultiSections
{
    #region Fields
    ...
    private const string SPA_GET_MERCHANT_PROFILE = "spa_cs_GetMerchantProfile_NORTH";
