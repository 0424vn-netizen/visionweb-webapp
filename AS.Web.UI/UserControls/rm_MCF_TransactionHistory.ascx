<%@ Control Language="C#" AutoEventWireup="true" CodeFile="rm_MCF_TransactionHistory.ascx.cs"
    Inherits="UserControls_rm_MCF_TransactionHistory" %>
...
<tek:RadCodeBlock ID="radCodeBlock" runat="server">
    <script type="text/javascript" src="<%=ResolveUrl("~") %>res/js/risk_MCF/rm_MCF_TransactionHistory.js">        
    </script>
</tek:RadCodeBlock>
