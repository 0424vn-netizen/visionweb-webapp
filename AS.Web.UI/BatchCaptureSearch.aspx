<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Title="Batch Capture"
    CodeFile="BatchCaptureSearch.aspx.cs" Inherits="BatchCaptureSearch" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="Server">
    ...
    <uc:PageTitle ID="uxPageTitle" runat="server" ReportTitle="Tech Console - Batch Capture" meta:resourcekey="uxPageTitleResource1" />
    <as:Container ID="uxContainer" runat="server" HeaderText="Filtering Options" Width="100%" meta:resourcekey="uxContainerResource1">
        <table style="width: 100%;" cellspacing="10">
            ...
            <tr>
                ...
                <td class="left_col">
                    <as:Literal ID="ltBatchTotal" runat="server" Text="Batch Total" meta:resourcekey="ltBatchTotalResource1"></as:Literal>
                </td>
                <td>
                    <div class="inline">
                        <tek:RadNumericTextBox ID="uxBatchTotal" runat="server" Type="Currency" Width="200"
                            NegativeStyle-ForeColor="Red" meta:resourcekey="uxBatchTotalResource1">
            ...
            <tr>
                ...
                <td class="left_col">
                    <as:Literal ID="ltCardType" runat="server" Text="Card Type" meta:resourcekey="ltCardTypeResource1"></as:Literal>
                </td>
                <td>
                    <div class="inline">
                        <as:TextBox ID="uxCardType" runat="server" Width="100" MaxLength="10" meta:resourcekey="uxCardTypeResource1" />
                    </div>
                </td>
            </tr>
            <tr>
    ...
    <br />
    <uc:UxExport ID="uxExporter" runat="server" GridID="uxReportGrid" GridHeader="Batch Capture Summary" meta:resourcekey="uxExporterResource1" />
    <as:ASGrid ID="uxReportGrid" runat="server" AutoGenerateColumns="false" AllowPaging="true"
        ...
        <MasterTableView>
            <Columns>
                <as:ASGridBoundColumn HeaderText="Report Date" HeaderTooltip="Report Date" UniqueName="ReportDate"
                    DataField="ReportDate" ASFormat="Date" meta:resourcekey="ASGridBoundColumnResource1">
                ...
                <as:ASGridBoundColumn HeaderText="Merchant ID" HeaderTooltip="Merchant ID" UniqueName="MerchantNumber"
                    DataField="MerchantNumber" ASFormat="StaticString" meta:resourcekey="ASGridBoundColumnResource3">
                    <ColumnValidationSettings>
                        <ModelErrorMessage Text=""></ModelErrorMessage>
                    </ColumnValidationSettings>
                ...
                <as:ASGridBoundColumn HeaderText="Batch #" HeaderTooltip="Batch Number" UniqueName="BatchNumber"
                    DataField="BatchNumber" ASFormat="StaticString" meta:resourcekey="ASGridBoundColumnResource4">
                    <ColumnValidationSettings>
                        <ModelErrorMessage Text=""></ModelErrorMessage>
                    </ColumnValidationSettings>
                ...
                <as:ASGridBoundColumn HeaderText="Term #" HeaderTooltip="Terminal Number" UniqueName="TerminalNumber"
                    DataField="TerminalNumber" ASFormat="StaticString" meta:resourcekey="ASGridBoundColumnResource5">
                    <ColumnValidationSettings>
                        <ModelErrorMessage Text=""></ModelErrorMessage>
                    </ColumnValidationSettings>
                ...
                <as:ASGridBoundColumn HeaderText="Batch Totals" HeaderTooltip="Batch Totals" UniqueName="BatchTotal"
                    DataField="BatchTotal" ASFormat="Currency" ASIsTotalColumn="true" meta:resourcekey="ASGridBoundColumnResource6">
                    <ColumnValidationSettings>
                        <ModelErrorMessage Text=""></ModelErrorMessage>
                    </ColumnValidationSettings>
    ...
    <tek:RadCodeBlock ID="uxRadCodeBlock" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            function ValidateData() {
                ...
                if (!CheckAlphaNumeric(_cardtype, '<%= GetLocalResourceObject("ltCardTypeResource1.Text").ToString() %>')) {
                    return false;
                }
        ...
        function CompareToday(datePicker, type) {
            ...
            if (selectedDate > currentDate) {
                ...
                switch (type) {
                    ...
                    case 2: object = '<%= GetLocalResourceObject("ltReportDateResource1.Text").ToString()%>'; break;
                }
            ...
            var beginDate = document.getElementById("<%=uxFromDate.ClientID %>");
                ...
                if (uxDaily && uxDaily.checked) {
                    ...
                    if (fromDate.get_textBox().value == "" || toDate.get_textBox().value == "") {
                        alert('<%= GetLocalResourceObject("ltReportDateResource1.Text").ToString()%>' + ': ' + '<%=Resources.MessageManager.ReportFilter_ReportDate_InvaidDate %>');
                        return false;
                    }
                    ...
                    if (fromDate.get_selectedDate() > toDate.get_selectedDate()) {
                        alert('<%= GetLocalResourceObject("ltReportDateResource1.Text").ToString()%>' + ': ' + '<%=Resources.MessageManager.ReportFilter_V3%>');
                        return false;
                    }
                }
        return true;
    ...
    function ChangeSearchOption(chk, isPostBack) {
        ...
        if (chk.value == 'uxRadMerchantNumber') {
    ...
    function KeepDateOption() {
        var uxRad = document.getElementById("<%=uxRadMerchantName.ClientID %>");
            ...
            var _filterValue;
            var _textObj;
            var _batch, _terminal, _cardtype;
            function InitControl() {
                ...
                _cardtype = document.getElementById('<%= uxCardType.ClientID %>');
                _filterValue.focus();
            }
